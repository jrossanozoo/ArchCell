...
define class Mock_completardesdeventas as MockBase of MockBase.prg
	...
	oColaboradorCompletarDesdeVentas = null                                                                                                                                                                                                                   
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function baseorigen_assign( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'baseorigen_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'baseorigen_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Baseorigen		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Baseorigen( lxVal )				this.Setear_Baseorigen( lxVal )			EndIf		Else			This.Setear_Baseorigen( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function basestock_assign( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'basestock_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'basestock_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Basestock		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Basestock( lxVal )				this.Setear_Basestock( lxVal )			EndIf		Else			This.Setear_Basestock( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventovalidarcomboorigen() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventovalidarcomboorigen', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventovalidarcombostock() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventovalidarcombostock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_articulo_nomenclador_desde_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_nomenclador_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_nomenclador_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_nomenclador_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_nomenclador_desde( lxVal )				this.Setear_F_articulo_nomenclador_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_nomenclador_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_nomenclador_hasta_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_nomenclador_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_nomenclador_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_nomenclador_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_nomenclador_hasta( lxVal )				this.Setear_F_articulo_nomenclador_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_nomenclador_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_precioconimpuestos_desde_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_precioconimpuestos_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_precioconimpuestos_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_precioconimpuestos_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_precioconimpuestos_desde( lxVal )				this.Setear_F_precioconimpuestos_desde( lxVal )			EndIf		Else			This.Setear_F_precioconimpuestos_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_precioconimpuestos_hasta_assign( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_precioconimpuestos_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_precioconimpuestos_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_precioconimpuestos_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_precioconimpuestos_hasta( lxVal )				this.Setear_F_precioconimpuestos_hasta( lxVal )			EndIf		Else			This.Setear_F_precioconimpuestos_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_baseorigen( txval as variant ) as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_baseorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_baseorigen', lcParametros )			endif		endif		this.Baseorigen = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_basestock( txval as variant ) as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_basestock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_basestock', lcParametros )			endif		endif		this.Basestock = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_precioconimpuestos_desde( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_precioconimpuestos_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_precioconimpuestos_desde', lcParametros )			endif		endif		this.F_precioconimpuestos_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_precioconimpuestos_hasta( txval as variant ) as void                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_precioconimpuestos_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_precioconimpuestos_hasta', lcParametros )			endif		endif		this.F_precioconimpuestos_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setearbases() as boolean                                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Setearbases', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_baseorigen( txval as variant ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_baseorigen', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_baseorigen', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_basestock( txval as variant ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_basestock', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_basestock', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_precioconimpuestos_desde( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_precioconimpuestos_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_precioconimpuestos_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_precioconimpuestos_hasta( txval as variant ) as boolean                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_precioconimpuestos_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_precioconimpuestos_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridobaseorigen() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridobaseorigen', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridobasestock() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridobasestock', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_precioconimpuestos_desde() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridof_precioconimpuestos_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_precioconimpuestos_hasta() as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridof_precioconimpuestos_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_precioconimpuestos_hasta() as void                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_precioconimpuestos_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwnocomercializable() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridofwnocomercializable', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function ocolaboradorcompletardesdeventas_access() as object                                                                                                                                                                                    
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPLETARDESDEVENTAS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorcompletardesdeventas_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorcompletardesdeventas_access', lcParametros )			endif		endif		if !this.lDestroy and vartype( this.oColaboradorCompletarDesdeVentas ) # "O"			this.oColaboradorCompletarDesdeVentas = _Screen.zoo.crearobjeto( "colaboradorCompletarDesdeVentas" )		endif		return this.oColaboradorCompletarDesdeVentas
	EndFunc
