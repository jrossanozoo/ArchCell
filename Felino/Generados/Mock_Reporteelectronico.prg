...
define class Mock_reporteelectronico as MockBase of MockBase.prg
	...
	FechaAltaFW = {}                                                                                                                                                                                                                                          
	FechaDesdeAFIP = ctod( '  /  /    ' )                                                                                                                                                                                                                     
	FechaDesdeAuditoria = ctod( '  /  /    ' )                                                                                                                                                                                                                
	FechaHastaAFIP = ctod( '  /  /    ' )                                                                                                                                                                                                                     
	FechaHastaAuditoria = ctod( '  /  /    ' )                                                                                                                                                                                                                
	FechaModificacionFW = {}                                                                                                                                                                                                                                  
	HORAALTAFW = ""                                                                                                                                                                                                                                           
	HORAEXPO = ""                                                                                                                                                                                                                                             
	HORAIMPO = ""                                                                                                                                                                                                                                             
	HORAMODIFICACIONFW = ""                                                                                                                                                                                                                                   
	Numero = 0                                                                                                                                                                                                                                                
	NumeroDesdeAuditoria = 0                                                                                                                                                                                                                                  
	NumeroHastaAuditoria = 0                                                                                                                                                                                                                                  
	Observacion = ""                                                                                                                                                                                                                                          
	PuntoDeVenta = 0                                                                                                                                                                                                                                          
	RetornoExtension = .t.                                                                                                                                                                                                                                    
	RutaAFIP = ""                                                                                                                                                                                                                                             
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Descarga de reportes electrónicos R.G. 3561/13"                                                                                                                                                                                          
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'REPORTEELECTRONICO'                                                                                                                                                                                                                            
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	lHabilitarFechaDesdeAFIP = .T.                                                                                                                                                                                                                            
	lHabilitarFechaDesdeAuditoria = .T.                                                                                                                                                                                                                       
	lHabilitarFechaHastaAFIP = .T.                                                                                                                                                                                                                            
	lHabilitarFechaHastaAuditoria = .T.                                                                                                                                                                                                                       
	lHabilitarNumeroDesdeAuditoria = .T.                                                                                                                                                                                                                      
	lHabilitarNumeroHastaAuditoria = .T.                                                                                                                                                                                                                      
	lHabilitarObservacion = .T.                                                                                                                                                                                                                               
	lHabilitarRutaAFIP = .T.                                                                                                                                                                                                                                  
	lHabilitarRutaAuditoria = .T.                                                                                                                                                                                                                             
	lHabilitarTipoDescargaAuditoria = .T.                                                                                                                                                                                                                     
	...
	oColaboradorReporteElectronico = null                                                                                                                                                                                                                     
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	...
	*-----------------------------------------------------------------------------------------
	function codint_assign( txval as variant ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'codint_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'codint_assign', lcParametros )			endif		endif		local llConsulta as Boolean, llNuevo as boolean, llEdicion as boolean		with this			llEdicion = .EsEdicion()			if !this.lPermiteMinusculasPK				try					txVal = upper( txVal )				Catch				Endtry			endif			if .lLimpiando or .lCargando				.CodInt = .TransformarAlAsignar( txVal )			else				if llEdicion				else					llNuevo = .EsNuevo()					.CodInt = .TransformarAlAsignar( txVal )					if empty( txVal ) and !llNuevo						.Limpiar()					else						if llNuevo							if .ValidarIngreso( txVal, llNuevo )							else								goServicios.Errores.LevantarExcepcion( 'Caracter inválido en el código.' )							endif						endif						llConsulta = .oAD.ConsultarPorClavePrimaria()						do case							case !llNuevo and llConsulta								.Cargar()							case !llNuevo and !llConsulta								.Limpiar()								goServicios.Errores.LevantarExcepcionTexto( 'El dato buscado ' + alltrim( transform( txVal ) ) + ' de la entidad ' + upper( this.cDescripcion ) + ' no existe.', 9001 )							case llNuevo and llConsulta								.CodInt = []								goServicios.Errores.LevantarExcepcion( 'El código ' + alltrim( transform( txVal ) ) + ' ya existe.' )						endcase					endif				endif			endif		endwith
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function descargaafip_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descargaafip_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descargaafip_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descargaafip		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descargaafip( lxVal )				this.Setear_Descargaafip( lxVal )				 This.Descargaafip_DespuesDeAsignar()			EndIf		Else			This.Setear_Descargaafip( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function descargaafip_despuesdeasignar() as void                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Descargaafip_despuesdeasignar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function descargaauditoria_assign( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'descargaauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'descargaauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Descargaauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Descargaauditoria( lxVal )				this.Setear_Descargaauditoria( lxVal )				 This.Descargaauditoria_DespuesDeAsignar()			EndIf		Else			This.Setear_Descargaauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function descargaauditoria_despuesdeasignar() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Descargaauditoria_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventohabilitarcontrolesportipoauditoria() as void                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventohabilitarcontrolesportipoauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventohabilitarcontrolessegundescargaafip() as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventohabilitarcontrolessegundescargaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventohabilitarcontrolessegundescargaauditoria() as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventohabilitarcontrolessegundescargaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechadesdeafip_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechadesdeafip_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechadesdeafip_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechadesdeafip		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechadesdeafip( lxVal )				if ( this.lHabilitarFechadesdeafip or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Fechacalendario( lxVal )					this.Setear_Fechadesdeafip( lxVal )				else					this.Fechadesdeafip = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Fechadesdeafip)" )				endif			EndIf		Else			This.Setear_Fechadesdeafip( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function fechadesdeauditoria_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechadesdeauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechadesdeauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechadesdeauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechadesdeauditoria( lxVal )				if ( this.lHabilitarFechadesdeauditoria or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Fechacalendario( lxVal )					this.Setear_Fechadesdeauditoria( lxVal )				else					this.Fechadesdeauditoria = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Fechadesdeauditoria)" )				endif			EndIf		Else			This.Setear_Fechadesdeauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function fechahastaafip_assign( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechahastaafip_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechahastaafip_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechahastaafip		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechahastaafip( lxVal )				if ( this.lHabilitarFechahastaafip or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Fechacalendario( lxVal )					this.Setear_Fechahastaafip( lxVal )				else					this.Fechahastaafip = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Fechahastaafip)" )				endif			EndIf		Else			This.Setear_Fechahastaafip( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function fechahastaauditoria_assign( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'fechahastaauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'fechahastaauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Fechahastaauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Fechahastaauditoria( lxVal )				if ( this.lHabilitarFechahastaauditoria or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.ValidarDominio_Fechacalendario( lxVal )					this.Setear_Fechahastaauditoria( lxVal )				else					this.Fechahastaauditoria = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Fechahastaauditoria)" )				endif			EndIf		Else			This.Setear_Fechahastaauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function habilitarcontrolesparadescarga() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarcontrolesparadescarga', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitarcontrolesparadescargaafip() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarcontrolesparadescargaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitarcontrolesparadescargaauditoria() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarcontrolesparadescargaauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function habilitarcontrolesportipoauditoria() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Habilitarcontrolesportipoauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function numerodesdeauditoria_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numerodesdeauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numerodesdeauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numerodesdeauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numerodesdeauditoria( lxVal )				if ( this.lHabilitarNumerodesdeauditoria or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Numerodesdeauditoria( lxVal )				else					this.Numerodesdeauditoria = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Numerodesdeauditoria)" )				endif			EndIf		Else			This.Setear_Numerodesdeauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function numerohastaauditoria_assign( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'numerohastaauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'numerohastaauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Numerohastaauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Numerohastaauditoria( lxVal )				if ( this.lHabilitarNumerohastaauditoria or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Numerohastaauditoria( lxVal )				else					this.Numerohastaauditoria = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Numerohastaauditoria)" )				endif			EndIf		Else			This.Setear_Numerohastaauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oad_access() as variant                                                                                                                                                                                                                          
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'oad_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'oad_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )			this.oAD = this.crearobjeto( 'Din_EntidadREPORTEELECTRONICOAD_' + alltrim( _screen.zoo.app.TipoDeBase ))			this.oAD.InyectarEntidad( this )			this.oAD.Inicializar()		endif		return this.oAD
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function observacion_assign( txval as variant ) as void                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'observacion_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'observacion_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Observacion		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Observacion( lxVal )				if ( this.lHabilitarObservacion or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Observacion( lxVal )				else					this.Observacion = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Observacion)" )				endif			EndIf		Else			This.Setear_Observacion( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdescripciondelerror() as string                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerdescripciondelerror', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorreporteelectronico_access() as void                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorreporteelectronico_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorreporteelectronico_access', lcParametros )			endif		endif		if !this.ldestroy and ( vartype( this.oColaboradorReporteElectronico ) != "O" or isnull( this.oColaboradorReporteElectronico ) )			this.oColaboradorReporteElectronico = newobject( "ColaboradorReporteElectronico", "ColaboradorReporteElectronico.prg" )			this.oColaboradorReporteElectronico.InyectarEntidadReporteElectronico( this )		endif		return this.oColaboradorReporteElectronico
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function rutaafip_assign( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaafip_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaafip_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Rutaafip		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Rutaafip( lxVal )				if ( this.lHabilitarRutaafip or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Rutaafip( lxVal )				else					this.Rutaafip = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Rutaafip)" )				endif			EndIf		Else			This.Setear_Rutaafip( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function rutaauditoria_assign( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'rutaauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'rutaauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Rutaauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Rutaauditoria( lxVal )				if ( this.lHabilitarRutaauditoria or this.lEstaSeteandoValorSugerido or alltrim( lxValOld ) == alltrim( lxVal ))					this.Setear_Rutaauditoria( lxVal )				else					this.Rutaauditoria = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Rutaauditoria)" )				endif			EndIf		Else			This.Setear_Rutaauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_acciones( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_acciones', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_acciones', lcParametros )			endif		endif		this.Acciones = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_descargaafip( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descargaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descargaafip', lcParametros )			endif		endif		this.Descargaafip = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_descargaauditoria( txval as variant ) as void                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_descargaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_descargaauditoria', lcParametros )			endif		endif		this.Descargaauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechadesdeafip( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechadesdeafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechadesdeafip', lcParametros )			endif		endif		this.Fechadesdeafip = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_fechadesdeauditoria( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechadesdeauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechadesdeauditoria', lcParametros )			endif		endif		this.Fechadesdeauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_fechahastaafip( txval as variant ) as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechahastaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechahastaafip', lcParametros )			endif		endif		this.Fechahastaafip = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_fechahastaauditoria( txval as variant ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_fechahastaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_fechahastaauditoria', lcParametros )			endif		endif		this.Fechahastaauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_numerodesdeauditoria( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerodesdeauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerodesdeauditoria', lcParametros )			endif		endif		this.Numerodesdeauditoria = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_numerohastaauditoria( txval as variant ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_numerohastaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_numerohastaauditoria', lcParametros )			endif		endif		this.Numerohastaauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_rutaafip( txval as variant ) as void                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutaafip', lcParametros )			endif		endif		this.Rutaafip = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_rutaauditoria( txval as variant ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_rutaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_rutaauditoria', lcParametros )			endif		endif		this.Rutaauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_tipodescargaauditoria( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_tipodescargaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_tipodescargaauditoria', lcParametros )			endif		endif		this.Tipodescargaauditoria = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function sugerirfiltrosdedescarga() as void                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Sugerirfiltrosdedescarga', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tipodescargaauditoria_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'tipodescargaauditoria_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'tipodescargaauditoria_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Tipodescargaauditoria		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Tipodescargaauditoria( lxVal )				if ( this.lHabilitarTipodescargaauditoria or this.lEstaSeteandoValorSugerido or lxValOld == lxVal)					this.Setear_Tipodescargaauditoria( lxVal )					 This.Tipodescargaauditoria_DespuesDeAsignar()				else					this.Tipodescargaauditoria = lxValOld					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Descarga de reportes electrónicos R.G. 3561/13 - Atributo: Tipodescargaauditoria)" )				endif			EndIf		Else			This.Setear_Tipodescargaauditoria( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function tipodescargaauditoria_despuesdeasignar() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Tipodescargaauditoria_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_acciones( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_acciones', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_acciones', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_descargaafip( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descargaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descargaafip', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_descargaauditoria( txval as variant ) as boolean                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_descargaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_descargaauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechadesdeafip( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechadesdeafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechadesdeafip', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_fechadesdeauditoria( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechadesdeauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechadesdeauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_fechahastaafip( txval as variant ) as boolean                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechahastaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechahastaafip', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_fechahastaauditoria( txval as variant ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_fechahastaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_fechahastaauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_numerodesdeauditoria( txval as variant ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerodesdeauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerodesdeauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_numerohastaauditoria( txval as variant ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_numerohastaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_numerohastaauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_rutaafip( txval as variant ) as boolean                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutaafip', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutaafip', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_rutaauditoria( txval as variant ) as boolean                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_rutaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_rutaauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_tipodescargaauditoria( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'REPORTEELECTRONICO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_tipodescargaauditoria', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_tipodescargaauditoria', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validardescargas() as boolean                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validardescargas', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarfechadesdeafip() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechadesdeafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarfechadesdeauditoria() as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechadesdeauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarfechahastaafip() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechahastaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarfechahastaauditoria() as boolean                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechahastaauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarfechasauditoria() as boolean                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarfechasauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarnumerodesdeauditoria() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarnumerodesdeauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarnumerohastaauditoria() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarnumerohastaauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarnumerosauditoria() as boolean                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarnumerosauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarrutaafip() as boolean                                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarrutaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarrutaauditoria() as boolean                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarrutaauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validartipodescargaauditoria() as boolean                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validartipodescargaauditoria', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridodescargaafip() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodescargaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridodescargaauditoria() as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridodescargaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwdescargaafip() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwdescargaafip', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function valorsugeridofwdescargaauditoria() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridofwdescargaauditoria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function descargarreporteselectronicos() as void                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Descargarreporteselectronicos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function errordedescargadereporteselectronicos() as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	protected function forzarhabilitacionfiltrosasugerir() as void                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Forzarhabilitacionfiltrosasugerir', lcParametros )
	EndFunc
