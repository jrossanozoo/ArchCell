...
define class Mock_Itemexpoagrupadasdisenos as MockBase of MockBase.prg

	cClase = 'Itemexpoagrupadasdisenos'
	...
	*-----------------------------------------------------------------------------------------
	function disenodetalle_assign( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Disenodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_disenodetalle( txval as variant ) as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Setear_disenodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_disenodetalle( txval as variant ) as boolean                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Validar_disenodetalle', lcParametros )
	EndFunc
