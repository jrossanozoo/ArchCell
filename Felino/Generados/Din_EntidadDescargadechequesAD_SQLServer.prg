...
define class Din_EntidadDESCARGADECHEQUESAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxDescargachequeFecimpo, lxDescargachequeFectrans, lxDescargachequeFmodifw, lxDescargachequeFaltafw, lxDescargachequeFecexpo, lxDescargachequeTimestamp, lxDescargachequeAnulado, lxDescargachequeHoraexpo, lxDescargachequeHoraimpo, lxDescargachequeSmodifw, lxDescargachequeUaltafw, lxDescargachequeSaltafw, lxDescargachequeHaltafw, lxDescargachequeHmodifw, lxDescargachequeZadsfw, lxDescargachequeBdmodifw, lxDescargachequeBdaltafw, lxDescargachequeEsttrans, lxDescargachequeValtafw, lxDescargachequeVmodifw, lxDescargachequeUmodifw, lxDescargachequeCodigo, lxDescargachequeDestino, lxDescargachequeConcepto, lxDescargachequeFfch, lxDescargachequeLetra, lxDescargachequePtoven, lxDescargachequeNumcomp, lxDescargachequeComptipo, lxDescargachequeCobs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.DESCARGACHEQUE ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Timestamp","Anulado","Horaexpo","Horaimpo","Smodifw","Ualtafw","Saltafw","Haltafw","Hmodifw","Zadsfw","Bdmodifw","Bdaltafw","Esttrans","Valtafw","Vmodifw","Umodifw","Codigo","Destino","Concepto","Ffch","Letra","Ptoven","Numcomp","Comptipo","Cobs" ) values ( <<"'" + this.ConvertirDateSql( lxDescargachequeFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescargachequeFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescargachequeFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescargachequeFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescargachequeFecexpo ) + "'" >>, <<lxDescargachequeTimestamp >>, <<iif( lxDescargachequeAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxDescargachequeHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeDestino ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeConcepto ) + "'" >>, <<"'" + this.ConvertirDateSql( lxDescargachequeFfch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxDescargachequeLetra ) + "'" >>, <<lxDescargachequePtoven >>, <<lxDescargachequeNumcomp >>, <<lxDescargachequeComptipo >>, <<"'" + this.FormatearTextoSql( lxDescargachequeCobs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.DESCARGACHEQUE set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxDescargachequeFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxDescargachequeFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxDescargachequeFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxDescargachequeFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxDescargachequeFecexpo ) + "'">>,"Timestamp" = <<lxDescargachequeTimestamp>>,"Anulado" = <<iif( lxDescargachequeAnulado, 1, 0 )>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxDescargachequeHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxDescargachequeHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxDescargachequeSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxDescargachequeUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxDescargachequeSaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxDescargachequeHaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxDescargachequeHmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxDescargachequeZadsfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxDescargachequeBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxDescargachequeBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxDescargachequeEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxDescargachequeValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxDescargachequeVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxDescargachequeUmodifw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxDescargachequeCodigo ) + "'">>,"Destino" = <<"'" + this.FormatearTextoSql( lxDescargachequeDestino ) + "'">>,"Concepto" = <<"'" + this.FormatearTextoSql( lxDescargachequeConcepto ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxDescargachequeFfch ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxDescargachequeLetra ) + "'">>,"Ptoven" = <<lxDescargachequePtoven>>,"Numcomp" = <<lxDescargachequeNumcomp>>,"Comptipo" = <<lxDescargachequeComptipo>>,"Cobs" = <<"'" + this.FormatearTextoSql( lxDescargachequeCobs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxDescargachequeCodigo ) + "'">> and  DESCARGACHEQUE.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Codigo" as "Codigo", "Destino" as "Destinodescarga", "Concepto" as "Concepto", "Ffch" as "Fecha", "Letra" as "Letra", "Ptoven" as "Puntodeventa", "Numcomp" as "Numero", "Comptipo" as "Tipocomprobante", "Cobs" as "Observ" from ZooLogic.DESCARGACHEQUE where "Codigo" = <<"'" + this.FormatearTextoSql( lxDescargachequeCodigo ) + "'">> and  DESCARGACHEQUE.CODIGO != ''
			endtext
	...
	Function Primero() As Boolean
		...
		try
			With This.oEntidad
				...
				lcOrden =  .Letra + str( .PuntoDeVenta, 4, 0) + str( .Numero, 8, 0) + .Codigo
			local lcSentencia as string

			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Codigo" as "Codigo", "Destino" as "Destinodescarga", "Concepto" as "Concepto", "Ffch" as "Fecha", "Letra" as "Letra", "Ptoven" as "Puntodeventa", "Numcomp" as "Numero", "Comptipo" as "Tipocomprobante", "Cobs" as "Observ" from ZooLogic.DESCARGACHEQUE where  DESCARGACHEQUE.CODIGO != '' order by Letra,PtoVen,NumComp,CODIGO
			endtext
			use in select('c_DESCARGADECHEQUES')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCARGADECHEQUES', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Codigo" as "Codigo", "Destino" as "Destinodescarga", "Concepto" as "Concepto", "Ffch" as "Fecha", "Letra" as "Letra", "Ptoven" as "Puntodeventa", "Numcomp" as "Numero", "Comptipo" as "Tipocomprobante", "Cobs" as "Observ" from ZooLogic.DESCARGACHEQUE where  funciones.padr( Letra, 1, ' ' ) + str( PtoVen, 4, 0) + str( NumComp, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  DESCARGACHEQUE.CODIGO != '' order by Letra,PtoVen,NumComp,CODIGO
			endtext
			use in select('c_DESCARGADECHEQUES')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCARGADECHEQUES', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Codigo" as "Codigo", "Destino" as "Destinodescarga", "Concepto" as "Concepto", "Ffch" as "Fecha", "Letra" as "Letra", "Ptoven" as "Puntodeventa", "Numcomp" as "Numero", "Comptipo" as "Tipocomprobante", "Cobs" as "Observ" from ZooLogic.DESCARGACHEQUE where  funciones.padr( Letra, 1, ' ' ) + str( PtoVen, 4, 0) + str( NumComp, 8, 0) + funciones.padr( CODIGO, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  DESCARGACHEQUE.CODIGO != '' order by Letra desc,PtoVen desc,NumComp desc,CODIGO desc
			endtext
			use in select('c_DESCARGADECHEQUES')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCARGADECHEQUES', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Timestamp" as "Timestamp", "Anulado" as "Anulado", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Haltafw" as "Horaaltafw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Codigo" as "Codigo", "Destino" as "Destinodescarga", "Concepto" as "Concepto", "Ffch" as "Fecha", "Letra" as "Letra", "Ptoven" as "Puntodeventa", "Numcomp" as "Numero", "Comptipo" as "Tipocomprobante", "Cobs" as "Observ" from ZooLogic.DESCARGACHEQUE where  DESCARGACHEQUE.CODIGO != '' order by Letra desc,PtoVen desc,NumComp desc,CODIGO desc
			endtext
			use in select('c_DESCARGADECHEQUES')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DESCARGADECHEQUES', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Timestamp,Anulado,Horaexpo,Horaimpo,Smodifw,Ualtafw" + ;
",Saltafw,Haltafw,Hmodifw,Zadsfw,Bdmodifw,Bdaltafw,Esttrans,Valtafw,Vmodifw,Umodifw,Codigo,Destino,Co" + ;
		...
		With this
			...
			for each loItem in this.oEntidad.ChequesDetalle
				if this.oEntidad.ChequesDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxMonto = loItem.Monto
					Text to lcCadena noshow textmerge
						Insert into ZooLogic.DETDESCCHEQUE("Pesos","NROITEM","JJT","CODIGO","NroCheque","NroInterno","guidComp","EntFin","EFDet","cNumero","cFechaEmi","cFechaPago","cCoTribGir","Cliente","FCLIENTE","cMonto" ) values ( <<lxPesosalcambio>>, <<lxNroitem>>, <<lxTipo>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxNumerocheque_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxNumerointerno ) + "'">>, <<"'" + this.FormatearTextoSql( lxIditemcomponente ) + "'">>, <<"'" + this.FormatearTextoSql( lxEntidadfinanciera_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxEntidadfinancieradetalle ) + "'">>, <<lxNumero>>, <<"'" + this.ConvertirDateSql( lxFechaemision ) + "'">>, <<"'" + this.ConvertirDateSql( lxFechapago ) + "'">>, <<"'" + this.FormatearTextoSql( lxCodigotributariolibrador ) + "'">>, <<"'" + this.FormatearTextoSql( lxCliente_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxClientedetalle ) + "'">>, <<lxMonto>> ) 
					endtext
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.DESCARGACHEQUE set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, destino = ] + "'" + this.FormatearTextoSql( &lcCursor..destino ) + "'"+ [, concepto = ] + "'" + this.FormatearTextoSql( &lcCursor..concepto ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, Letra = ] + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'"+ [, PtoVen = ] + transform( &lcCursor..PtoVen )+ [, NumComp = ] + transform( &lcCursor..NumComp )+ [, CompTipo = ] + transform( &lcCursor..CompTipo )+ [, CObs = ] + "'" + this.FormatearTextoSql( &lcCursor..CObs ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, TIMESTAMP, Anulado, HORAEXPO, HORAIMPO, SMODIFW, UALTAFW, SALTAFW, HALTAFW, HMODIFW, ZADSFW, BDMODIFW, BDALTAFW, ESTTRANS, VALTAFW, VMODIFW, UMODIFW, CODIGO, destino, concepto, FFCH, Letra, PtoVen, NumComp, CompTipo, CObs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	Protected Function ObtenerIdentificadorParaLoguear( tcCursor as String ) As String
		...
		lcRetorno = lcRetorno + ' - Número comprobante: ' + transform( &tcCursor..Letra      )
		lcRetorno = lcRetorno + ' - Pto. venta: ' + transform( &tcCursor..PtoVen     )
		lcRetorno = lcRetorno + ' - Número: ' + transform( &tcCursor..NumComp    )
		Return lcRetorno
	endfunc
	*--------------------------------------------------------------------------------------------------------
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad DESCARGADECHEQUES. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESTINO = isnull( d.DESTINO, t.DESTINO ),t.CONCEPTO = isnull( d.CONCEPTO, t.CONCEPTO ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVEN = isnull( d.PTOVEN, t.PTOVEN ),t.NUMCOMP = isnull( d.NUMCOMP, t.NUMCOMP ),t.COMPTIPO = isnull( d.COMPTIPO, t.COMPTIPO ),t.COBS = isnull( d.COBS, t.COBS )
				...
				-- Fin Updates
				insert into ZooLogic.DESCARGACHEQUE(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Timestamp,Anulado,Horaexpo,Horaimpo,Smodifw,Ualtafw,Saltafw,Haltafw,Hmodifw,Zadsfw,Bdmodifw,Bdaltafw,Esttrans,Valtafw,Vmodifw,Umodifw,Codigo,Destino,Concepto,Ffch,Letra,Ptoven,Numcomp,Comptipo,Cobs)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.TIMESTAMP,0),isnull( d.ANULADO,0),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.HMODIFW,''),isnull( d.ZADSFW,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.CODIGO,''),isnull( d.DESTINO,''),isnull( d.CONCEPTO,''),isnull( d.FFCH,''),isnull( d.LETRA,''),isnull( d.PTOVEN,0),isnull( d.NUMCOMP,0),isnull( d.COMPTIPO,0),isnull( d.COBS,'')
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					...
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: NÚMERO COMPROBANTE ' + cast( d.Letra as Varchar(1) ) + ', PTO. VENTA ' + cast( d.PtoVen as Varchar(4) ) + ', NÚMERO ' + cast( d.NumComp as Varchar(8) ) + '','La clave principal no es la esperada'
					from ZooLogic.DESCARGACHEQUE t inner join deleted d 
							on   t.Letra = d.Letra
							 and  t.PtoVen = d.PtoVen
							 and  t.NumComp = d.NumComp
				...
				select GetDate(), 'INFO', '', 'Importación <<lcEntidad>>','<<loLogueo.BaseDatos>>',
					<<loLogueo.EstadoSistema>>,'<<loLogueo.Aplicacion>>','<<loLogueo.Version>>',
					'<<loLogueo.Serie>>','<<loLogueo.Usuario>>','<<loLogueo.NombrePc>>',
					'<<loLogueo.UsuarioPc>>','<<loLogueo.OrigenLogueo>>','No se pudo importar la entidad <<lcEntidad>>: NÚMERO COMPROBANTE ' + cast( d.Letra as Varchar(1) ) + ', PTO. VENTA ' + cast( d.PtoVen as Varchar(4) ) + ', NÚMERO ' + cast( d.NumComp as Varchar(8) ) + '','La clave principal a importar ya existe'
					from ZooLogic.DESCARGACHEQUE t inner join deleted d 
							 on t.CODIGO = d.CODIGO
						left join deleted h 
							on   t.Letra = h.Letra
...
<VFPData xml:space="preserve">
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="FECHAIMPO                               " tabla="DESCARGACHEQUE " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCARGADECHEQUES                       " atributo="FECHATRANSFERENCIA                      " tabla="DESCARGACHEQUE " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCARGADECHEQUES                       " atributo="FECHAMODIFICACIONFW                     " tabla="DESCARGACHEQUE " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="FECHAEXPO                               " tabla="DESCARGACHEQUE " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="HORAEXPO                                " tabla="DESCARGACHEQUE " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="SERIEMODIFICACIONFW                     " tabla="DESCARGACHEQUE " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="HORAALTAFW                              " tabla="DESCARGACHEQUE " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="ESTADOTRANSFERENCIA                     " tabla="DESCARGACHEQUE " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCARGADECHEQUES                       " atributo="VERSIONALTAFW                           " tabla="DESCARGACHEQUE " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DESCARGADECHEQUES                       " atributo="VERSIONMODIFICACIONFW                   " tabla="DESCARGACHEQUE " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DESCARGADECHEQUES                       " atributo="NUMERO                                  " tabla="DESCARGACHEQUE " campo="NUMCOMP   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="6" etiqueta="Número                                                                                                                                                          " dominio="NUMEROCOMPROBANTE             " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="3" mascara="X 9999-99999999          " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CONCEPTOCAJA                            " atributo="DESCRIPCION                             " tabla="CONCECAJA      " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="11" etiqueta="Detalle Con.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CONCECAJA On DESCARGACHEQUE.CONCEPTO = CONCECAJA.Codigo And  CONCECAJA.CODIGO != ''                                                                                                                                                                " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
