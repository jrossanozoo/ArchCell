	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPPL ( "Fecexpo","Fectrans","Fecimpo","Fmodifw","Codigo","Timestamp","Horaexpo","Haltafw","Horaimpo","Smodifw","Vmodifw","Zadsfw","Valtafw","Umodifw","Saltafw","Ualtafw","Hmodifw","Esttrans","Bdmodifw","Bdaltafw","Faltafw","Tipcomp","Comprob","Letra","Ptovta","Numdesde","Numhasta","Serie","Vrsn","Db","Usuario","Observacio" ) values ( <<"'" + this.ConvertirDateSql( lxCompplFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompplFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompplFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompplFmodifw ) + "'" >>, <<lxCompplCodigo >>, <<lxCompplTimestamp >>, <<"'" + this.FormatearTextoSql( lxCompplHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplBdaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxCompplFaltafw ) + "'" >>, <<lxCompplTipcomp >>, <<"'" + this.FormatearTextoSql( lxCompplComprob ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplLetra ) + "'" >>, <<lxCompplPtovta >>, <<lxCompplNumdesde >>, <<lxCompplNumhasta >>, <<"'" + this.FormatearTextoSql( lxCompplSerie ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplVrsn ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplDb ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplUsuario ) + "'" >>, <<"'" + this.FormatearTextoSql( lxCompplObservacio ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPPL set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxCompplFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxCompplFectrans ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxCompplFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxCompplFmodifw ) + "'">>,"Codigo" = <<lxCompplCodigo>>,"Timestamp" = <<lxCompplTimestamp>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxCompplHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxCompplHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxCompplHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxCompplSmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxCompplVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxCompplZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxCompplValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxCompplUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxCompplSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxCompplUaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxCompplHmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxCompplEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxCompplBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxCompplBdaltafw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxCompplFaltafw ) + "'">>,"Tipcomp" = <<lxCompplTipcomp>>,"Comprob" = <<"'" + this.FormatearTextoSql( lxCompplComprob ) + "'">>,"Letra" = <<"'" + this.FormatearTextoSql( lxCompplLetra ) + "'">>,"Ptovta" = <<lxCompplPtovta>>,"Numdesde" = <<lxCompplNumdesde>>,"Numhasta" = <<lxCompplNumhasta>>,"Serie" = <<"'" + this.FormatearTextoSql( lxCompplSerie ) + "'">>,"Vrsn" = <<"'" + this.FormatearTextoSql( lxCompplVrsn ) + "'">>,"Db" = <<"'" + this.FormatearTextoSql( lxCompplDb ) + "'">>,"Usuario" = <<"'" + this.FormatearTextoSql( lxCompplUsuario ) + "'">>,"Observacio" = <<"'" + this.FormatearTextoSql( lxCompplObservacio ) + "'">> where "Codigo" = <<lxCompplCodigo>> and  COMPPL.CODIGO != 0 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
...
"Zadsfw,Valtafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Esttrans,Bdmodifw,Bdaltafw,Faltafw,Tipcomp,Comprob,Le" + ;
"tra,Ptovta,Numdesde,Numhasta,Serie,Vrsn,Db,Usuario,Observacio" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FECIMPO, FMODIFW, CODIGO, TIMESTAMP, HORAEXPO, HALTAFW, HORAIMPO, SMODIFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, SALTAFW, UALTAFW, HMODIFW, ESTTRANS, BDMODIFW, BDALTAFW, FAltaFW, TipComp, Comprob, Letra, ptovta, NumDesde, NumHasta, serie, vrsn, db, usuario, Observacio
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TipComp ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Comprob ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Letra ) + "'" + ',' + transform( &lcCursor..ptovta ) + ',' + transform( &lcCursor..NumDesde ) + ',' + transform( &lcCursor..NumHasta ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..serie ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..vrsn ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIPCOMP = isnull( d.TIPCOMP, t.TIPCOMP ),t.COMPROB = isnull( d.COMPROB, t.COMPROB ),t.LETRA = isnull( d.LETRA, t.LETRA ),t.PTOVTA = isnull( d.PTOVTA, t.PTOVTA ),t.NUMDESDE = isnull( d.NUMDESDE, t.NUMDESDE ),t.NUMHASTA = isnull( d.NUMHASTA, t.NUMHASTA ),t.SERIE = isnull( d.SERIE, t.SERIE ),t.VRSN = isnull( d.VRSN, t.VRSN ),t.DB = isnull( d.DB, t.DB ),t.USUARIO = isnull( d.USUARIO, t.USUARIO ),t.OBSERVACIO = isnull( d.OBSERVACIO, t.OBSERVACIO )
					from ZooLogic.COMPPL t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.COMPPL(Fecexpo,Fectrans,Fecimpo,Fmodifw,Codigo,Timestamp,Horaexpo,Haltafw,Horaimpo,Smodifw,Vmodifw,Zadsfw,Valtafw,Umodifw,Saltafw,Ualtafw,Hmodifw,Esttrans,Bdmodifw,Bdaltafw,Faltafw,Tipcomp,Comprob,Letra,Ptovta,Numdesde,Numhasta,Serie,Vrsn,Db,Usuario,Observacio)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.CODIGO,0),isnull( d.TIMESTAMP,0),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.HMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.TIPCOMP,0),isnull( d.COMPROB,''),isnull( d.LETRA,''),isnull( d.PTOVTA,0),isnull( d.NUMDESDE,0),isnull( d.NUMHASTA,0),isnull( d.SERIE,''),isnull( d.VRSN,''),isnull( d.DB,''),isnull( d.USUARIO,''),isnull( d.OBSERVACIO,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="IMPRIMIRCOMPROBANTEPORLOTE              " atributo="FECHATRANSFERENCIA                      " tabla="COMPPL         " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPRIMIRCOMPROBANTEPORLOTE              " atributo="ESTADOTRANSFERENCIA                     " tabla="COMPPL         " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPRIMIRCOMPROBANTEPORLOTE              " atributo="TIPOCOMPROBANTE                         " tabla="COMPPL         " campo="TIPCOMP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=01                                                                                                                                                                                                                                                           " obligatorio="true" admitebusqueda="3" etiqueta="Comprobante                                                                                                                                                     " dominio="TIPOCOMPROBANTEVENTASFISCAL   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPRIMIRCOMPROBANTEPORLOTE              " atributo="ENTIDAD                                 " tabla="COMPPL         " campo="COMPROB   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="3" etiqueta="Comprobante                                                                                                                                                     " dominio="TIPOCOMPROBANTEVENTASFISCAL   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="4" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="IMPRIMIRCOMPROBANTEPORLOTE              " atributo="NUMERODESDE                             " tabla="COMPPL         " campo="NUMDESDE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="9" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="6" etiqueta="Número                                                                                                                                                          " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="IMPRIMIRCOMPROBANTEPORLOTE              " atributo="NUMEROHASTA                             " tabla="COMPPL         " campo="NUMHASTA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="9" decimales="0" valorsugerido="=this.ValorSugeridoNumerohastaEntidad()                                                                                                                                                                                                                       " obligatorio="false" admitebusqueda="7" etiqueta="Número                                                                                                                                                          " dominio="EtiquetaCaracterDesdeHasta    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="2" orden="9" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
