	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TAREAPROG ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdmodifw","Haltafw","Bdaltafw","Esttrans","Codigo","Period" ) values ( <<"'" + this.ConvertirDateSql( lxTareaprogFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaprogFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaprogFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaprogFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTareaprogFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTareaprogCodigo ) + "'" >>, <<lxTareaprogPeriod >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TAREAPROG set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTareaprogFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTareaprogFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTareaprogFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTareaprogFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTareaprogFectrans ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTareaprogSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTareaprogSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTareaprogUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTareaprogValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTareaprogUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTareaprogZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTareaprogVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTareaprogHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTareaprogHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTareaprogHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTareaprogBdmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTareaprogHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTareaprogBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTareaprogEsttrans ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxTareaprogCodigo ) + "'">>,"Period" = <<lxTareaprogPeriod>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxTareaprogCodigo ) + "'">> and  TAREAPROG.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Period" as "Periodicidad" from ZooLogic.TAREAPROG where "Codigo" = <<"'" + this.FormatearTextoSql( lxTareaprogCodigo ) + "'">> and  TAREAPROG.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Period" as "Periodicidad" from ZooLogic.TAREAPROG where  TAREAPROG.CODIGO != '' order by Codigo
			endtext
			use in select('c_DATOSTAREAPROGRAMADAECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DATOSTAREAPROGRAMADAECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Period" as "Periodicidad" from ZooLogic.TAREAPROG where  funciones.padr( Codigo, 38, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TAREAPROG.CODIGO != '' order by Codigo
			endtext
			use in select('c_DATOSTAREAPROGRAMADAECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DATOSTAREAPROGRAMADAECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Period" as "Periodicidad" from ZooLogic.TAREAPROG where  funciones.padr( Codigo, 38, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TAREAPROG.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_DATOSTAREAPROGRAMADAECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DATOSTAREAPROGRAMADAECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Period" as "Periodicidad" from ZooLogic.TAREAPROG where  TAREAPROG.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_DATOSTAREAPROGRAMADAECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_DATOSTAREAPROGRAMADAECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
...
"ifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Haltafw,Bdaltafw,Esttrans,Codigo,Period" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Esttrans" as "Estadotransferencia", "Codigo" as "Codigo", "Period" as "Periodicidad"
				endtext
			Else
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDMODIFW, HALTAFW, BDALTAFW, ESTTRANS, Codigo, period
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + transform( &lcCursor..period )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.PERIOD = isnull( d.PERIOD, t.PERIOD )
					from ZooLogic.TAREAPROG t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.TAREAPROG(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdmodifw,Haltafw,Bdaltafw,Esttrans,Codigo,Period)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.CODIGO,''),isnull( d.PERIOD,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="DATOSTAREAPROGRAMADAECOMMERCE           " atributo="FECHATRANSFERENCIA                      " tabla="TAREAPROG      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSTAREAPROGRAMADAECOMMERCE           " atributo="ESTADOTRANSFERENCIA                     " tabla="TAREAPROG      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="DATOSTAREAPROGRAMADAECOMMERCE           " atributo="PERIODICIDAD                            " tabla="TAREAPROG      " campo="PERIOD    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Repetir cada                                                                                                                                                    " dominio="COMBOTIEMPOS                  " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="DATOSTAREAPROGRAMADAECOMMERCE           " atributo="PLATAFORMA                              " tabla="PLATAF         " campo="PLATAFDET " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="201" etiqueta="Plataformas a procesar                                                                                                                                          " dominio="DETALLEITEMPLATAFORMAS        " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
