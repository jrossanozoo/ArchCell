...
define class Mock_CONECTORAGENTEDEACCIONESORGANIC as MockBase of MockBase.prg

	cClase = 'CONECTORAGENTEDEACCIONESORGANIC'
	...
	lNoLoguearRestAPI = .F.                                                                                                                                                                                                                                   
	oConector = null                                                                                                                                                                                                                                          
	oFactoryDeConectorDeRedes = null                                                                                                                                                                                                                          
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function confirmareliminaciondedbalaao( tcactionid as string, tcoperationticketid as string, tcidbasededatos as string, tcnombredb as string ) as void                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4

		lnParametros = pcount()
		lxParam1 = tcactionid
		lxParam2 = tcoperationticketid
		lxParam3 = tcidbasededatos
		lxParam4 = tcnombredb
		...
		return this.ObtenerResultado( 'Confirmareliminaciondedbalaao', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearaccesosdirectoslistados( tclistadospermitidos as string ) as void                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tclistadospermitidos
		...
		return this.ObtenerResultado( 'Crearaccesosdirectoslistados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function declararsitio() as void                                                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Declararsitio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function disparar( tcaplicacion as string, tcparametros as string, tcworkingdirectory as string ) as void                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tcaplicacion
		lxParam2 = tcparametros
		lxParam3 = tcworkingdirectory
		...
		return this.ObtenerResultado( 'Disparar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ejecutarenviarnotificacionalusuario( tcmensaje as string ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Ejecutarenviarnotificacionalusuario', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ejecutarmantenimiento() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Ejecutarmantenimiento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ejecutarpedirmandatodereplicadesubida( tobd as zoocoleccion of zoocoleccion.prg, tcdescripciondelaaccion as string ) as void                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tobd
		lxParam2 = tcdescripciondelaaccion
		...
		return this.ObtenerResultado( 'Ejecutarpedirmandatodereplicadesubida', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ejecutascriptorganicpormediodelgestor() as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Ejecutascriptorganicpormediodelgestor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function enviainstrucciones( toinstruccionesorganic as instruccionesscript of factoryinstruccionesscript.prg ) as void                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toinstruccionesorganic
		...
		return this.ObtenerResultado( 'Enviainstrucciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function init( tofactorydeconectorderedes as object )                                                                                                                                                                                                     
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdisponibilidadaao() as integer                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Obtenerdisponibilidadaao', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oconector_access() as variant                                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oconector_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregarreferencias() as void                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Agregarreferencias', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function estadisponibletryappenlasesiondeusuario() as boolean                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estadisponibletryappenlasesiondeusuario', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function instanciarconector( tofactorydeconectorderedes as object ) as void                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tofactorydeconectorderedes
		...
		return this.ObtenerResultado( 'Instanciarconector', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function lanzarexcepcion( toerror as exception, tllevantarerror as boolean ) as void                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = toerror
		lxParam2 = tllevantarerror
