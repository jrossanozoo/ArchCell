...
define class Mock_webhook as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetallehookdetalle() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetallehookdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayentidadsinaventoactivado() as boolean                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Hayentidadsinaventoactivado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayurlrepetido() as string                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Hayurlrepetido', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function hookdetalle_access() as variant                                                                                                                                                                                                                  
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'WEBHOOK' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'hookdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'hookdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Hookdetalle ) = 'O' or isnull( this.Hookdetalle ) )			this.Hookdetalle = this.crearobjeto( 'DetalleWebhookHookdetalle' )			this.Hookdetalle.inicializar()			this.enlazar( 'Hookdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Hookdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Hookdetalle, 'CambioSumarizado', this, 'CambiosDetalleHookdetalle', 1)			this.enlazar( 'Hookdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Hookdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Hookdetalle.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Hookdetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function realizarprueba() as string                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Realizarprueba', lcParametros )
	EndFunc
