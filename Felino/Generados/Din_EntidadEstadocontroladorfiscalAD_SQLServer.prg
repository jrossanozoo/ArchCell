...
define class Din_EntidadESTADOCONTROLADORFISCALAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxErrorcfFecexpo, lxErrorcfFectrans, lxErrorcfFmodifw, lxErrorcfFaltafw, lxErrorcfFecimpo, lxErrorcfDescfw, lxErrorcfSaltafw, lxErrorcfSmodifw, lxErrorcfUaltafw, lxErrorcfZadsfw, lxErrorcfValtafw, lxErrorcfHmodifw, lxErrorcfUmodifw, lxErrorcfVmodifw, lxErrorcfHaltafw, lxErrorcfBdaltafw, lxErrorcfDescripci, lxErrorcfBdmodifw, lxErrorcfEsttrans, lxErrorcfHoraimpo, lxErrorcfHoraexpo, lxErrorcfCod, lxErrorcfObs, lxErrorcfFptoven, lxErrorcfComp, lxErrorcfTieneerr, lxErrorcfCodcomp, lxErrorcfGuicomp
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ERRORCF ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Descfw","Saltafw","Smodifw","Ualtafw","Zadsfw","Valtafw","Hmodifw","Umodifw","Vmodifw","Haltafw","Bdaltafw","Descripci","Bdmodifw","Esttrans","Horaimpo","Horaexpo","Cod","Obs","Fptoven","Comp","Tieneerr","Codcomp","Guicomp" ) values ( <<"'" + this.ConvertirDateSql( lxErrorcfFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxErrorcfFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxErrorcfFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxErrorcfFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxErrorcfFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfDescripci ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfCod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxErrorcfObs ) + "'" >>, <<lxErrorcfFptoven >>, <<lxErrorcfComp >>, <<iif( lxErrorcfTieneerr, 1, 0 ) >>, <<lxErrorcfCodcomp >>, <<"'" + this.FormatearTextoSql( lxErrorcfGuicomp ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ERRORCF set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxErrorcfFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxErrorcfFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxErrorcfFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxErrorcfFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxErrorcfFecimpo ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxErrorcfDescfw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxErrorcfSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfSmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxErrorcfUaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxErrorcfZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxErrorcfValtafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfHmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxErrorcfHaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxErrorcfBdaltafw ) + "'">>,"Descripci" = <<"'" + this.FormatearTextoSql( lxErrorcfDescripci ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxErrorcfEsttrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxErrorcfHoraimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxErrorcfHoraexpo ) + "'">>,"Cod" = <<"'" + this.FormatearTextoSql( lxErrorcfCod ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxErrorcfObs ) + "'">>,"Fptoven" = <<lxErrorcfFptoven>>,"Comp" = <<lxErrorcfComp>>,"Tieneerr" = <<iif( lxErrorcfTieneerr, 1, 0 )>>,"Codcomp" = <<lxErrorcfCodcomp>>,"Guicomp" = <<"'" + this.FormatearTextoSql( lxErrorcfGuicomp ) + "'">> where "Cod" = <<"'" + this.FormatearTextoSql( lxErrorcfCod ) + "'">> and  ERRORCF.COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Descfw" as "Descripcionfw", "Saltafw" as "Seriealtafw", "Smodifw" as "Seriemodificacionfw", "Ualtafw" as "Usuarioaltafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Hmodifw" as "Horamodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdaltafw" as "Basededatosaltafw", "Descripci" as "Descrip", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Cod" as "Codigo", "Obs" as "Obs", "Fptoven" as "Puntodeventa", "Comp" as "Comprobante", "Tieneerr" as "Tieneerror", "Codcomp" as "Idcomprobante", "Guicomp" as "Codigocomprobante" from ZooLogic.ERRORCF where "Cod" = <<"'" + this.FormatearTextoSql( lxErrorcfCod ) + "'">> and  ERRORCF.COD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Descfw,Saltafw,Smodifw,Ualtafw,Zadsfw,Valtafw,Hmodi" + ;
"fw,Umodifw,Vmodifw,Haltafw,Bdaltafw,Descripci,Bdmodifw,Esttrans,Horaimpo,Horaexpo,Cod,Obs,Fptoven,Co" + ;
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ERRORCF set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxErrorcfFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxErrorcfFectrans ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxErrorcfFmodifw ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxErrorcfFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxErrorcfFecimpo ) + "'">>, "Descfw" = <<"'" + this.FormatearTextoSql( lxErrorcfDescfw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxErrorcfSaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfSmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxErrorcfUaltafw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxErrorcfZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxErrorcfValtafw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfHmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfUmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfVmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxErrorcfHaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxErrorcfBdaltafw ) + "'">>, "Descripci" = <<"'" + this.FormatearTextoSql( lxErrorcfDescripci ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxErrorcfBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxErrorcfEsttrans ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxErrorcfHoraimpo ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxErrorcfHoraexpo ) + "'">>, "Cod" = <<"'" + this.FormatearTextoSql( lxErrorcfCod ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxErrorcfObs ) + "'">>, "Fptoven" = <<lxErrorcfFptoven>>, "Comp" = <<lxErrorcfComp>>, "Tieneerr" = <<iif( lxErrorcfTieneerr, 1, 0 )>>, "Codcomp" = <<lxErrorcfCodcomp>>, "Guicomp" = <<"'" + this.FormatearTextoSql( lxErrorcfGuicomp ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ERRORCF' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		If llInsertarAuditoria
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ERRORCF set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, Descripci = ] + "'" + this.FormatearTextoSql( &lcCursor..Descripci ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, Cod = ] + "'" + this.FormatearTextoSql( &lcCursor..Cod ) + "'"+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, Comp = ] + transform( &lcCursor..Comp )+ [, Tieneerr = ] + Transform( iif( &lcCursor..Tieneerr, 1, 0 ))+ [, CodComp = ] + transform( &lcCursor..CodComp )+ [, GUIComp = ] + "'" + this.FormatearTextoSql( &lcCursor..GUIComp ) + "'" + [ Where Cod = ] + "'" + this.FormatearTextoSql( &lcCursor..Cod ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, DescFW, SALTAFW, SMODIFW, UALTAFW, ZADSFW, VALTAFW, HMODIFW, UMODIFW, VMODIFW, HALTAFW, BDALTAFW, Descripci, BDMODIFW, ESTTRANS, HORAIMPO, HORAEXPO, Cod, OBS, FPTOVEN, Comp, Tieneerr, CodComp, GUIComp
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descripci ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.DESCRIPCI = isnull( d.DESCRIPCI, t.DESCRIPCI ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.COD = isnull( d.COD, t.COD ),t.OBS = isnull( d.OBS, t.OBS ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.COMP = isnull( d.COMP, t.COMP ),t.TIENEERR = isnull( d.TIENEERR, t.TIENEERR ),t.CODCOMP = isnull( d.CODCOMP, t.CODCOMP ),t.GUICOMP = isnull( d.GUICOMP, t.GUICOMP )
					from ZooLogic.ERRORCF t inner join deleted d 
							 on t.Cod = d.Cod
				-- Fin Updates
				insert into ZooLogic.ADT_ERRORCF ( "ADT_Cod","ADT_Fecha","ADT_Hora","ADT_Serie","ADT_Usr","ADT_Ent","ADT_Comp","ADT_ADN","ADT_Vers","ADT_Ext","Cod","Fptoven","Comp" ) 
				...
				insert into ZooLogic.ERRORCF(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Descfw,Saltafw,Smodifw,Ualtafw,Zadsfw,Valtafw,Hmodifw,Umodifw,Vmodifw,Haltafw,Bdaltafw,Descripci,Bdmodifw,Esttrans,Horaimpo,Horaexpo,Cod,Obs,Fptoven,Comp,Tieneerr,Codcomp,Guicomp)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.DESCFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UALTAFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.HMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.BDALTAFW,''),isnull( d.DESCRIPCI,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.HORAIMPO,''),isnull( d.HORAEXPO,''),isnull( d.COD,''),isnull( d.OBS,''),isnull( d.FPTOVEN,0),isnull( d.COMP,0),isnull( d.TIENEERR,0),isnull( d.CODCOMP,0),isnull( d.GUICOMP,'')
						From deleted d left join ZooLogic.ERRORCF pk 
							 on d.Cod = pk.Cod
						Where pk.Cod Is Null 
				-- Fin Inserts
...
<VFPData xml:space="preserve">
	...
	<row entidad="ESTADOCONTROLADORFISCAL                 " atributo="FECHATRANSFERENCIA                      " tabla="ERRORCF        " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ESTADOCONTROLADORFISCAL                 " atributo="ESTADOTRANSFERENCIA                     " tabla="ERRORCF        " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
