...
define class Mock_calculodeprecios as MockBase of MockBase.prg
	...
	*-----------------------------------------------------------------------------------------
	function f_articulo_anio_desde_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_anio_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_anio_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_anio_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_anio_desde( lxVal )				this.Setear_F_articulo_anio_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_anio_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_anio_hasta_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_anio_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_anio_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_anio_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_anio_hasta( lxVal )				this.Setear_F_articulo_anio_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_anio_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function f_articulo_estacion_desde_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_estacion_desde_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_estacion_desde_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_estacion_desde		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_estacion_desde( lxVal )				this.Setear_F_articulo_estacion_desde( lxVal )			EndIf		Else			This.Setear_F_articulo_estacion_desde( lxVal )		EndIf		dodefault( lxVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function f_articulo_estacion_hasta_assign( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'f_articulo_estacion_hasta_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'f_articulo_estacion_hasta_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.F_articulo_estacion_hasta		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_F_articulo_estacion_hasta( lxVal )				this.Setear_F_articulo_estacion_hasta( lxVal )			EndIf		Else			This.Setear_F_articulo_estacion_hasta( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_anio_desde( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_anio_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_anio_desde', lcParametros )			endif		endif		this.F_articulo_anio_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_anio_hasta( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_anio_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_anio_hasta', lcParametros )			endif		endif		this.F_articulo_anio_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_estacion_desde( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_estacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_estacion_desde', lcParametros )			endif		endif		this.F_articulo_estacion_desde = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_estacion_hasta( txval as variant ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_estacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_estacion_hasta', lcParametros )			endif		endif		this.F_articulo_estacion_hasta = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_unidad_desde( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_unidad_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_unidad_desde', lcParametros )			endif		endif		this.F_articulo_unidad_desde.CODIGO = txVal		dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function setear_f_articulo_unidad_hasta( txval as variant ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_f_articulo_unidad_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_f_articulo_unidad_hasta', lcParametros )			endif		endif		this.F_articulo_unidad_hasta.CODIGO = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_anio_desde( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_anio_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_anio_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_anio_hasta( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_anio_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_anio_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_estacion_desde( txval as variant ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_estacion_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_estacion_desde', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_estacion_hasta( txval as variant ) as boolean                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_estacion_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_estacion_hasta', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_unidad_desde( txval as variant, txvalold as variant ) as boolean                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_unidad_desde', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_unidad_desde', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validar_f_articulo_unidad_hasta( txval as variant, txvalold as variant ) as boolean                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1, lxParam2lnParametros = pcount()lxParam1 = txvallxParam2 = txvaloldlcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'CALCULODEPRECIOS' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_f_articulo_unidad_hasta', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_f_articulo_unidad_hasta', lcParametros )			endif		endif		Return This.CargaManual() and dodefault( txVal, txValOld )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_unidad_desde() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarf_articulo_unidad_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarf_articulo_unidad_hasta() as boolean                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Validarf_articulo_unidad_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_anio_desde() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_anio_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_anio_hasta() as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_anio_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_estacion_desde() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_estacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_estacion_hasta() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_estacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_unidad_desde() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_unidad_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridof_articulo_unidad_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridof_articulo_unidad_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_anio_hasta() as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_anio_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_estacion_desde() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_estacion_desde', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_estacion_hasta() as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_estacion_hasta', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridofwf_articulo_unidad_hasta() as void                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridofwf_articulo_unidad_hasta', lcParametros )
	EndFunc
