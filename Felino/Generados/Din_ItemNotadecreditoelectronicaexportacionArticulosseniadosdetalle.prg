...
define class Din_ItemNOTADECREDITOELECTRONICAEXPORTACIONArticulosseniadosdetalle as ItemARTICULOSSENIADOS of ItemARTICULOSSENIADOS.prg
	...
	function Material_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Material( lxVal, lxValOld )
			if ( this.lHabilitarMaterial_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Material)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Numerogiftcard_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Numerogiftcard( lxVal, lxValOld )
			if ( this.lHabilitarNumerogiftcard_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Numerogiftcard)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Codigomotivodescuento_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Codigomotivodescuento( lxVal, lxValOld )
			if ( this.lHabilitarCodigomotivodescuento_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Codigomotivodescuento)" )
			endif 
		endif
		dodefault( lxVal )
	...
	function Codigomotivodevolucion_PK_Assign( txVal as variant ) as void
		...
		if this.Validar_Codigomotivodevolucion( lxVal, lxValOld )
			if ( this.lHabilitarCodigomotivodevolucion_PK or this.lEstaSeteandoValorSugerido or lxValOld == lxVal )
				...
				goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Codigomotivodevolucion)" )
			endif 
		endif
		dodefault( lxVal )
		...
		if This.CargaManual()
			if this.Validar_Tienerestriccion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tienerestriccion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Tienerestriccion)" )
				endif 
			EndIf
		Else
			This.Setear_Tienerestriccion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateodescuentofinancierosinimp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateodescuentofinancierosinimp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Montoprorrateodescuentofinancierosinimp)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateodescuentofinancierosinimp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateorecargofinancierosinimp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateorecargofinancierosinimp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Montoprorrateorecargofinancierosinimp)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateorecargofinancierosinimp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Percepcionivarg5329( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Percepcionivarg5329', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Percepcionivarg5329)" )
				endif 
			EndIf
		Else
			This.Setear_Percepcionivarg5329( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_saldoliquidacion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_saldoliquidacion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Afe_saldoliquidacion)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_saldoliquidacion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoimpuestointerno( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoimpuestointerno', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Montoimpuestointerno)" )
				endif 
			EndIf
		Else
			This.Setear_Montoimpuestointerno( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Tasaimpuestointerno( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Tasaimpuestointerno', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Tasaimpuestointerno)" )
				endif 
			EndIf
		Else
			This.Setear_Tasaimpuestointerno( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Stock( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Stock', lxValOld, lxVal  )
					...
					this.Stock = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Stock)" )
				endif 
			EndIf
		Else
			This.Setear_Stock( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Eslibre( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Eslibre', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Eslibre)" )
				endif 
			EndIf
		Else
			This.Setear_Eslibre( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Restringirdescuentos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Restringirdescuentos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Restringirdescuentos)" )
				endif 
			EndIf
		Else
			This.Setear_Restringirdescuentos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Fueautorizadodevolucion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Fueautorizadodevolucion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Fueautorizadodevolucion)" )
				endif 
			EndIf
		Else
			This.Setear_Fueautorizadodevolucion( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Idkit( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Idkit', lxValOld, lxVal  )
					...
					this.Idkit = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Idkit)" )
				endif 
			EndIf
		Else
			This.Setear_Idkit( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Ordendeservicio( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Ordendeservicio', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Ordendeservicio)" )
				endif 
			EndIf
		Else
			This.Setear_Ordendeservicio( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Iditemarticulos_aux( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Iditemarticulos_aux', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Iditemarticulos_aux)" )
				endif 
			EndIf
		Else
			This.Setear_Iditemarticulos_aux( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_codigo_aux( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_codigo_aux', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Afe_codigo_aux)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_codigo_aux( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Codigoautorizaciondjcp( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Codigoautorizaciondjcp', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Codigoautorizaciondjcp)" )
				endif 
			EndIf
		Else
			This.Setear_Codigoautorizaciondjcp( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Iditemarticulos( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Iditemarticulos', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Iditemarticulos)" )
				endif 
			EndIf
		Else
			This.Setear_Iditemarticulos( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Afe_codigo( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Afe_codigo', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Afe_codigo)" )
				endif 
			EndIf
		Else
			This.Setear_Afe_codigo( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Montoprorrateoimpuestointerno( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Montoprorrateoimpuestointerno', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Nota de crédito electrónica exportación de venta - Atributo: Montoprorrateoimpuestointerno)" )
				endif 
			EndIf
		Else
			This.Setear_Montoprorrateoimpuestointerno( lxVal ) 
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoCantidad() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "NOTADECREDITOELECTRONICAEXPORTACION", "Articulosseniadosdetalle", "Cantidad" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
