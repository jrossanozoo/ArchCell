...
define class Mock_imprimircomprobanteporlote as MockBase of MockBase.prg
	...
	cClase = 'imprimircomprobanteporlote'
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Imprimir comprobante por lote"                                                                                                                                                                                                           
	cDescripcionSingular = ""                                                                                                                                                                                                                                 
	cEvento = ""                                                                                                                                                                                                                                              
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cIdentificadorConexion = ""                                                                                                                                                                                                                               
	cNombre = ""                                                                                                                                                                                                                                              
	cNombre = 'IMPRIMIRCOMPROBANTEPORLOTE'                                                                                                                                                                                                                    
	cPrefijoImportar = ""                                                                                                                                                                                                                                     
	cPrefijoRecibir = ""                                                                                                                                                                                                                                      
	...
	oEntidadComprobantes = null                                                                                                                                                                                                                               
	oEntidadNumeroHasta = null                                                                                                                                                                                                                                
	oExtension = null                                                                                                                                                                                                                                         
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function eventomensajecomprobantesincae( tcentidad as string, tnptovta as integer, tcletra as string,  tnnumerodesde as integer, tnhasta as integer ) as void                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventomensajecomprobantesincae', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesarcomprobanteportipo( tntipo as number, tcentidad as string, lndesde as number, lnhasta as number ) as void                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Procesarcomprobanteportipo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function procesarcomprobantesporlote() as void                                                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesarcomprobantesporlote', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonumerohastaentidad() as object                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridonumerohastaentidad', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	hidden function cargarmensajesenobservacion() as void                                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cargarmensajesenobservacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function escomprobanteelectronico( toentidad as object ) as boolean                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Escomprobanteelectronico', lcParametros )
	EndFunc
