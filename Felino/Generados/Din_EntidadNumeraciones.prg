...
define class Din_EntidadNUMERACIONES as entidad of entidad.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function oAD_Access() as variant
		if !this.ldestroy and ( !vartype( this.oAD ) = 'O' or isnull( this.oAD ) )
			this.oAD = this.crearobjeto( 'Din_EntidadNUMERACIONESAD_' + alltrim( _screen.zoo.app.TipoDeBase ))
	...
	*--------------------------------------------------------------------------------------------------------
	function Talonarios_Access() as variant
		if !this.ldestroy and ( !vartype( this.Talonarios ) = 'O' or isnull( this.Talonarios ) )
			this.Talonarios = this.crearobjeto( 'Din_DetalleNumeracionesTalonarios' )
			this.Talonarios.inicializar()
			this.enlazar( 'Talonarios.EventoObtenerLogueo', 'inyectarLogueo' )
			this.enlazar( 'Talonarios.EventoObtenerInformacion', 'inyectarInformacion' )
			bindevent( this.Talonarios, 'CambioSumarizado', this, 'CambiosDetalleTalonarios', 1) 
			this.enlazar( 'Talonarios.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno') 
			this.enlazar( 'Talonarios.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno') 
		endif
	...
	*--------------------------------------------------------------------------------------------------------
	function SetearEstadoNuevoEnItems() as Void
		dodefault()
		this.Talonarios.oItem.lNuevo = this.lNuevo
	endfunc

	*--------------------------------------------------------------------------------------------------------
	function SetearEstadoEdicionEnItems() as Void
		dodefault()
		this.Talonarios.oItem.lEdicion = this.lEdicion
	endfunc

	*--------------------------------------------------------------------------------------------------------
	function CambiosDetalleTalonarios() as void
		dodefault()
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function ValidacionDetalles() as Boolean
		...
		llRetorno = dodefault()
		llRetorno = This.ValidarUnDetalle( this.Talonarios, 'Talonarios' ) and llRetorno
		return llRetorno
	endfunc
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as Void
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'NUMERACIONES', '')
