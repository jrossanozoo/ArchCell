...
define class Mock_COLABORADORPRODUCCION as MockBase of MockBase.prg

	cClase = 'COLABORADORPRODUCCION'
	...
	*-----------------------------------------------------------------------------------------
	function escomodinenvariantepricinpal( tcvariante as string ) as boolean                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Escomodinenvariantepricinpal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function escomodinenvariantesecundaria( tcvariante as string ) as void                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Escomodinenvariantesecundaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercomboparaatributo( tcnombreatributo) as collection                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercomboparaatributo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercurvadeproduccion( tccurvadeproduccion as string ) as collection                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercurvadeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerinformaciondecombinacionesfueradecurva( toinformacion as zooinformacion of zooinformacion.prg, tccurva as string, todetalle as detalle of detalle.prg, tcvarianteprincipal as string, tcvariantesecundaria as string) as collection       
		...
		lxParam2 = tccurva
		lxParam3 = todetalle
		lxParam4 = tcvarianteprincipal
		lxParam5 = tcvariantesecundaria
		...
		return this.ObtenerResultado( 'Obtenerinformaciondecombinacionesfueradecurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermodelodeproduccion( tcmodelo as string ) as object                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenermodelodeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocurvadeproduccion_access() as variant                                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Ocurvadeproduccion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validartallerparaliquidacion( tctaller as string, tcproceso as string, toinformacion as collection ) as collection                                                                                                                               
		...
		return this.ObtenerResultado( 'Validartallerparaliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function esdetalledeproduccionconcurva(todetalle as detalle of detalle.prg) as boolean                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Esdetalledeproduccionconcurva', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercombodescarteenliquidacion() as collection                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Obtenercombodescarteenliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomboinsumocomportamiento() as collection                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenercomboinsumocomportamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercomboinsumoenliquidacion() as collection                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercomboinsumoenliquidacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercombotipodeproduccion() as collection                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenercombotipodeproduccion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercombotipomaquinaria() as collection                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercombotipomaquinaria', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercombotipotaller() as collection                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercombotipotaller', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercombounidaddetiempo() as collection                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercombounidaddetiempo', lcParametros )
	EndFunc
