...
define class Din_EntidadTICKETFACTURAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFecimpo, lxComprobantevFmodifw, lxComprobantevFecexpo, lxComprobantevFd2, lxComprobantevInformnube, lxComprobantevFaltafw, lxComprobantevFectrans, lxComprobantevEntregapos, lxComprobantevDatosecomm, lxComprobantevIdcaja, lxComprobantevFpodes1, lxComprobantevMr, lxComprobantevRecpor, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevCotiz, lxComprobantevFajxre, lxComprobantevMdcimpu, lxComprobantevTimestamp, lxComprobantevTotalcant, lxComprobantevMr2, lxComprobantevFactsec, lxComprobantevDesmntosi3, lxComprobantevSubtotsisi, lxComprobantevSubtotcisi, lxComprobantevFpodes2, lxComprobantevSitfisccli, lxComprobantevFsubton, lxComprobantevFacttipo, lxComprobantevCondivalp, lxComprobantevFsubtot, lxComprobantevRecmnto, lxComprobantevDesmntosi, lxComprobantevRecmntosi2, lxComprobantevDesmntosi1, lxComprobantevRecmntosi1, lxComprobantevDesmntosi2, lxComprobantevRecmntosi, lxComprobantevRecmnto2, lxComprobantevSignomov, lxComprobantevRecmnto1, lxComprobantevFcompfis, lxComprobantevAnulado, lxComprobantevDesauto, lxComprobantevHoraexpo, lxComprobantevHoraimpo, lxComprobantevHaltafw, lxComprobantevEsttrans, lxComprobantevFhora, lxComprobantevBdaltafw, lxComprobantevBdmodifw, lxComprobantevHmodifw, lxComprobantevSaltafw, lxComprobantevZadsfw, lxComprobantevDescfw, lxComprobantevVmodifw, lxComprobantevValtafw, lxComprobantevSmodifw, lxComprobantevUmodifw, lxComprobantevUaltafw, lxComprobantevDespachos, lxComprobantevOpecomm, lxComprobantevSimbmon, lxComprobantevIdajuste, lxComprobantevMotdescdev, lxComprobantevIdvuelto, lxComprobantevMoneda, lxComprobantevMonsis, lxComprobantevFobs, lxComprobantevFletra, lxComprobantevFven, lxComprobantevFfch, lxComprobantevMd1, lxComprobantevFcliente, lxComprobantevMd2, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevIdsenia, lxComprobantevCodigo, lxComprobantevSenia, lxComprobantevFptoven, lxComprobantevDeuda, lxComprobantevFcuit, lxComprobantevFmtdes3, lxComprobantevCodlista, lxComprobantevFnumcomp, lxComprobantevTotdescsi, lxComprobantevTdci, lxComprobantevEmail, lxComprobantevVtosenia, lxComprobantevFvuelto, lxComprobantevFtotal, lxComprobantevDirentr, lxComprobantevFpago, lxComprobantevFpodes, lxComprobantevFdescu, lxComprobantevMd3, lxComprobantevPercepcion, lxComprobantevMr1, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecar, lxComprobantevTotrecarsi, lxComprobantevTrci, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevChequer, lxComprobantevCancelar, lxComprobantevIvasis, lxComprobantevTipocrela, lxComprobantevLetrarela, lxComprobantevPuntorela, lxComprobantevNumerorela, lxComprobantevFeccrela, lxComprobantevMerconsign
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fecimpo","Fmodifw","Fecexpo","Fd2","Informnube","Faltafw","Fectrans","Entregapos","Datosecomm","Idcaja","Fpodes1","Mr","Recpor","Fperson","Fturno","Cotiz","Fajxre","Mdcimpu","Timestamp","Totalcant","Mr2","Factsec","Desmntosi3","Subtotsisi","Subtotcisi","Fpodes2","Sitfisccli","Fsubton","Facttipo","Condivalp","Fsubtot","Recmnto","Desmntosi","Recmntosi2","Desmntosi1","Recmntosi1","Desmntosi2","Recmntosi","Recmnto2","Signomov","Recmnto1","Fcompfis","Anulado","Desauto","Horaexpo","Horaimpo","Haltafw","Esttrans","Fhora","Bdaltafw","Bdmodifw","Hmodifw","Saltafw","Zadsfw","Descfw","Vmodifw","Valtafw","Smodifw","Umodifw","Ualtafw","Despachos","Opecomm","Simbmon","Idajuste","Motdescdev","Idvuelto","Moneda","Monsis","Fobs","Fletra","Fven","Ffch","Md1","Fcliente","Md2","Fmtdes1","Fmtdes2","Idsenia","Codigo","Senia","Fptoven","Deuda","Fcuit","Fmtdes3","Codlista","Fnumcomp","Totdescsi","Tdci","Email","Vtosenia","Fvuelto","Ftotal","Direntr","Fpago","Fpodes","Fdescu","Md3","Percepcion","Mr1","Gravamen","Fimpuesto","Totrecar","Totrecarsi","Trci","Totdesc","Totimpue","Chequer","Cancelar","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela","Merconsign" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<lxComprobantevEntregapos >>, <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'" >>, <<lxComprobantevIdcaja >>, <<lxComprobantevFpodes1 >>, <<lxComprobantevMr >>, <<lxComprobantevRecpor >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<lxComprobantevCotiz >>, <<lxComprobantevFajxre >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevTimestamp >>, <<lxComprobantevTotalcant >>, <<lxComprobantevMr2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevSitfisccli >>, <<lxComprobantevFsubton >>, <<lxComprobantevFacttipo >>, <<lxComprobantevCondivalp >>, <<lxComprobantevFsubtot >>, <<lxComprobantevRecmnto >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevDesmntosi2 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevSignomov >>, <<lxComprobantevRecmnto1 >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<iif( lxComprobantevDesauto, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevMd2 >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSenia ) + "'" >>, <<lxComprobantevFptoven >>, <<lxComprobantevDeuda >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevFmtdes3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevTotdescsi >>, <<lxComprobantevTdci >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'" >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFtotal >>, <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'" >>, <<lxComprobantevFpodes >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevMr1 >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTrci >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<"'" + this.FormatearTextoSql( lxComprobantevChequer ) + "'" >>, <<iif( lxComprobantevCancelar, 1, 0 ) >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >>, <<iif( lxComprobantevMerconsign, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Informnube" = <<"'" + this.ConvertirDateSql( lxComprobantevInformnube ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Entregapos" = <<lxComprobantevEntregapos>>,"Datosecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevDatosecomm ) + "'">>,"Idcaja" = <<lxComprobantevIdcaja>>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Mr" = <<lxComprobantevMr>>,"Recpor" = <<lxComprobantevRecpor>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Cotiz" = <<lxComprobantevCotiz>>,"Fajxre" = <<lxComprobantevFajxre>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Totalcant" = <<lxComprobantevTotalcant>>,"Mr2" = <<lxComprobantevMr2>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Fsubton" = <<lxComprobantevFsubton>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Signomov" = <<lxComprobantevSignomov>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Desauto" = <<iif( lxComprobantevDesauto, 1, 0 )>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Despachos" = <<"'" + this.FormatearTextoSql( lxComprobantevDespachos ) + "'">>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Idajuste" = <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'">>,"Motdescdev" = <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'">>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'">>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Md2" = <<lxComprobantevMd2>>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Idsenia" = <<"'" + this.FormatearTextoSql( lxComprobantevIdsenia ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Senia" = <<"'" + this.FormatearTextoSql( lxComprobantevSenia ) + "'">>,"Fptoven" = <<lxComprobantevFptoven>>,"Deuda" = <<lxComprobantevDeuda>>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Tdci" = <<lxComprobantevTdci>>,"Email" = <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'">>,"Vtosenia" = <<"'" + this.ConvertirDateSql( lxComprobantevVtosenia ) + "'">>,"Fvuelto" = <<lxComprobantevFvuelto>>,"Ftotal" = <<lxComprobantevFtotal>>,"Direntr" = <<"'" + this.FormatearTextoSql( lxComprobantevDirentr ) + "'">>,"Fpago" = <<"'" + this.FormatearTextoSql( lxComprobantevFpago ) + "'">>,"Fpodes" = <<lxComprobantevFpodes>>,"Fdescu" = <<lxComprobantevFdescu>>,"Md3" = <<lxComprobantevMd3>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Mr1" = <<lxComprobantevMr1>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecar" = <<lxComprobantevTotrecar>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Trci" = <<lxComprobantevTrci>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Chequer" = <<"'" + this.FormatearTextoSql( lxComprobantevChequer ) + "'">>,"Cancelar" = <<iif( lxComprobantevCancelar, 1, 0 )>>,"Ivasis" = <<lxComprobantevIvasis>>,"Tipocrela" = <<lxComprobantevTipocrela>>,"Letrarela" = <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'">>,"Puntorela" = <<lxComprobantevPuntorela>>,"Numerorela" = <<lxComprobantevNumerorela>>,"Feccrela" = <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'">>,"Merconsign" = <<iif( lxComprobantevMerconsign, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 2 << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Informnube" as "Fueinformadoalanube", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Entregapos" as "Entregaposterior", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Facttipo" as "Tipocomprobante", "Condivalp" as "Condicioniva", "Fsubtot" as "Subtotalbruto", "Recmnto" as "Recargomontoconimpuestos", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto2" as "Recargomontoconimpuestos2", "Signomov" as "Signodemovimiento", "Recmnto1" as "Recargomontoconimpuestos1", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Despachos" as "Despachos", "Opecomm" as "Nroopecommerce", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Moneda" as "Monedacomprobante", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fletra" as "Letra", "Fven" as "Vendedor", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Senia" as "Senia", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fcuit" as "Cuit", "Fmtdes3" as "Montodescuentoconimpuestos3", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Merconsign" as "Mercaderiaconsignacion" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 2
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_TICKETFACTURA.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Tipo" as "Promociontipo", "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Promo" as "Promocion", "Descrip" as "Promociondetalle", "Cantidad" as "Cantidad", "Beneficio" as "Beneficio", "Iditem" as "Iditempromocion" from ZooLogic.PromDet where CODIGO = <<"'" + this.FormatearTextoSql( c_TICKETFACTURA.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Monto" as "Montobeneficio", "Nroitem" as "Nroitem", "Idvalor" as "Iditemvalor", "Atrcabever" as "Atributocabecera", "Idarti" as "Iditemarticulo", "Idpromo" as "Iditempromo", "Codigo" as "Codigo" from ZooLogic.ProArtDet where CODIGO = <<"'" + this.FormatearTextoSql( c_TICKETFACTURA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Informnube" as "Fueinformadoalanube", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Entregapos" as "Entregaposterior", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Facttipo" as "Tipocomprobante", "Condivalp" as "Condicioniva", "Fsubtot" as "Subtotalbruto", "Recmnto" as "Recargomontoconimpuestos", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto2" as "Recargomontoconimpuestos2", "Signomov" as "Signodemovimiento", "Recmnto1" as "Recargomontoconimpuestos1", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Despachos" as "Despachos", "Opecomm" as "Nroopecommerce", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Moneda" as "Monedacomprobante", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fletra" as "Letra", "Fven" as "Vendedor", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Senia" as "Senia", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fcuit" as "Cuit", "Fmtdes3" as "Montodescuentoconimpuestos3", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Merconsign" as "Mercaderiaconsignacion" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 2 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_TICKETFACTURA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TICKETFACTURA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Informnube" as "Fueinformadoalanube", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Entregapos" as "Entregaposterior", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Facttipo" as "Tipocomprobante", "Condivalp" as "Condicioniva", "Fsubtot" as "Subtotalbruto", "Recmnto" as "Recargomontoconimpuestos", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto2" as "Recargomontoconimpuestos2", "Signomov" as "Signodemovimiento", "Recmnto1" as "Recargomontoconimpuestos1", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Despachos" as "Despachos", "Opecomm" as "Nroopecommerce", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Moneda" as "Monedacomprobante", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fletra" as "Letra", "Fven" as "Vendedor", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Senia" as "Senia", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fcuit" as "Cuit", "Fmtdes3" as "Montodescuentoconimpuestos3", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Merconsign" as "Mercaderiaconsignacion" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 2 order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_TICKETFACTURA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TICKETFACTURA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Informnube" as "Fueinformadoalanube", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Entregapos" as "Entregaposterior", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Facttipo" as "Tipocomprobante", "Condivalp" as "Condicioniva", "Fsubtot" as "Subtotalbruto", "Recmnto" as "Recargomontoconimpuestos", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto2" as "Recargomontoconimpuestos2", "Signomov" as "Signodemovimiento", "Recmnto1" as "Recargomontoconimpuestos1", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Despachos" as "Despachos", "Opecomm" as "Nroopecommerce", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Moneda" as "Monedacomprobante", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fletra" as "Letra", "Fven" as "Vendedor", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Senia" as "Senia", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fcuit" as "Cuit", "Fmtdes3" as "Montodescuentoconimpuestos3", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Merconsign" as "Mercaderiaconsignacion" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 2 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_TICKETFACTURA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TICKETFACTURA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Informnube" as "Fueinformadoalanube", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Entregapos" as "Entregaposterior", "Datosecomm" as "Dataecom", "Idcaja" as "Caja", "Fpodes1" as "Porcentajedescuento1", "Mr" as "Recargomonto", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Cotiz" as "Cotizacion", "Fajxre" as "Ajustesporredondeos", "Mdcimpu" as "Montodescuentoconimpuestos", "Timestamp" as "Timestamp", "Totalcant" as "Totalcantidad", "Mr2" as "Recargomonto2", "Factsec" as "Secuencia", "Desmntosi3" as "Montodescuentosinimpuestos3", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Fpodes2" as "Porcentajedescuento2", "Sitfisccli" as "Situacionfiscal", "Fsubton" as "Subtotalneto", "Facttipo" as "Tipocomprobante", "Condivalp" as "Condicioniva", "Fsubtot" as "Subtotalbruto", "Recmnto" as "Recargomontoconimpuestos", "Desmntosi" as "Montodescuentosinimpuestos", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi1" as "Montodescuentosinimpuestos1", "Recmntosi1" as "Recargomontosinimpuestos1", "Desmntosi2" as "Montodescuentosinimpuestos2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto2" as "Recargomontoconimpuestos2", "Signomov" as "Signodemovimiento", "Recmnto1" as "Recargomontoconimpuestos1", "Fcompfis" as "Comprobantefiscal", "Anulado" as "Anulado", "Desauto" as "Descuentoautomatico", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Fhora" as "Hora", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Descfw" as "Descripcionfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Ualtafw" as "Usuarioaltafw", "Despachos" as "Despachos", "Opecomm" as "Nroopecommerce", "Simbmon" as "Simbolomonetariocomprobante", "Idajuste" as "Codigoajuste", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Idvuelto" as "Idvuelto", "Moneda" as "Monedacomprobante", "Monsis" as "Monedasistema", "Fobs" as "Obs", "Fletra" as "Letra", "Fven" as "Vendedor", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Idsenia" as "Idsenia", "Codigo" as "Codigo", "Senia" as "Senia", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fcuit" as "Cuit", "Fmtdes3" as "Montodescuentoconimpuestos3", "Codlista" as "Listadeprecios", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Email" as "Email", "Vtosenia" as "Fechavtosenia", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Direntr" as "Direccionentrega", "Fpago" as "Forpago", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Percepcion" as "Percepciones", "Mr1" as "Recargomonto1", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecar" as "Totalrecargos", "Totrecarsi" as "Totalrecargossinimpuestos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Chequer" as "Chequereintegro", "Cancelar" as "Accioncancelatoria", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Merconsign" as "Mercaderiaconsignacion" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND COMPROBANTEV.FACTTIPO = 2 order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_TICKETFACTURA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TICKETFACTURA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fmodifw,Fecexpo,Fd2,Informnube,Faltafw,Fectrans,Entregapos,Datosecomm,Idcaja,Fpodes1" + ;
",Mr,Recpor,Fperson,Fturno,Cotiz,Fajxre,Mdcimpu,Timestamp,Totalcant,Mr2,Factsec,Desmntosi3,Subtotsisi" + ;
",Subtotcisi,Fpodes2,Sitfisccli,Fsubton,Facttipo,Condivalp,Fsubtot,Recmnto,Desmntosi,Recmntosi2,Desmn" + ;
"tosi1,Recmntosi1,Desmntosi2,Recmntosi,Recmnto2,Signomov,Recmnto1,Fcompfis,Anulado,Desauto,Horaexpo,H" + ;
"oraimpo,Haltafw,Esttrans,Fhora,Bdaltafw,Bdmodifw,Hmodifw,Saltafw,Zadsfw,Descfw,Vmodifw,Valtafw,Smodi" + ;
"fw,Umodifw,Ualtafw,Despachos,Opecomm,Simbmon,Idajuste,Motdescdev,Idvuelto,Moneda,Monsis,Fobs,Fletra," + ;
"Fven,Ffch,Md1,Fcliente,Md2,Fmtdes1,Fmtdes2,Idsenia,Codigo,Senia,Fptoven,Deuda,Fcuit,Fmtdes3,Codlista" + ;
",Fnumcomp,Totdescsi,Tdci,Email,Vtosenia,Fvuelto,Ftotal,Direntr,Fpago,Fpodes,Fdescu,Md3,Percepcion,Mr" + ;
"1,Gravamen,Fimpuesto,Totrecar,Totrecarsi,Trci,Totdesc,Totimpue,Chequer,Cancelar,Ivasis,Tipocrela,Let" + ;
"rarela,Puntorela,Numerorela,Feccrela,Merconsign" + ;
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, InformNube = ] + "'" + this.ConvertirDateSql( &lcCursor..InformNube ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, EntregaPos = ] + transform( &lcCursor..EntregaPos )+ [, DatosEComm = ] + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, MR = ] + transform( &lcCursor..MR )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, DesAuto = ] + Transform( iif( &lcCursor..DesAuto, 1, 0 ))+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, Despachos = ] + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, IDSenia = ] + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, Senia = ] + "'" + this.FormatearTextoSql( &lcCursor..Senia ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, vtosenia = ] + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'"+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, DirEntr = ] + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'"+ [, FPago = ] + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'"+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, ChequeR = ] + "'" + this.FormatearTextoSql( &lcCursor..ChequeR ) + "'"+ [, Cancelar = ] + Transform( iif( &lcCursor..Cancelar, 1, 0 ))+ [, IvaSis = ] + transform( &lcCursor..IvaSis )+ [, TipoCRela = ] + transform( &lcCursor..TipoCRela )+ [, letraRela = ] + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'"+ [, puntoRela = ] + transform( &lcCursor..puntoRela )+ [, numeroRela = ] + transform( &lcCursor..numeroRela )+ [, FecCRela = ] + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'"+ [, MerConsign = ] + Transform( iif( &lcCursor..MerConsign, 1, 0 )) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..EntregaPos ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DatosEComm ) + "'" + ',' + transform( &lcCursor..IdCaja ) + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..RecPor ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..FTurno ) + ',' + transform( &lcCursor..Cotiz )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..TotalCant ) + ',' + transform( &lcCursor..MR2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..FPODES2 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..SitFiscCli ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..FSubTOT ) + ',' + transform( &lcCursor..RecMnto ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..RecMntoSI1 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI2 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..DesAuto, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Despachos ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..MD1 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..IDSenia ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Senia ) + "'" + ',' + transform( &lcCursor..FPTOVEN )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..Deuda ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..FMTDES3 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..totdescSI ) + ',' + transform( &lcCursor..TDCI ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..vtosenia ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..FTotal ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..DirEntr ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPago ) + "'" + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..MD3 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..gravamen )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totdesc ) + ',' + transform( &lcCursor..totimpue ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ChequeR ) + "'" + ',' + Transform( iif( &lcCursor..Cancelar, 1, 0 )) + ',' + transform( &lcCursor..IvaSis )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TipoCRela ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'" + ',' + transform( &lcCursor..puntoRela ) + ',' + transform( &lcCursor..numeroRela ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'" + ',' + Transform( iif( &lcCursor..MerConsign, 1, 0 ))
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'TICKETFACTURA_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'TICKETFACTURA_FOBS'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FD2 = isnull( d.FD2, t.FD2 ),t.INFORMNUBE = isnull( d.INFORMNUBE, t.INFORMNUBE ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.ENTREGAPOS = isnull( d.ENTREGAPOS, t.ENTREGAPOS ),t.DATOSECOMM = isnull( d.DATOSECOMM, t.DATOSECOMM ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.MR = isnull( d.MR, t.MR ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.MR2 = isnull( d.MR2, t.MR2 ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.DESAUTO = isnull( d.DESAUTO, t.DESAUTO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.DESPACHOS = isnull( d.DESPACHOS, t.DESPACHOS ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.MD2 = isnull( d.MD2, t.MD2 ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.IDSENIA = isnull( d.IDSENIA, t.IDSENIA ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.SENIA = isnull( d.SENIA, t.SENIA ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.VTOSENIA = isnull( d.VTOSENIA, t.VTOSENIA ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.DIRENTR = isnull( d.DIRENTR, t.DIRENTR ),t.FPAGO = isnull( d.FPAGO, t.FPAGO ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MD3 = isnull( d.MD3, t.MD3 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.MR1 = isnull( d.MR1, t.MR1 ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.CHEQUER = isnull( d.CHEQUER, t.CHEQUER ),t.CANCELAR = isnull( d.CANCELAR, t.CANCELAR ),t.IVASIS = isnull( d.IVASIS, t.IVASIS ),t.TIPOCRELA = isnull( d.TIPOCRELA, t.TIPOCRELA ),t.LETRARELA = isnull( d.LETRARELA, t.LETRARELA ),t.PUNTORELA = isnull( d.PUNTORELA, t.PUNTORELA ),t.NUMERORELA = isnull( d.NUMERORELA, t.NUMERORELA ),t.FECCRELA = isnull( d.FECCRELA, t.FECCRELA ),t.MERCONSIGN = isnull( d.MERCONSIGN, t.MERCONSIGN )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fecimpo,Fmodifw,Fecexpo,Fd2,Informnube,Faltafw,Fectrans,Entregapos,Datosecomm,Idcaja,Fpodes1,Mr,Recpor,Fperson,Fturno,Cotiz,Fajxre,Mdcimpu,Timestamp,Totalcant,Mr2,Factsec,Desmntosi3,Subtotsisi,Subtotcisi,Fpodes2,Sitfisccli,Fsubton,Facttipo,Condivalp,Fsubtot,Recmnto,Desmntosi,Recmntosi2,Desmntosi1,Recmntosi1,Desmntosi2,Recmntosi,Recmnto2,Signomov,Recmnto1,Fcompfis,Anulado,Desauto,Horaexpo,Horaimpo,Haltafw,Esttrans,Fhora,Bdaltafw,Bdmodifw,Hmodifw,Saltafw,Zadsfw,Descfw,Vmodifw,Valtafw,Smodifw,Umodifw,Ualtafw,Despachos,Opecomm,Simbmon,Idajuste,Motdescdev,Idvuelto,Moneda,Monsis,Fobs,Fletra,Fven,Ffch,Md1,Fcliente,Md2,Fmtdes1,Fmtdes2,Idsenia,Codigo,Senia,Fptoven,Deuda,Fcuit,Fmtdes3,Codlista,Fnumcomp,Totdescsi,Tdci,Email,Vtosenia,Fvuelto,Ftotal,Direntr,Fpago,Fpodes,Fdescu,Md3,Percepcion,Mr1,Gravamen,Fimpuesto,Totrecar,Totrecarsi,Trci,Totdesc,Totimpue,Chequer,Cancelar,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela,Merconsign)
					Select isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.FD2,''),isnull( d.INFORMNUBE,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.ENTREGAPOS,0),isnull( d.DATOSECOMM,''),isnull( d.IDCAJA,0),isnull( d.FPODES1,0),isnull( d.MR,0),isnull( d.RECPOR,0),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.COTIZ,0),isnull( d.FAJXRE,0),isnull( d.MDCIMPU,0),isnull( d.TIMESTAMP,0),isnull( d.TOTALCANT,0),isnull( d.MR2,0),isnull( d.FACTSEC,''),isnull( d.DESMNTOSI3,0),isnull( d.SUBTOTSISI,0),isnull( d.SUBTOTCISI,0),isnull( d.FPODES2,0),isnull( d.SITFISCCLI,0),isnull( d.FSUBTON,0),isnull( d.FACTTIPO,0),isnull( d.CONDIVALP,0),isnull( d.FSUBTOT,0),isnull( d.RECMNTO,0),isnull( d.DESMNTOSI,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI1,0),isnull( d.RECMNTOSI1,0),isnull( d.DESMNTOSI2,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTO2,0),isnull( d.SIGNOMOV,0),isnull( d.RECMNTO1,0),isnull( d.FCOMPFIS,0),isnull( d.ANULADO,0),isnull( d.DESAUTO,0),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.ESTTRANS,''),isnull( d.FHORA,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.ZADSFW,''),isnull( d.DESCFW,''),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.UALTAFW,''),isnull( d.DESPACHOS,''),isnull( d.OPECOMM,''),isnull( d.SIMBMON,''),isnull( d.IDAJUSTE,''),isnull( d.MOTDESCDEV,''),isnull( d.IDVUELTO,''),isnull( d.MONEDA,''),isnull( d.MONSIS,''),isnull( d.FOBS,''),isnull( d.FLETRA,''),isnull( d.FVEN,''),isnull( d.FFCH,''),isnull( d.MD1,0),isnull( d.FCLIENTE,''),isnull( d.MD2,0),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.IDSENIA,''),isnull( d.CODIGO,''),isnull( d.SENIA,''),isnull( d.FPTOVEN,0),isnull( d.DEUDA,0),isnull( d.FCUIT,''),isnull( d.FMTDES3,0),isnull( d.CODLISTA,''),isnull( d.FNUMCOMP,0),isnull( d.TOTDESCSI,0),isnull( d.TDCI,0),isnull( d.EMAIL,''),isnull( d.VTOSENIA,''),isnull( d.FVUELTO,0),isnull( d.FTOTAL,0),isnull( d.DIRENTR,''),isnull( d.FPAGO,''),isnull( d.FPODES,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.PERCEPCION,0),isnull( d.MR1,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECAR,0),isnull( d.TOTRECARSI,0),isnull( d.TRCI,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.CHEQUER,''),isnull( d.CANCELAR,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,''),isnull( d.MERCONSIGN,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="TICKETFACTURA                           " atributo="VALORESDETALLE                          " tabla="VAL            " campo="JJNUM     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="                                                                                                                                                                " dominio="DETALLEITEMVALORES            " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="2" orden="0" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="CAJA                                    " tabla="COMPROBANTEV   " campo="IDCAJA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CAJAESTADO                              " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGONUMERICO                " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="PORCENTAJEDESCUENTO1                    " tabla="COMPROBANTEV   " campo="FPODES1   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="402" etiqueta="Descuento %                                                                                                                                                     " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="RECARGOMONTO                            " tabla="COMPROBANTEV   " campo="MR        " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="404" etiqueta="Monto recargo                                                                                                                                                   " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="AJUSTESPORREDONDEOS                     " tabla="COMPROBANTEV   " campo="FAJXRE    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Ajustes por redondeo                                                                                                                                            " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Monto recargo 2                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="PORCENTAJEDESCUENTO2                    " tabla="COMPROBANTEV   " campo="FPODES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Descuento %                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="SITUACIONFISCAL                         " tabla="COMPROBANTEV   " campo="SITFISCCLI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SITUACIONFISCAL                         " tipodato="N         " longitud="2" decimales="0" valorsugerido="=3                                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="0" etiqueta="Sit.Fis                                                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=2                                                                                                                                                                                                                                                            " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="RECARGOMONTOCONIMPUESTOS                " tabla="COMPROBANTEV   " campo="RECMNTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="RECARGOMONTOCONIMPUESTOS2               " tabla="COMPROBANTEV   " campo="RECMNTO2  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Monto de recargo                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="DESCUENTOAUTOMATICO                     " tabla="COMPROBANTEV   " campo="DESAUTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="HORAALTAFW                              " tabla="COMPROBANTEV   " campo="HALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora alta                                                                                                                                                       " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="MONEDASISTEMA                           " tabla="COMPROBANTEV   " campo="MONSIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="OBS                                     " tabla="COMPROBANTEV   " campo="FOBS      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="                                                                                                                                                                " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="FECHA                                   " tabla="COMPROBANTEV   " campo="FFCH      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="=goServicios.Librerias.ObtenerFecha()                                                                                                                                                                                                                         " obligatorio="true" admitebusqueda="8" etiqueta="Fecha                                                                                                                                                           " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="FACTURADETALLE                          " tabla="COMPROBANTEVDET" campo="CODIGO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="38" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="                                                                                                                                                                " dominio="DETALLEITEMARTICULOSVENTAS    " detalle="true" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="true" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="MONTODESCUENTO1                         " tabla="COMPROBANTEV   " campo="MD1       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="426" etiqueta="Monto descuento 1                                                                                                                                               " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="428" etiqueta="                                                                                                                                                                " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="MONTODESCUENTOCONIMPUESTOS2             " tabla="COMPROBANTEV   " campo="FMTDES2   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuento %                                                                                                                                                     " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="4" orden="1" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="DEUDA                                   " tabla="COMPROBANTEV   " campo="DEUDA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Saldo de cta. cte.                                                                                                                                              " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="TOTALDESCUENTOSCONIMPUESTOS             " tabla="COMPROBANTEV   " campo="TDCI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuentos                                                                                                                                                      " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="25" orden="3" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="FECHAVTOSENIA                           " tabla="COMPROBANTEV   " campo="VTOSENIA  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="440" etiqueta="Fecha vencimiento de la seña                                                                                                                                    " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="VUELTOVIRTUAL                           " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Vuelto                                                                                                                                                          " dominio="VUELTO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="TOTAL                                   " tabla="COMPROBANTEV   " campo="FTOTAL    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="16" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Total                                                                                                                                                           " dominio="TOTALPESOS                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="4" subgrupo="1" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="444" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="448" etiqueta="Monto descuento 3                                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="TOTALRECARGOS                           " tabla="COMPROBANTEV   " campo="TOTRECAR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TICKETFACTURA                           " atributo="TOTALRECARGOSCONIMPUESTOS               " tabla="COMPROBANTEV   " campo="TRCI      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="4" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Recargos                                                                                                                                                        " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="27" orden="52" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="TOTALDESCUENTOS                         " tabla="COMPROBANTEV   " campo="TOTDESC   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Descuentos                                                                                                                                                      " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="28" orden="53" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TICKETFACTURA                           " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="458" etiqueta="Impuestos                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="26" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="409" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On COMPROBANTEV.FPERSON = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                       " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
