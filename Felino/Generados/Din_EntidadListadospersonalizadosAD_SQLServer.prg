...
define class Din_EntidadLISTADOSPERSONALIZADOSAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxLtdspersFaltafw, lxLtdspersFecimpo, lxLtdspersFmodifw, lxLtdspersFecexpo, lxLtdspersFectrans, lxLtdspersEncdetalle, lxLtdspersEncreporte, lxLtdspersMantgruni, lxLtdspersEncpagina, lxLtdspersHoraimpre, lxLtdspersColsubrecp, lxLtdspersAnulado, lxLtdspersColgrupocp, lxLtdspersTranspag, lxLtdspersPagsimple, lxLtdspersResumenrep, lxLtdspersFechaimpre, lxLtdspersInfcorrida, lxLtdspersInfocontex, lxLtdspersRepecabgru, lxLtdspersHoraexpo, lxLtdspersHaltafw, lxLtdspersHoraimpo, lxLtdspersSmodifw, lxLtdspersHmodifw, lxLtdspersVmodifw, lxLtdspersZadsfw, lxLtdspersValtafw, lxLtdspersUmodifw, lxLtdspersEsttrans, lxLtdspersUaltafw, lxLtdspersSaltafw, lxLtdspersBdaltafw, lxLtdspersBdmodifw, lxLtdspersCcod, lxLtdspersMpara, lxLtdspersClistado, lxLtdspersEsdefault, lxLtdspersCestilo, lxLtdspersMder, lxLtdspersIdentifica, lxLtdspersMasunto, lxLtdspersMizq, lxLtdspersMpie, lxLtdspersMcab, lxLtdspersOrien, lxLtdspersMcc, lxLtdspersOrdpor, lxLtdspersDescrip, lxLtdspersTipord, lxLtdspersTitulo, lxLtdspersImagen, lxLtdspersMcco, lxLtdspersDstnotip, lxLtdspersDbdato, lxLtdspersDbdatod, lxLtdspersDstnorut, lxLtdspersMensaje, lxLtdspersDstnoarc, lxLtdspersDstnofh, lxLtdspersSubtdetall, lxLtdspersObs, lxLtdspersDdetalle, lxLtdspersColorsombr
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ORGANIZACION.LTDSPERS ( "Faltafw","Fecimpo","Fmodifw","Fecexpo","Fectrans","Encdetalle","Encreporte","Mantgruni","Encpagina","Horaimpre","Colsubrecp","Anulado","Colgrupocp","Transpag","Pagsimple","Resumenrep","Fechaimpre","Infcorrida","Infocontex","Repecabgru","Horaexpo","Haltafw","Horaimpo","Smodifw","Hmodifw","Vmodifw","Zadsfw","Valtafw","Umodifw","Esttrans","Ualtafw","Saltafw","Bdaltafw","Bdmodifw","Ccod","Mpara","Clistado","Esdefault","Cestilo","Mder","Identifica","Masunto","Mizq","Mpie","Mcab","Orien","Mcc","Ordpor","Descrip","Tipord","Titulo","Imagen","Mcco","Dstnotip","Dbdato","Dbdatod","Dstnorut","Mensaje","Dstnoarc","Dstnofh","Subtdetall","Obs","Ddetalle","Colorsombr" ) values ( <<"'" + this.ConvertirDateSql( lxLtdspersFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLtdspersFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLtdspersFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLtdspersFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLtdspersFectrans ) + "'" >>, <<iif( lxLtdspersEncdetalle, 1, 0 ) >>, <<iif( lxLtdspersEncreporte, 1, 0 ) >>, <<iif( lxLtdspersMantgruni, 1, 0 ) >>, <<iif( lxLtdspersEncpagina, 1, 0 ) >>, <<iif( lxLtdspersHoraimpre, 1, 0 ) >>, <<iif( lxLtdspersColsubrecp, 1, 0 ) >>, <<iif( lxLtdspersAnulado, 1, 0 ) >>, <<iif( lxLtdspersColgrupocp, 1, 0 ) >>, <<iif( lxLtdspersTranspag, 1, 0 ) >>, <<iif( lxLtdspersPagsimple, 1, 0 ) >>, <<iif( lxLtdspersResumenrep, 1, 0 ) >>, <<iif( lxLtdspersFechaimpre, 1, 0 ) >>, <<iif( lxLtdspersInfcorrida, 1, 0 ) >>, <<iif( lxLtdspersInfocontex, 1, 0 ) >>, <<iif( lxLtdspersRepecabgru, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxLtdspersHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersCcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersMpara ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersClistado ) + "'" >>, <<iif( lxLtdspersEsdefault, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxLtdspersCestilo ) + "'" >>, <<lxLtdspersMder >>, <<"'" + this.FormatearTextoSql( lxLtdspersIdentifica ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersMasunto ) + "'" >>, <<lxLtdspersMizq >>, <<lxLtdspersMpie >>, <<lxLtdspersMcab >>, <<lxLtdspersOrien >>, <<"'" + this.FormatearTextoSql( lxLtdspersMcc ) + "'" >>, <<lxLtdspersOrdpor >>, <<"'" + this.FormatearTextoSql( lxLtdspersDescrip ) + "'" >>, <<lxLtdspersTipord >>, <<"'" + this.FormatearTextoSql( lxLtdspersTitulo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersImagen ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersMcco ) + "'" >>, <<lxLtdspersDstnotip >>, <<"'" + this.FormatearTextoSql( lxLtdspersDbdato ) + "'" >>, <<iif( lxLtdspersDbdatod, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxLtdspersDstnorut ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersMensaje ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLtdspersDstnoarc ) + "'" >>, <<iif( lxLtdspersDstnofh, 1, 0 ) >>, <<iif( lxLtdspersSubtdetall, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxLtdspersObs ) + "'" >>, <<iif( lxLtdspersDdetalle, 1, 0 ) >>, <<lxLtdspersColorsombr >> )
			endtext
		...
		this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.CamposDetalle
				if this.oEntidad.CamposDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETCAMTROPER("NROITEM","codigo","Identifica","idCampo","Etiqueta","Longitud","Decimales","Mceros","GrupoV","Expresion","ExpresionN","Calculo","nOrden","activado","LVertical","PCrecer","ORepetido","MImagen","WImagen","HImagen" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<"'" + this.FormatearTextoSql( lxEtiquetareporte ) + "'">>, <<lxLongitudreporte>>, <<lxDecimalesreporte>>, <<lxMostrarceros>>, <<lxGrupovisual>>, <<"'" + this.FormatearTextoSql( lxExpresion ) + "'">>, <<"'" + this.FormatearTextoSql( lxExpresionnueva_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipocalculo ) + "'">>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<iif( lxLineavertical, 1, 0 )>>, <<iif( lxPuedecrecer, 1, 0 )>>, <<iif( lxOcultarepetido, 1, 0 )>>, <<iif( lxTamañooriginalimagen, 1, 0 )>>, <<lxAnchoimagen>>, <<lxAltoimagen>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.SubtotalDetalle
				if this.oEntidad.SubtotalDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETCAMSUBPER("NROITEM","codigo","Identifica","idCampo","lpagenew","nOrden","activado","nSubtotal","Formula","Ancho","EtiqF" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<iif( lxLnuevapaginaantes, 1, 0 )>>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<lxNsubtotal>>, <<"'" + this.FormatearTextoSql( lxFormula ) + "'">>, <<lxAnchoformula>>, <<"'" + this.FormatearTextoSql( lxEtiquetaformula ) + "'">> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.OrdenamientosDetalle
				if this.oEntidad.OrdenamientosDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETCAMORDPER("NROITEM","codigo","Identifica","idCampo","nOrden","activado","Sentido" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<lxSentido>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
			...
			for each loItem in this.oEntidad.SalidasDetalle
				if this.oEntidad.SalidasDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxActivado = loItem.Activado
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETSALIDASLPER("NROITEM","codigo","tipo","Extendido","activado" ) values ( <<lxNroitem>>, <<"'" + this.FormatearTextoSql( lxValorClavePrimaria ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipo ) + "'">>, <<iif( lxExtendido, 1, 0 )>>, <<iif( lxActivado, 1, 0 )>> ) 
					endtext
					this.oConexion.EjecutarSql( strtran( lcCadena, chr(9), '' ) )
					this.ComprobarTransaccion()
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ORGANIZACION.LTDSPERS set "Faltafw" = <<"'" + this.ConvertirDateSql( lxLtdspersFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxLtdspersFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxLtdspersFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxLtdspersFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxLtdspersFectrans ) + "'">>,"Encdetalle" = <<iif( lxLtdspersEncdetalle, 1, 0 )>>,"Encreporte" = <<iif( lxLtdspersEncreporte, 1, 0 )>>,"Mantgruni" = <<iif( lxLtdspersMantgruni, 1, 0 )>>,"Encpagina" = <<iif( lxLtdspersEncpagina, 1, 0 )>>,"Horaimpre" = <<iif( lxLtdspersHoraimpre, 1, 0 )>>,"Colsubrecp" = <<iif( lxLtdspersColsubrecp, 1, 0 )>>,"Anulado" = <<iif( lxLtdspersAnulado, 1, 0 )>>,"Colgrupocp" = <<iif( lxLtdspersColgrupocp, 1, 0 )>>,"Transpag" = <<iif( lxLtdspersTranspag, 1, 0 )>>,"Pagsimple" = <<iif( lxLtdspersPagsimple, 1, 0 )>>,"Resumenrep" = <<iif( lxLtdspersResumenrep, 1, 0 )>>,"Fechaimpre" = <<iif( lxLtdspersFechaimpre, 1, 0 )>>,"Infcorrida" = <<iif( lxLtdspersInfcorrida, 1, 0 )>>,"Infocontex" = <<iif( lxLtdspersInfocontex, 1, 0 )>>,"Repecabgru" = <<iif( lxLtdspersRepecabgru, 1, 0 )>>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxLtdspersHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxLtdspersHaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxLtdspersHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersSmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersHmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxLtdspersZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxLtdspersValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersUmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxLtdspersEsttrans ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxLtdspersUaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxLtdspersSaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLtdspersBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersBdmodifw ) + "'">>,"Ccod" = <<"'" + this.FormatearTextoSql( lxLtdspersCcod ) + "'">>,"Mpara" = <<"'" + this.FormatearTextoSql( lxLtdspersMpara ) + "'">>,"Clistado" = <<"'" + this.FormatearTextoSql( lxLtdspersClistado ) + "'">>,"Esdefault" = <<iif( lxLtdspersEsdefault, 1, 0 )>>,"Cestilo" = <<"'" + this.FormatearTextoSql( lxLtdspersCestilo ) + "'">>,"Mder" = <<lxLtdspersMder>>,"Identifica" = <<"'" + this.FormatearTextoSql( lxLtdspersIdentifica ) + "'">>,"Masunto" = <<"'" + this.FormatearTextoSql( lxLtdspersMasunto ) + "'">>,"Mizq" = <<lxLtdspersMizq>>,"Mpie" = <<lxLtdspersMpie>>,"Mcab" = <<lxLtdspersMcab>>,"Orien" = <<lxLtdspersOrien>>,"Mcc" = <<"'" + this.FormatearTextoSql( lxLtdspersMcc ) + "'">>,"Ordpor" = <<lxLtdspersOrdpor>>,"Descrip" = <<"'" + this.FormatearTextoSql( lxLtdspersDescrip ) + "'">>,"Tipord" = <<lxLtdspersTipord>>,"Titulo" = <<"'" + this.FormatearTextoSql( lxLtdspersTitulo ) + "'">>,"Imagen" = <<"'" + this.FormatearTextoSql( lxLtdspersImagen ) + "'">>,"Mcco" = <<"'" + this.FormatearTextoSql( lxLtdspersMcco ) + "'">>,"Dstnotip" = <<lxLtdspersDstnotip>>,"Dbdato" = <<"'" + this.FormatearTextoSql( lxLtdspersDbdato ) + "'">>,"Dbdatod" = <<iif( lxLtdspersDbdatod, 1, 0 )>>,"Dstnorut" = <<"'" + this.FormatearTextoSql( lxLtdspersDstnorut ) + "'">>,"Mensaje" = <<"'" + this.FormatearTextoSql( lxLtdspersMensaje ) + "'">>,"Dstnoarc" = <<"'" + this.FormatearTextoSql( lxLtdspersDstnoarc ) + "'">>,"Dstnofh" = <<iif( lxLtdspersDstnofh, 1, 0 )>>,"Subtdetall" = <<iif( lxLtdspersSubtdetall, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxLtdspersObs ) + "'">>,"Ddetalle" = <<iif( lxLtdspersDdetalle, 1, 0 )>>,"Colorsombr" = <<lxLtdspersColorsombr>> where "Ccod" = <<"'" + this.FormatearTextoSql( lxLtdspersCcod ) + "'">> and  LTDSPERS.CCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Faltafw" as "Fechaaltafw", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Fectrans" as "Fechatransferencia", "Encdetalle" as "Imprimeencabezadodedetalle", "Encreporte" as "Imprimeencabezadodereporte", "Mantgruni" as "Mantenergruposunidos", "Encpagina" as "Imprimeencabezadodepagina", "Horaimpre" as "Imprimehoradeimpresion", "Colsubrecp" as "Titulosdecolumnasdesubreporteencp", "Anulado" as "Anulado", "Colgrupocp" as "Titulosdecolumnasdegrupoencp", "Transpag" as "Usatransporteentrepaginas", "Pagsimple" as "Numeraciondepaginasimple", "Resumenrep" as "Imprimeresumendereporte", "Fechaimpre" as "Imprimefechadeimpresion", "Infcorrida" as "Imprimeinformaciondecorrida", "Infocontex" as "Imprimeinformaciondecontexto", "Repecabgru" as "Repetircabecerasdegrupos", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Hmodifw" as "Horamodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Esttrans" as "Estadotransferencia", "Ualtafw" as "Usuarioaltafw", "Saltafw" as "Seriealtafw", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Ccod" as "Codigo", "Mpara" as "Mailpara", "Clistado" as "Clistado", "Esdefault" as "Esdefault", "Cestilo" as "Estilo", "Mder" as "Margenderecho", "Identifica" as "Identificadorordenamiento", "Masunto" as "Mailasunto", "Mizq" as "Margenizquierdo", "Mpie" as "Margenpie", "Mcab" as "Margencabecera", "Orien" as "Orientacion", "Mcc" as "Mailconcopia", "Ordpor" as "Ordenadopor", "Descrip" as "Descripcion", "Tipord" as "Tipoordenamiento", "Titulo" as "Titulolistado", "Imagen" as "Imagenlistado", "Mcco" as "Mailconcopiaoculta", "Dstnotip" as "Destinotipo", "Dbdato" as "Basededatos", "Dbdatod" as "Basededatosdetallada", "Dstnorut" as "Destinoruta", "Mensaje" as "Mailmensaje", "Dstnoarc" as "Destinoarchivo", "Dstnofh" as "Destinofechahora", "Subtdetall" as "Subtotaldetallado", "Obs" as "Observacion", "Ddetalle" as "Diferenciardetalle", "Colorsombr" as "Colorparaelsombreado" from ORGANIZACION.LTDSPERS where "Ccod" = <<"'" + this.FormatearTextoSql( lxLtdspersCcod ) + "'">> and  LTDSPERS.CCOD != ''
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Identifica" as "Identificador", "Idcampo" as "Idcampo", "Norden" as "Norden", "Activado" as "Activado", "Sentido" as "Sentido" from ORGANIZACION.DETCAMORDPER where codigo = <<"'" + this.FormatearTextoSql( c_LISTADOSPERSONALIZADOS.CODIGO ) + "'">> Order by NroItem
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Nroitem" as "Nroitem", "Codigo" as "Codigo", "Tipo" as "Tipo", "Extendido" as "Extendido", "Activado" as "Activado" from ORGANIZACION.DETSALIDASLPER where codigo = <<"'" + this.FormatearTextoSql( c_LISTADOSPERSONALIZADOS.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Faltafw,Fecimpo,Fmodifw,Fecexpo,Fectrans,Encdetalle,Encreporte,Mantgruni,Encpagina,Horaimpre" + ;
",Colsubrecp,Anulado,Colgrupocp,Transpag,Pagsimple,Resumenrep,Fechaimpre,Infcorrida,Infocontex,Repeca" + ;
"bgru,Horaexpo,Haltafw,Horaimpo,Smodifw,Hmodifw,Vmodifw,Zadsfw,Valtafw,Umodifw,Esttrans,Ualtafw,Salta" + ;
"fw,Bdaltafw,Bdmodifw,Ccod,Mpara,Clistado,Esdefault,Cestilo,Mder,Identifica,Masunto,Mizq,Mpie,Mcab,Or" + ;
"ien,Mcc,Ordpor,Descrip,Tipord,Titulo,Imagen,Mcco,Dstnotip,Dbdato,Dbdatod,Dstnorut,Mensaje,Dstnoarc,D" + ;
"stnofh,Subtdetall,Obs,Ddetalle,Colorsombr" + ;
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleFiltrosDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Identifica" as "Identificador", "Idcampo" as "Idcampo", "Desde" as "Valordesde", "Sld" as "Sololecturadesde", "Hasta" as "Valorhasta", "Slh" as "Sololecturahasta", "Norden" as "Norden", "Activado" as "Activado", "Criteinit" as "Criteriodeinicializacion", "Diasatras" as "Diashaciaatras", "Vnidesde" as "Valornumericoinicial_desde", "Vnihasta" as "Valornumericoinicial_hasta", "Vcidesde" as "Valorcaracterinicial_desde", "Vcihasta" as "Valorcaracterinicial_hasta", "Vibooleano" as "Valorbooleanoinicial", "Visinobool" as "Valorsinoinicial", "Slectura" as "Sololectura", "Noinformar" as "Noinformar", "Nomostrar" as "Nomostrar"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleCamposDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Identifica" as "Identificador", "Idcampo" as "Idcampo", "Etiqueta" as "Etiquetareporte", "Longitud" as "Longitudreporte", "Decimales" as "Decimalesreporte", "Mceros" as "Mostrarceros", "Grupov" as "Grupovisual", "Expresion" as "Expresion", "Expresionn" as "Expresionnueva", "Calculo" as "Tipocalculo", "Norden" as "Norden", "Activado" as "Activado", "Lvertical" as "Lineavertical", "Pcrecer" as "Puedecrecer", "Orepetido" as "Ocultarepetido", "Mimagen" as "Tamañooriginalimagen", "Wimagen" as "Anchoimagen", "Himagen" as "Altoimagen"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleSubtotalDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Identifica" as "Identificador", "Idcampo" as "Idcampo", "Lpagenew" as "Lnuevapaginaantes", "Norden" as "Norden", "Activado" as "Activado", "Nsubtotal" as "Nsubtotal", "Formula" as "Formula", "Ancho" as "Anchoformula", "Etiqf" as "Etiquetaformula"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleOrdenamientosDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Identifica" as "Identificador", "Idcampo" as "Idcampo", "Norden" as "Norden", "Activado" as "Activado", "Sentido" as "Sentido"
				endtext
			Else
	...
	*--------------------------------------------------------------------------------------------------------
	Function ObtenerDatosDetalleSalidasDetalle( tcAtributos As String, tcHaving As String, tcOrder As String, tcFunc As String, tnTope as Integer ) As String
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Nroitem" as "Nroitem", "Codigo" as "Codigo", "Tipo" as "Tipo", "Extendido" as "Extendido", "Activado" as "Activado"
				endtext
			Else
		...
		With this
			...
			for each loItem in this.oEntidad.FiltrosDetalle
				if this.oEntidad.FiltrosDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxNomostrar = loItem.Nomostrar
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETFILTROPER("NROITEM","codigo","Identifica","idCampo","desde","SLD","hasta","SLH","nOrden","activado","CriteInit","DiasAtras","VNIDesde","VNIHasta","VCIDesde","VCIHasta","VIBooleano","VISiNoBool","SLectura","NoInformar","NoMostrar" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<"'" + this.FormatearTextoSql( lxValordesde ) + "'">>, <<iif( lxSololecturadesde, 1, 0 )>>, <<"'" + this.FormatearTextoSql( lxValorhasta ) + "'">>, <<iif( lxSololecturahasta, 1, 0 )>>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<lxCriteriodeinicializacion>>, <<lxDiashaciaatras>>, <<lxValornumericoinicial_desde>>, <<lxValornumericoinicial_hasta>>, <<"'" + this.FormatearTextoSql( lxValorcaracterinicial_desde ) + "'">>, <<"'" + this.FormatearTextoSql( lxValorcaracterinicial_hasta ) + "'">>, <<lxValorbooleanoinicial>>, <<lxValorsinoinicial>>, <<iif( lxSololectura, 1, 0 )>>, <<iif( lxNoinformar, 1, 0 )>>, <<iif( lxNomostrar, 1, 0 )>> ) 
					endtext
			...
			for each loItem in this.oEntidad.CamposDetalle
				if this.oEntidad.CamposDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxAltoimagen = loItem.Altoimagen
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETCAMTROPER("NROITEM","codigo","Identifica","idCampo","Etiqueta","Longitud","Decimales","Mceros","GrupoV","Expresion","ExpresionN","Calculo","nOrden","activado","LVertical","PCrecer","ORepetido","MImagen","WImagen","HImagen" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<"'" + this.FormatearTextoSql( lxEtiquetareporte ) + "'">>, <<lxLongitudreporte>>, <<lxDecimalesreporte>>, <<lxMostrarceros>>, <<lxGrupovisual>>, <<"'" + this.FormatearTextoSql( lxExpresion ) + "'">>, <<"'" + this.FormatearTextoSql( lxExpresionnueva_PK ) + "'">>, <<"'" + this.FormatearTextoSql( lxTipocalculo ) + "'">>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<iif( lxLineavertical, 1, 0 )>>, <<iif( lxPuedecrecer, 1, 0 )>>, <<iif( lxOcultarepetido, 1, 0 )>>, <<iif( lxTamañooriginalimagen, 1, 0 )>>, <<lxAnchoimagen>>, <<lxAltoimagen>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.SubtotalDetalle
				if this.oEntidad.SubtotalDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxEtiquetaformula = loItem.Etiquetaformula
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETCAMSUBPER("NROITEM","codigo","Identifica","idCampo","lpagenew","nOrden","activado","nSubtotal","Formula","Ancho","EtiqF" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<iif( lxLnuevapaginaantes, 1, 0 )>>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<lxNsubtotal>>, <<"'" + this.FormatearTextoSql( lxFormula ) + "'">>, <<lxAnchoformula>>, <<"'" + this.FormatearTextoSql( lxEtiquetaformula ) + "'">> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.OrdenamientosDetalle
				if this.oEntidad.OrdenamientosDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxSentido = loItem.Sentido
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETCAMORDPER("NROITEM","codigo","Identifica","idCampo","nOrden","activado","Sentido" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxIdentificador ) + "'">>, <<lxIdcampo>>, <<lxNorden>>, <<iif( lxActivado, 1, 0 )>>, <<lxSentido>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
			...
			for each loItem in this.oEntidad.SalidasDetalle
				if this.oEntidad.SalidasDetalle.ValidarExistenciaCamposFijosItemPlano( loItem.NroItem )
					...
					lxActivado = loItem.Activado
					Text to lcCadena noshow textmerge
						Insert into ORGANIZACION.DETSALIDASLPER("NROITEM","codigo","tipo","Extendido","activado" ) values ( <<lxNroitem>>, << lcValorClavePrimariaString >>, <<"'" + this.FormatearTextoSql( lxTipo ) + "'">>, <<iif( lxExtendido, 1, 0 )>>, <<iif( lxActivado, 1, 0 )>> ) 
					endtext
					loColeccion.Agregar( strtran( lcCadena, chr(9), '' ) )
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ORGANIZACION.LTDSPERS set "Faltafw" = <<"'" + this.ConvertirDateSql( lxLtdspersFaltafw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxLtdspersFecimpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxLtdspersFmodifw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxLtdspersFecexpo ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxLtdspersFectrans ) + "'">>, "Encdetalle" = <<iif( lxLtdspersEncdetalle, 1, 0 )>>, "Encreporte" = <<iif( lxLtdspersEncreporte, 1, 0 )>>, "Mantgruni" = <<iif( lxLtdspersMantgruni, 1, 0 )>>, "Encpagina" = <<iif( lxLtdspersEncpagina, 1, 0 )>>, "Horaimpre" = <<iif( lxLtdspersHoraimpre, 1, 0 )>>, "Colsubrecp" = <<iif( lxLtdspersColsubrecp, 1, 0 )>>, "Anulado" = <<iif( lxLtdspersAnulado, 1, 0 )>>, "Colgrupocp" = <<iif( lxLtdspersColgrupocp, 1, 0 )>>, "Transpag" = <<iif( lxLtdspersTranspag, 1, 0 )>>, "Pagsimple" = <<iif( lxLtdspersPagsimple, 1, 0 )>>, "Resumenrep" = <<iif( lxLtdspersResumenrep, 1, 0 )>>, "Fechaimpre" = <<iif( lxLtdspersFechaimpre, 1, 0 )>>, "Infcorrida" = <<iif( lxLtdspersInfcorrida, 1, 0 )>>, "Infocontex" = <<iif( lxLtdspersInfocontex, 1, 0 )>>, "Repecabgru" = <<iif( lxLtdspersRepecabgru, 1, 0 )>>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxLtdspersHoraexpo ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxLtdspersHaltafw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxLtdspersHoraimpo ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersSmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersHmodifw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersVmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxLtdspersZadsfw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxLtdspersValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersUmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxLtdspersEsttrans ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxLtdspersUaltafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxLtdspersSaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLtdspersBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLtdspersBdmodifw ) + "'">>, "Ccod" = <<"'" + this.FormatearTextoSql( lxLtdspersCcod ) + "'">>, "Mpara" = <<"'" + this.FormatearTextoSql( lxLtdspersMpara ) + "'">>, "Clistado" = <<"'" + this.FormatearTextoSql( lxLtdspersClistado ) + "'">>, "Esdefault" = <<iif( lxLtdspersEsdefault, 1, 0 )>>, "Cestilo" = <<"'" + this.FormatearTextoSql( lxLtdspersCestilo ) + "'">>, "Mder" = <<lxLtdspersMder>>, "Identifica" = <<"'" + this.FormatearTextoSql( lxLtdspersIdentifica ) + "'">>, "Masunto" = <<"'" + this.FormatearTextoSql( lxLtdspersMasunto ) + "'">>, "Mizq" = <<lxLtdspersMizq>>, "Mpie" = <<lxLtdspersMpie>>, "Mcab" = <<lxLtdspersMcab>>, "Orien" = <<lxLtdspersOrien>>, "Mcc" = <<"'" + this.FormatearTextoSql( lxLtdspersMcc ) + "'">>, "Ordpor" = <<lxLtdspersOrdpor>>, "Descrip" = <<"'" + this.FormatearTextoSql( lxLtdspersDescrip ) + "'">>, "Tipord" = <<lxLtdspersTipord>>, "Titulo" = <<"'" + this.FormatearTextoSql( lxLtdspersTitulo ) + "'">>, "Imagen" = <<"'" + this.FormatearTextoSql( lxLtdspersImagen ) + "'">>, "Mcco" = <<"'" + this.FormatearTextoSql( lxLtdspersMcco ) + "'">>, "Dstnotip" = <<lxLtdspersDstnotip>>, "Dbdato" = <<"'" + this.FormatearTextoSql( lxLtdspersDbdato ) + "'">>, "Dbdatod" = <<iif( lxLtdspersDbdatod, 1, 0 )>>, "Dstnorut" = <<"'" + this.FormatearTextoSql( lxLtdspersDstnorut ) + "'">>, "Mensaje" = <<"'" + this.FormatearTextoSql( lxLtdspersMensaje ) + "'">>, "Dstnoarc" = <<"'" + this.FormatearTextoSql( lxLtdspersDstnoarc ) + "'">>, "Dstnofh" = <<iif( lxLtdspersDstnofh, 1, 0 )>>, "Subtdetall" = <<iif( lxLtdspersSubtdetall, 1, 0 )>>, "Obs" = <<"'" + this.FormatearTextoSql( lxLtdspersObs ) + "'">>, "Ddetalle" = <<iif( lxLtdspersDdetalle, 1, 0 )>>, "Colorsombr" = <<lxLtdspersColorsombr>> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'LTDSPERS' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ORGANIZACION.LTDSPERS set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, encdetalle = ] + Transform( iif( &lcCursor..encdetalle, 1, 0 ))+ [, encreporte = ] + Transform( iif( &lcCursor..encreporte, 1, 0 ))+ [, mantgruni = ] + Transform( iif( &lcCursor..mantgruni, 1, 0 ))+ [, encpagina = ] + Transform( iif( &lcCursor..encpagina, 1, 0 ))+ [, horaimpre = ] + Transform( iif( &lcCursor..horaimpre, 1, 0 ))+ [, colsubreCP = ] + Transform( iif( &lcCursor..colsubreCP, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, colgrupoCP = ] + Transform( iif( &lcCursor..colgrupoCP, 1, 0 ))+ [, transpag = ] + Transform( iif( &lcCursor..transpag, 1, 0 ))+ [, pagsimple = ] + Transform( iif( &lcCursor..pagsimple, 1, 0 ))+ [, resumenrep = ] + Transform( iif( &lcCursor..resumenrep, 1, 0 ))+ [, fechaimpre = ] + Transform( iif( &lcCursor..fechaimpre, 1, 0 ))+ [, infcorrida = ] + Transform( iif( &lcCursor..infcorrida, 1, 0 ))+ [, infocontex = ] + Transform( iif( &lcCursor..infocontex, 1, 0 ))+ [, repecabgru = ] + Transform( iif( &lcCursor..repecabgru, 1, 0 ))+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'"+ [, Mpara = ] + "'" + this.FormatearTextoSql( &lcCursor..Mpara ) + "'"+ [, cListado = ] + "'" + this.FormatearTextoSql( &lcCursor..cListado ) + "'"+ [, EsDefault = ] + Transform( iif( &lcCursor..EsDefault, 1, 0 ))+ [, cEstilo = ] + "'" + this.FormatearTextoSql( &lcCursor..cEstilo ) + "'"+ [, Mder = ] + transform( &lcCursor..Mder )+ [, Identifica = ] + "'" + this.FormatearTextoSql( &lcCursor..Identifica ) + "'"+ [, Masunto = ] + "'" + this.FormatearTextoSql( &lcCursor..Masunto ) + "'"+ [, mizq = ] + transform( &lcCursor..mizq )+ [, mpie = ] + transform( &lcCursor..mpie )+ [, mcab = ] + transform( &lcCursor..mcab )+ [, Orien = ] + transform( &lcCursor..Orien )+ [, Mcc = ] + "'" + this.FormatearTextoSql( &lcCursor..Mcc ) + "'"+ [, OrdPor = ] + transform( &lcCursor..OrdPor )+ [, descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'"+ [, TipOrd = ] + transform( &lcCursor..TipOrd )+ [, titulo = ] + "'" + this.FormatearTextoSql( &lcCursor..titulo ) + "'"+ [, Imagen = ] + "'" + this.FormatearTextoSql( &lcCursor..Imagen ) + "'"+ [, Mcco = ] + "'" + this.FormatearTextoSql( &lcCursor..Mcco ) + "'"+ [, dstnotip = ] + transform( &lcCursor..dstnotip )+ [, dbDato = ] + "'" + this.FormatearTextoSql( &lcCursor..dbDato ) + "'"+ [, dbDatoD = ] + Transform( iif( &lcCursor..dbDatoD, 1, 0 ))+ [, dstnorut = ] + "'" + this.FormatearTextoSql( &lcCursor..dstnorut ) + "'"+ [, Mensaje = ] + "'" + this.FormatearTextoSql( &lcCursor..Mensaje ) + "'"+ [, dstnoarc = ] + "'" + this.FormatearTextoSql( &lcCursor..dstnoarc ) + "'"+ [, dstnofh = ] + Transform( iif( &lcCursor..dstnofh, 1, 0 ))+ [, subtDetall = ] + Transform( iif( &lcCursor..subtDetall, 1, 0 ))+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, DDetalle = ] + Transform( iif( &lcCursor..DDetalle, 1, 0 ))+ [, ColorSombr = ] + transform( &lcCursor..ColorSombr ) + [ Where cCod = ] + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" )
				...
				Text to lcCampos noShow
					 FALTAFW, FECIMPO, FMODIFW, FECEXPO, FECTRANS, encdetalle, encreporte, mantgruni, encpagina, horaimpre, colsubreCP, Anulado, colgrupoCP, transpag, pagsimple, resumenrep, fechaimpre, infcorrida, infocontex, repecabgru, HORAEXPO, HALTAFW, HORAIMPO, SMODIFW, HMODIFW, VMODIFW, ZADSFW, VALTAFW, UMODIFW, ESTTRANS, UALTAFW, SALTAFW, BDALTAFW, BDMODIFW, cCod, Mpara, cListado, EsDefault, cEstilo, Mder, Identifica, Masunto, mizq, mpie, mcab, Orien, Mcc, OrdPor, descrip, TipOrd, titulo, Imagen, Mcco, dstnotip, dbDato, dbDatoD, dstnorut, Mensaje, dstnoarc, dstnofh, subtDetall, Obs, DDetalle, ColorSombr
				EndText
				local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + Transform( iif( &lcCursor..encdetalle, 1, 0 )) + ',' + Transform( iif( &lcCursor..encreporte, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..mantgruni, 1, 0 )) + ',' + Transform( iif( &lcCursor..encpagina, 1, 0 )) + ',' + Transform( iif( &lcCursor..horaimpre, 1, 0 )) + ',' + Transform( iif( &lcCursor..colsubreCP, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + Transform( iif( &lcCursor..colgrupoCP, 1, 0 )) + ',' + Transform( iif( &lcCursor..transpag, 1, 0 )) + ',' + Transform( iif( &lcCursor..pagsimple, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..resumenrep, 1, 0 )) + ',' + Transform( iif( &lcCursor..fechaimpre, 1, 0 )) + ',' + Transform( iif( &lcCursor..infcorrida, 1, 0 )) + ',' + Transform( iif( &lcCursor..infocontex, 1, 0 )) + ',' + Transform( iif( &lcCursor..repecabgru, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCod ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Mpara ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..cListado ) + "'" + ',' + Transform( iif( &lcCursor..EsDefault, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..cEstilo ) + "'" + ',' + transform( &lcCursor..Mder ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Identifica ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Masunto ) + "'" + ',' + transform( &lcCursor..mizq ) + ',' + transform( &lcCursor..mpie )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..mcab ) + ',' + transform( &lcCursor..Orien ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Mcc ) + "'" + ',' + transform( &lcCursor..OrdPor ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..descrip ) + "'" + ',' + transform( &lcCursor..TipOrd ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..titulo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Imagen ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Mcco ) + "'" + ',' + transform( &lcCursor..dstnotip ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..dbDato ) + "'" + ',' + Transform( iif( &lcCursor..dbDatoD, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..dstnorut ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Mensaje ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..dstnoarc ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","codigo","Identifica","idCampo","Etiqueta","Longitud","Decimales","Mceros","GrupoV","Expresion","ExpresionN","Calculo","nOrden","activado","LVertical","PCrecer","ORepetido","MImagen","WImagen","HImagen"
		endText
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","codigo","Identifica","idCampo","nOrden","activado","Sentido"
		endText
		this.oConexion.EjecutarSql( [Insert into ORGANIZACION.DETCAMORDPER ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.Identifica ) + "'" + ',' + transform( cDetallesExistentes.idCampo    ) + ',' + transform( cDetallesExistentes.nOrden     ) + ',' + Transform( iif( cDetallesExistentes.activado  , 1, 0 )) + ',' + transform( cDetallesExistentes.Sentido    ) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
	...
	Scan All
		Text to lcCamposInsert noShow
			"NROITEM","codigo","tipo","Extendido","activado"
		endText
		this.oConexion.EjecutarSql( [Insert into ORGANIZACION.DETSALIDASLPER ( ] + lcCamposInsert + [ ) values ( ] +  transform( cDetallesExistentes.NROITEM    ) + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.codigo     ) + "'" + ',' + "'" + this.FormatearTextoSql( cDetallesExistentes.tipo       ) + "'" + ',' + Transform( iif( cDetallesExistentes.Extendido , 1, 0 )) + ',' + Transform( iif( cDetallesExistentes.activado  , 1, 0 )) + ' )'  )
		select cDetallesExistentes
	EndScan
	Use in select( 'cDetallesExistentes' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.ENCDETALLE = isnull( d.ENCDETALLE, t.ENCDETALLE ),t.ENCREPORTE = isnull( d.ENCREPORTE, t.ENCREPORTE ),t.MANTGRUNI = isnull( d.MANTGRUNI, t.MANTGRUNI ),t.ENCPAGINA = isnull( d.ENCPAGINA, t.ENCPAGINA ),t.HORAIMPRE = isnull( d.HORAIMPRE, t.HORAIMPRE ),t.COLSUBRECP = isnull( d.COLSUBRECP, t.COLSUBRECP ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.COLGRUPOCP = isnull( d.COLGRUPOCP, t.COLGRUPOCP ),t.TRANSPAG = isnull( d.TRANSPAG, t.TRANSPAG ),t.PAGSIMPLE = isnull( d.PAGSIMPLE, t.PAGSIMPLE ),t.RESUMENREP = isnull( d.RESUMENREP, t.RESUMENREP ),t.FECHAIMPRE = isnull( d.FECHAIMPRE, t.FECHAIMPRE ),t.INFCORRIDA = isnull( d.INFCORRIDA, t.INFCORRIDA ),t.INFOCONTEX = isnull( d.INFOCONTEX, t.INFOCONTEX ),t.REPECABGRU = isnull( d.REPECABGRU, t.REPECABGRU ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.CCOD = isnull( d.CCOD, t.CCOD ),t.MPARA = isnull( d.MPARA, t.MPARA ),t.CLISTADO = isnull( d.CLISTADO, t.CLISTADO ),t.ESDEFAULT = isnull( d.ESDEFAULT, t.ESDEFAULT ),t.CESTILO = isnull( d.CESTILO, t.CESTILO ),t.MDER = isnull( d.MDER, t.MDER ),t.IDENTIFICA = isnull( d.IDENTIFICA, t.IDENTIFICA ),t.MASUNTO = isnull( d.MASUNTO, t.MASUNTO ),t.MIZQ = isnull( d.MIZQ, t.MIZQ ),t.MPIE = isnull( d.MPIE, t.MPIE ),t.MCAB = isnull( d.MCAB, t.MCAB ),t.ORIEN = isnull( d.ORIEN, t.ORIEN ),t.MCC = isnull( d.MCC, t.MCC ),t.ORDPOR = isnull( d.ORDPOR, t.ORDPOR ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.TIPORD = isnull( d.TIPORD, t.TIPORD ),t.TITULO = isnull( d.TITULO, t.TITULO ),t.IMAGEN = isnull( d.IMAGEN, t.IMAGEN ),t.MCCO = isnull( d.MCCO, t.MCCO ),t.DSTNOTIP = isnull( d.DSTNOTIP, t.DSTNOTIP ),t.DBDATO = isnull( d.DBDATO, t.DBDATO ),t.DBDATOD = isnull( d.DBDATOD, t.DBDATOD ),t.DSTNORUT = isnull( d.DSTNORUT, t.DSTNORUT ),t.MENSAJE = isnull( d.MENSAJE, t.MENSAJE ),t.DSTNOARC = isnull( d.DSTNOARC, t.DSTNOARC ),t.DSTNOFH = isnull( d.DSTNOFH, t.DSTNOFH ),t.SUBTDETALL = isnull( d.SUBTDETALL, t.SUBTDETALL ),t.OBS = isnull( d.OBS, t.OBS ),t.DDETALLE = isnull( d.DDETALLE, t.DDETALLE ),t.COLORSOMBR = isnull( d.COLORSOMBR, t.COLORSOMBR )
					from ORGANIZACION.LTDSPERS t inner join deleted d 
							 on t.cCod = d.cCod
				-- Fin Updates
				insert into ORGANIZACION.LTDSPERS(Faltafw,Fecimpo,Fmodifw,Fecexpo,Fectrans,Encdetalle,Encreporte,Mantgruni,Encpagina,Horaimpre,Colsubrecp,Anulado,Colgrupocp,Transpag,Pagsimple,Resumenrep,Fechaimpre,Infcorrida,Infocontex,Repecabgru,Horaexpo,Haltafw,Horaimpo,Smodifw,Hmodifw,Vmodifw,Zadsfw,Valtafw,Umodifw,Esttrans,Ualtafw,Saltafw,Bdaltafw,Bdmodifw,Ccod,Mpara,Clistado,Esdefault,Cestilo,Mder,Identifica,Masunto,Mizq,Mpie,Mcab,Orien,Mcc,Ordpor,Descrip,Tipord,Titulo,Imagen,Mcco,Dstnotip,Dbdato,Dbdatod,Dstnorut,Mensaje,Dstnoarc,Dstnofh,Subtdetall,Obs,Ddetalle,Colorsombr)
					Select CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.ENCDETALLE,0),isnull( d.ENCREPORTE,0),isnull( d.MANTGRUNI,0),isnull( d.ENCPAGINA,0),isnull( d.HORAIMPRE,0),isnull( d.COLSUBRECP,0),isnull( d.ANULADO,0),isnull( d.COLGRUPOCP,0),isnull( d.TRANSPAG,0),isnull( d.PAGSIMPLE,0),isnull( d.RESUMENREP,0),isnull( d.FECHAIMPRE,0),isnull( d.INFCORRIDA,0),isnull( d.INFOCONTEX,0),isnull( d.REPECABGRU,0),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.HMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.UALTAFW,''),isnull( d.SALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.CCOD,''),isnull( d.MPARA,''),isnull( d.CLISTADO,''),isnull( d.ESDEFAULT,0),isnull( d.CESTILO,''),isnull( d.MDER,0),isnull( d.IDENTIFICA,''),isnull( d.MASUNTO,''),isnull( d.MIZQ,0),isnull( d.MPIE,0),isnull( d.MCAB,0),isnull( d.ORIEN,0),isnull( d.MCC,''),isnull( d.ORDPOR,0),isnull( d.DESCRIP,''),isnull( d.TIPORD,0),isnull( d.TITULO,''),isnull( d.IMAGEN,''),isnull( d.MCCO,''),isnull( d.DSTNOTIP,0),isnull( d.DBDATO,''),isnull( d.DBDATOD,0),isnull( d.DSTNORUT,''),isnull( d.MENSAJE,''),isnull( d.DSTNOARC,''),isnull( d.DSTNOFH,0),isnull( d.SUBTDETALL,0),isnull( d.OBS,''),isnull( d.DDETALLE,0),isnull( d.COLORSOMBR,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="LISTADOSPERSONALIZADOS                  " atributo="FECHATRANSFERENCIA                      " tabla="LTDSPERS       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LISTADOSPERSONALIZADOS                  " atributo="ESTADOTRANSFERENCIA                     " tabla="LTDSPERS       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
