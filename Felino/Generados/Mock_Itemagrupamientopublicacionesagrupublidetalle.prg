...
define class Mock_Itemagrupamientopublicacionesagrupublidetalle as MockBase of MockBase.prg

	cClase = 'Itemagrupamientopublicacionesagrupublidetalle'
	...
	*-----------------------------------------------------------------------------------------
	function agrupamiento_access() as variant                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Agrupamiento_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agrupamiento_pk_assign( txval as variant ) as void                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Agrupamiento_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agrupamiento_pk_despuesdeasignar() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Agrupamiento_pk_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agrupamientodetalle_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Agrupamientodetalle_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesardespuesdesetearagrupamiento() as void                                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Procesardespuesdesetearagrupamiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_agrupamientodetalle( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_agrupamientodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_agrupamientodetalle( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_agrupamientodetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaragrupamientopermitido() as void                                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaragrupamientopermitido', lcParametros )
	EndFunc
