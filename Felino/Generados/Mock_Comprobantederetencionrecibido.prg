...
define class Mock_comprobantederetencionrecibido as MockBase of MockBase.prg
	...
	cClase = 'comprobantederetencionrecibido'
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalleretencionesdetalle() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalleretencionesdetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function retencionesdetalle_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTEDERETENCIONRECIBIDO' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'retencionesdetalle_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'retencionesdetalle_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Retencionesdetalle ) = 'O' or isnull( this.Retencionesdetalle ) )			this.Retencionesdetalle = this.crearobjeto( 'Din_DetalleComprobantederetencionrecibidoRetencionesdetalle' )			this.Retencionesdetalle.inicializar()			this.enlazar( 'Retencionesdetalle.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Retencionesdetalle.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Retencionesdetalle, 'CambioSumarizado', this, 'CambiosDetalleRetencionesdetalle', 1)			this.enlazar( 'Retencionesdetalle.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Retencionesdetalle.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Retencionesdetalle.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Retencionesdetalle
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoregimen() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Valorsugeridoregimen', lcParametros )
	EndFunc
