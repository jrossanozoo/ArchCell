...
define class Din_ItemDEVOLUCIONImpuestosdetalle as ItemIMPUESTOS of ItemIMPUESTOS.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'DEVOLUCION', 'Impuestosdetalle')
