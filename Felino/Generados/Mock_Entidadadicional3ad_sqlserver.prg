...
define class Mock_Entidadadicional3ad_sqlserver as MockBase of MockBase.prg

	cClase = 'Entidadadicional3ad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubea3( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubea3', lcParametros )
	EndFunc
