...
define class Mock_Detalleconfiguracionarticuloecommercecategoriasecom as MockBase of MockBase.prg

	cClase = 'Detalleconfiguracionarticuloecommercecategoriasecom'
