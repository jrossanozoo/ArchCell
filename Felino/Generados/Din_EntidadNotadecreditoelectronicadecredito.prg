...
define class Din_EntidadNOTADECREDITOELECTRONICADECREDITO as Ent_ComprobanteElectronicoNacional of Ent_ComprobanteElectronicoNacional.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<ANULABLE><VENTAS><CONVALORES><FISCAL><CE><NOLISTAGENERICO><VALORCIERRE><DESCUENTOAUTOMATICO><ACTUALIZAEMAILCLIENTE>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
