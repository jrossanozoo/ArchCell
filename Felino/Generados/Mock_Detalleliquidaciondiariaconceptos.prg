...
define class Mock_Detalleliquidaciondiariaconceptos as MockBase of MockBase.prg

	cClase = 'Detalleliquidaciondiariaconceptos'
	...
	cMensajeErrorUnicidad = 'Las columnas Código + Código no admiten valores repetidos.'                                                                                                                                                                      
	cNombre = 'Conceptos'                                                                                                                                                                                                                                     
	cNombreVisual = "Impuestos"                                                                                                                                                                                                                               
	cNombreVisual = 'Conceptos'                                                                                                                                                                                                                               
	datasession = 1                                                                                                                                                                                                                                           
