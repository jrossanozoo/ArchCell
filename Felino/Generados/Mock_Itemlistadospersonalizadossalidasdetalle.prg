...
define class Mock_Itemlistadospersonalizadossalidasdetalle as MockBase of MockBase.prg

	cClase = 'Itemlistadospersonalizadossalidasdetalle'
	...
	*-----------------------------------------------------------------------------------------
	function extendido_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Extendido_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_extendido( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_extendido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_extendido( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_extendido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoextendido() as void                                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Valorsugeridoextendido', lcParametros )
	EndFunc
