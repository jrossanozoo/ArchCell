...
define class Din_EntidadREGISTRODEACTIVIDADAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRegactivFecimpo, lxRegactivFectrans, lxRegactivFmodifw, lxRegactivFaltafw, lxRegactivFecexpo, lxRegactivHmodifw, lxRegactivSaltafw, lxRegactivSmodifw, lxRegactivUmodifw, lxRegactivVmodifw, lxRegactivZadsfw, lxRegactivValtafw, lxRegactivUaltafw, lxRegactivHoraimpo, lxRegactivBdmodifw, lxRegactivBdaltafw, lxRegactivEsttrans, lxRegactivHaltafw, lxRegactivHoraexpo, lxRegactivCcodigo, lxRegactivCactividad, lxRegactivCfechaini, lxRegactivChoraini, lxRegactivCfechafin, lxRegactivChorafin, lxRegactivBdaltafw, lxRegactivNneto, lxRegactivObs, lxRegactivInvocador
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REGACTIV ( "Fecimpo","Fectrans","Fmodifw","Faltafw","Fecexpo","Hmodifw","Saltafw","Smodifw","Umodifw","Vmodifw","Zadsfw","Valtafw","Ualtafw","Horaimpo","Bdmodifw","Bdaltafw","Esttrans","Haltafw","Horaexpo","Ccodigo","Cactividad","Cfechaini","Choraini","Cfechafin","Chorafin","Nneto","Obs","Invocador" ) values ( <<"'" + this.ConvertirDateSql( lxRegactivFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactivFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactivFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactivFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactivFecexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivCcodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivCactividad ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactivCfechaini ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivChoraini ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRegactivCfechafin ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivChorafin ) + "'" >>, <<lxRegactivNneto >>, <<"'" + this.FormatearTextoSql( lxRegactivObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRegactivInvocador ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REGACTIV set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxRegactivFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRegactivFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxRegactivFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRegactivFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRegactivFecexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRegactivHmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRegactivSaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRegactivSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRegactivUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRegactivVmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRegactivZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRegactivValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRegactivUaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRegactivHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRegactivBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRegactivBdaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRegactivEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRegactivHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRegactivHoraexpo ) + "'">>,"Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegactivCcodigo ) + "'">>,"Cactividad" = <<"'" + this.FormatearTextoSql( lxRegactivCactividad ) + "'">>,"Cfechaini" = <<"'" + this.ConvertirDateSql( lxRegactivCfechaini ) + "'">>,"Choraini" = <<"'" + this.FormatearTextoSql( lxRegactivChoraini ) + "'">>,"Cfechafin" = <<"'" + this.ConvertirDateSql( lxRegactivCfechafin ) + "'">>,"Chorafin" = <<"'" + this.FormatearTextoSql( lxRegactivChorafin ) + "'">>,"Nneto" = <<lxRegactivNneto>>,"Obs" = <<"'" + this.FormatearTextoSql( lxRegactivObs ) + "'">>,"Invocador" = <<"'" + this.FormatearTextoSql( lxRegactivInvocador ) + "'">> where "Ccodigo" = <<"'" + this.FormatearTextoSql( lxRegactivCcodigo ) + "'">> and  REGACTIV.CCODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Hmodifw,Saltafw,Smodifw,Umodifw,Vmodifw,Zadsfw,Valt" + ;
"afw,Ualtafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Horaexpo,Ccodigo,Cactividad,Cfechaini,Chorai" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.REGACTIV set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, cCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'"+ [, cActividad = ] + "'" + this.FormatearTextoSql( &lcCursor..cActividad ) + "'"+ [, cFechaIni = ] + "'" + this.ConvertirDateSql( &lcCursor..cFechaIni ) + "'"+ [, cHoraIni = ] + "'" + this.FormatearTextoSql( &lcCursor..cHoraIni ) + "'"+ [, cFechaFin = ] + "'" + this.ConvertirDateSql( &lcCursor..cFechaFin ) + "'"+ [, cHoraFin = ] + "'" + this.FormatearTextoSql( &lcCursor..cHoraFin ) + "'"+ [, BDAltaFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDAltaFW ) + "'"+ [, nNeto = ] + transform( &lcCursor..nNeto )+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Invocador = ] + "'" + this.FormatearTextoSql( &lcCursor..Invocador ) + "'" + [ Where cCodigo = ] + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FECTRANS, FMODIFW, FALTAFW, FECEXPO, HMODIFW, SALTAFW, SMODIFW, UMODIFW, VMODIFW, ZADSFW, VALTAFW, UALTAFW, HORAIMPO, BDMODIFW, BDALTAFW, ESTTRANS, HALTAFW, HORAEXPO, cCodigo, cActividad, cFechaIni, cHoraIni, cFechaFin, cHoraFin, BDAltaFW, nNeto, Obs, Invocador
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cCodigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..cActividad ) + "'"
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad REGISTRODEACTIVIDAD. Hay un error en el diseño de importación.' )
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CCODIGO = isnull( d.CCODIGO, t.CCODIGO ),t.CACTIVIDAD = isnull( d.CACTIVIDAD, t.CACTIVIDAD ),t.CFECHAINI = isnull( d.CFECHAINI, t.CFECHAINI ),t.CHORAINI = isnull( d.CHORAINI, t.CHORAINI ),t.CFECHAFIN = isnull( d.CFECHAFIN, t.CFECHAFIN ),t.CHORAFIN = isnull( d.CHORAFIN, t.CHORAFIN ),t.NNETO = isnull( d.NNETO, t.NNETO ),t.OBS = isnull( d.OBS, t.OBS ),t.INVOCADOR = isnull( d.INVOCADOR, t.INVOCADOR )
					from ZooLogic.REGACTIV t inner join deleted d 
							 on t.cCodigo = d.cCodigo
				-- Fin Updates
				insert into ZooLogic.REGACTIV(Fecimpo,Fectrans,Fmodifw,Faltafw,Fecexpo,Hmodifw,Saltafw,Smodifw,Umodifw,Vmodifw,Zadsfw,Valtafw,Ualtafw,Horaimpo,Bdmodifw,Bdaltafw,Esttrans,Haltafw,Horaexpo,Ccodigo,Cactividad,Cfechaini,Choraini,Cfechafin,Chorafin,Nneto,Obs,Invocador)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.HMODIFW,''),isnull( d.SALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.CCODIGO,''),isnull( d.CACTIVIDAD,''),isnull( d.CFECHAINI,''),isnull( d.CHORAINI,''),isnull( d.CFECHAFIN,''),isnull( d.CHORAFIN,''),isnull( d.NNETO,0),isnull( d.OBS,''),isnull( d.INVOCADOR,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="FECHAIMPO                               " tabla="REGACTIV       " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="FECHATRANSFERENCIA                      " tabla="REGACTIV       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="FECHAMODIFICACIONFW                     " tabla="REGACTIV       " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="FECHAEXPO                               " tabla="REGACTIV       " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="SERIEMODIFICACIONFW                     " tabla="REGACTIV       " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="VERSIONMODIFICACIONFW                   " tabla="REGACTIV       " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="VERSIONALTAFW                           " tabla="REGACTIV       " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="ESTADOTRANSFERENCIA                     " tabla="REGACTIV       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="HORAEXPO                                " tabla="REGACTIV       " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="HORAFIN                                 " tabla="REGACTIV       " campo="CHORAFIN  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Hora fin del inicio del Sistema                                                                                                                                 " dominio="HORA                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REGISTRODEACTIVIDAD                     " atributo="TIEMPONETOSININTERACCIONDELUSUARIO      " tabla="REGACTIV       " campo="NNETO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="13" decimales="3" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Tiempo neto sin interacción del usuario                                                                                                                         " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="8" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
