...
define class Din_EntidadENTIDADADICIONAL1AD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxEntadic1Fecimpo, lxEntadic1Fectrans, lxEntadic1Fmodifw, lxEntadic1Fecexpo, lxEntadic1Faltafw, lxEntadic1Tipagrupub, lxEntadic1Ualtafw, lxEntadic1Smodifw, lxEntadic1Umodifw, lxEntadic1Saltafw, lxEntadic1Zadsfw, lxEntadic1Valtafw, lxEntadic1Vmodifw, lxEntadic1Haltafw, lxEntadic1Bdmodifw, lxEntadic1Bdaltafw, lxEntadic1Hmodifw, lxEntadic1Esttrans, lxEntadic1Horaimpo, lxEntadic1Horaexpo, lxEntadic1Cod, lxEntadic1Descri, lxEntadic1Obs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ENTADIC1 ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Tipagrupub","Ualtafw","Smodifw","Umodifw","Saltafw","Zadsfw","Valtafw","Vmodifw","Haltafw","Bdmodifw","Bdaltafw","Hmodifw","Esttrans","Horaimpo","Horaexpo","Cod","Descri","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxEntadic1Fecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic1Fectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic1Fmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic1Fecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEntadic1Faltafw ) + "'" >>, <<lxEntadic1Tipagrupub >>, <<"'" + this.FormatearTextoSql( lxEntadic1Ualtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Smodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Umodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Saltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Zadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Valtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Vmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Haltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Bdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Bdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Hmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Esttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Horaimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Horaexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Cod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Descri ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEntadic1Obs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ENTADIC1 set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEntadic1Fecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEntadic1Fectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEntadic1Fmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxEntadic1Fecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEntadic1Faltafw ) + "'">>,"Tipagrupub" = <<lxEntadic1Tipagrupub>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEntadic1Ualtafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEntadic1Smodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEntadic1Umodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEntadic1Saltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEntadic1Zadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEntadic1Valtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic1Vmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEntadic1Haltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic1Bdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEntadic1Bdaltafw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEntadic1Hmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEntadic1Esttrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEntadic1Horaimpo ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEntadic1Horaexpo ) + "'">>,"Cod" = <<"'" + this.FormatearTextoSql( lxEntadic1Cod ) + "'">>,"Descri" = <<"'" + this.FormatearTextoSql( lxEntadic1Descri ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxEntadic1Obs ) + "'">> where "Cod" = <<"'" + this.FormatearTextoSql( lxEntadic1Cod ) + "'">> and  ENTADIC1.COD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC1 where  ENTADIC1.COD != '' order by Cod
			endtext
			use in select('c_ENTIDADADICIONAL1')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL1', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC1 where  funciones.padr( Cod, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ENTADIC1.COD != '' order by Cod
			endtext
			use in select('c_ENTIDADADICIONAL1')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL1', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC1 where  funciones.padr( Cod, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ENTADIC1.COD != '' order by Cod desc
			endtext
			use in select('c_ENTIDADADICIONAL1')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL1', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Tipagrupub" as "Tipoagrupamientopublicaciones", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Hmodifw" as "Horamodificacionfw", "Esttrans" as "Estadotransferencia", "Horaimpo" as "Horaimpo", "Horaexpo" as "Horaexpo", "Cod" as "Codigo", "Descri" as "Descri", "Obs" as "Obs" from ZooLogic.ENTADIC1 where  ENTADIC1.COD != '' order by Cod desc
			endtext
			use in select('c_ENTIDADADICIONAL1')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ENTIDADADICIONAL1', set( 'Datasession' ) )
			local lcSentencia as string
...
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function ValidarDatosAImportar() as boolean
		...
		if llCondicion
			this.oEntidad.Loguear( 'No se puede importar la entidad ENTIDADADICIONAL1. Hay un error en el diseño de importación.' )
			...
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.TIPAGRUPUB = isnull( d.TIPAGRUPUB, t.TIPAGRUPUB ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.COD = isnull( d.COD, t.COD ),t.DESCRI = isnull( d.DESCRI, t.DESCRI ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.ENTADIC1 t inner join deleted d 
							 on t.Cod = d.Cod
				-- Fin Updates
				insert into ZooLogic.ENTADIC1(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Tipagrupub,Ualtafw,Smodifw,Umodifw,Saltafw,Zadsfw,Valtafw,Vmodifw,Haltafw,Bdmodifw,Bdaltafw,Hmodifw,Esttrans,Horaimpo,Horaexpo,Cod,Descri,Obs)
...
<VFPData xml:space="preserve">
	...
	<row entidad="ENTIDADADICIONAL1                       " atributo="FECHAIMPO                               " tabla="ENTADIC1       " campo="FECIMPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha importación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL1                       " atributo="FECHATRANSFERENCIA                      " tabla="ENTADIC1       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL1                       " atributo="FECHAMODIFICACIONFW                     " tabla="ENTADIC1       " campo="FMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha modificación                                                                                                                                              " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL1                       " atributo="FECHAEXPO                               " tabla="ENTADIC1       " campo="FECEXPO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha exportación                                                                                                                                               " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL1                       " atributo="SERIEMODIFICACIONFW                     " tabla="ENTADIC1       " campo="SMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="7" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Serie modificación                                                                                                                                              " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL1                       " atributo="VERSIONALTAFW                           " tabla="ENTADIC1       " campo="VALTAFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión alta                                                                                                                                                    " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ENTIDADADICIONAL1                       " atributo="VERSIONMODIFICACIONFW                   " tabla="ENTADIC1       " campo="VMODIFW   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Versión modificación                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL1                       " atributo="ESTADOTRANSFERENCIA                     " tabla="ENTADIC1       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL1                       " atributo="HORAEXPO                                " tabla="ENTADIC1       " campo="HORAEXPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Hora exportación                                                                                                                                                " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ENTIDADADICIONAL1                       " atributo="DESCRI                                  " tabla="ENTADIC1       " campo="DESCRI    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
