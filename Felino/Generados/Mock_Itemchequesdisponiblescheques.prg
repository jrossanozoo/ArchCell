...
define class Mock_Itemchequesdisponiblescheques as MockBase of MockBase.prg

	cClase = 'Itemchequesdisponiblescheques'
	...
	*-----------------------------------------------------------------------------------------
	function codigocheque_assign( txval as variant ) as void                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Codigocheque_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function interno_assign( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Interno_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_interno( txval as variant ) as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Setear_interno', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigocheque( txval as variant ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function validar_interno( txval as variant ) as boolean                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Validar_interno', lcParametros )
	EndFunc
