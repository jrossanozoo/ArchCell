...
define class Din_ItemREDONDEODEPRECIOSDetredondeoporentero as ItemActivo of ItemActivo.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Inicializar() as boolean
		...
		oICol = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugeridoDeUnaEntidadDetalle( 'REDONDEODEPRECIOS', 'Detredondeoporentero')
		...
		if This.CargaManual()
			if this.Validar_Terminacioncaracter( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Terminacioncaracter', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Redondeo de precios - Atributo: Terminacioncaracter)" )
				endif 
			EndIf
		Else
			This.Setear_Terminacioncaracter( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Desde( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Desde', lxValOld, lxVal  )
					...
					this.Desde = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Redondeo de precios - Atributo: Desde)" )
				endif 
			EndIf
		Else
			This.Setear_Desde( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Hasta( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Hasta', lxValOld, lxVal  )
					...
					this.Hasta = lxValOld
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Redondeo de precios - Atributo: Hasta)" )
				endif 
			EndIf
		Else
			This.Setear_Hasta( lxVal ) 
		...
		if This.CargaManual()
			if this.Validar_Terminacion( lxVal )
				...
				this.EventoDespuesDeSetear( This, 'Terminacion', lxValOld, lxVal  )
					...
					goServicios.Errores.LevantarExcepcion( "No se puede cambiar este valor (Entidad: Redondeo de precios - Atributo: Terminacion)" )
				endif 
			EndIf
		Else
			This.Setear_Terminacion( lxVal ) 
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoTerminacioncaracter() as void
		...
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "REDONDEODEPRECIOS", "Detredondeoporentero", "Terminacioncaracter" )
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDesde() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "REDONDEODEPRECIOS", "Detredondeoporentero", "Desde" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoHasta() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "REDONDEODEPRECIOS", "Detredondeoporentero", "Hasta" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoDesdeprecio() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "REDONDEODEPRECIOS", "Detredondeoporentero", "Desdeprecio" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
	...
	*--------------------------------------------------------------------------------------------------------
	Function ValorSugeridoHastaprecio() as void
		...
		lcExpresionValorSugeridoDefinidoPorElUsuario = null
		with this
			lcExpresionValorSugeridoDefinidoPorElUsuario = goServicios.SaltosDeCampoYValoresSugeridos.ObtenerValorSugerido( "REDONDEODEPRECIOS", "Detredondeoporentero", "Hastaprecio" )
			if !isnull( lcExpresionValorSugeridoDefinidoPorElUsuario )
				if !empty( lcExpresionValorSugeridoDefinidoPorElUsuario )
					try
						lvValorSugeridoDefinidoPorElUsuario = &lcExpresionValorSugeridoDefinidoPorElUsuario
