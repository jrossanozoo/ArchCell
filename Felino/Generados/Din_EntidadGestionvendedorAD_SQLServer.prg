...
define class Din_EntidadGESTIONVENDEDORAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxGesvenFecexpo, lxGesvenFectrans, lxGesvenFmodifw, lxGesvenFaltafw, lxGesvenFecimpo, lxGesvenHaltafw, lxGesvenHoraexpo, lxGesvenHmodifw, lxGesvenSmodifw, lxGesvenSaltafw, lxGesvenHoraimpo, lxGesvenUmodifw, lxGesvenBdaltafw, lxGesvenZadsfw, lxGesvenBdmodifw, lxGesvenEsttrans, lxGesvenValtafw, lxGesvenVmodifw, lxGesvenUaltafw, lxGesvenCodigo, lxGesvenFch, lxGesvenVen, lxGesvenFchdes, lxGesvenFchhas, lxGesvenBase, lxGesvenSucur, lxGesvenObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.GESVEN ( "Fecexpo","Fectrans","Fmodifw","Faltafw","Fecimpo","Haltafw","Horaexpo","Hmodifw","Smodifw","Saltafw","Horaimpo","Umodifw","Bdaltafw","Zadsfw","Bdmodifw","Esttrans","Valtafw","Vmodifw","Ualtafw","Codigo","Fch","Ven","Fchdes","Fchhas","Base","Sucur","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxGesvenFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFecimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenCodigo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFch ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenVen ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFchdes ) + "'" >>, <<"'" + this.ConvertirDateSql( lxGesvenFchhas ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenBase ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenSucur ) + "'" >>, <<"'" + this.FormatearTextoSql( lxGesvenObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.GESVEN set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxGesvenFecexpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxGesvenFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxGesvenFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxGesvenFaltafw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxGesvenFecimpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxGesvenHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxGesvenHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxGesvenHmodifw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxGesvenSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxGesvenSaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxGesvenHoraimpo ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxGesvenUmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxGesvenBdaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxGesvenZadsfw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxGesvenBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxGesvenEsttrans ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxGesvenValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxGesvenVmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxGesvenUaltafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxGesvenCodigo ) + "'">>,"Fch" = <<"'" + this.ConvertirDateSql( lxGesvenFch ) + "'">>,"Ven" = <<"'" + this.FormatearTextoSql( lxGesvenVen ) + "'">>,"Fchdes" = <<"'" + this.ConvertirDateSql( lxGesvenFchdes ) + "'">>,"Fchhas" = <<"'" + this.ConvertirDateSql( lxGesvenFchhas ) + "'">>,"Base" = <<"'" + this.FormatearTextoSql( lxGesvenBase ) + "'">>,"Sucur" = <<"'" + this.FormatearTextoSql( lxGesvenSucur ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxGesvenObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxGesvenCodigo ) + "'">> and  GESVEN.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Haltafw,Horaexpo,Hmodifw,Smodifw,Saltafw,Horaimpo,U" + ;
"modifw,Bdaltafw,Zadsfw,Bdmodifw,Esttrans,Valtafw,Vmodifw,Ualtafw,Codigo,Fch,Ven,Fchdes,Fchhas,Base,S" + ;
"ucur,Obs" + ;
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				...
				Text to lcCampos noShow
					 FECEXPO, FECTRANS, FMODIFW, FALTAFW, FECIMPO, HALTAFW, HORAEXPO, HMODIFW, SMODIFW, SALTAFW, HORAIMPO, UMODIFW, BDALTAFW, ZADSFW, BDMODIFW, ESTTRANS, VALTAFW, VMODIFW, UALTAFW, CODIGO, FCH, VEN, FCHDES, FCHHAS, BASE, SUCUR, Obs
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FCH ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VEN ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FCHDES ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FCHHAS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BASE ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SUCUR ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FCH = isnull( d.FCH, t.FCH ),t.VEN = isnull( d.VEN, t.VEN ),t.FCHDES = isnull( d.FCHDES, t.FCHDES ),t.FCHHAS = isnull( d.FCHHAS, t.FCHHAS ),t.BASE = isnull( d.BASE, t.BASE ),t.SUCUR = isnull( d.SUCUR, t.SUCUR ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.GESVEN t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.GESVEN(Fecexpo,Fectrans,Fmodifw,Faltafw,Fecimpo,Haltafw,Horaexpo,Hmodifw,Smodifw,Saltafw,Horaimpo,Umodifw,Bdaltafw,Zadsfw,Bdmodifw,Esttrans,Valtafw,Vmodifw,Ualtafw,Codigo,Fch,Ven,Fchdes,Fchhas,Base,Sucur,Obs)
					Select isnull( d.FECEXPO,''),isnull( d.FECTRANS,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECIMPO,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.UMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.ZADSFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.UALTAFW,''),isnull( d.CODIGO,''),isnull( d.FCH,''),isnull( d.VEN,''),isnull( d.FCHDES,''),isnull( d.FCHHAS,''),isnull( d.BASE,''),isnull( d.SUCUR,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="GESTIONVENDEDOR                         " atributo="BASEDEDATOS                             " tabla="GESVEN         " campo="BASE      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="400" etiqueta="Base de datos                                                                                                                                                   " dominio="COMBOSUCURSALESCONVACIO       " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="25" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="GESTIONVENDEDOR                         " atributo="SUCURSAL                                " tabla="GESVEN         " campo="SUCUR     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="SUCURSAL                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Sucursal                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="BASEDEDATOS.SUCURSAL                                                                                                                                                                                                                                          " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="SUCURSAL                                " atributo="NOMBRE                                  " tabla="SUC            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="13" etiqueta="Detalle Suc.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join SUC On GESVEN.SUCUR = SUC.codigo And  SUC.CODIGO != ''                                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
