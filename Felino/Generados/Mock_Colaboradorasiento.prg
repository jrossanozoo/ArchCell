...
define class Mock_COLABORADORASIENTO as MockBase of MockBase.prg

	cClase = 'COLABORADORASIENTO'

	
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cRangoDeAsientosGenerados = ""                                                                                                                                                                                                                            
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	lDestroy = .f.                                                                                                                                                                                                                                            
	lEsExe = .f.                                                                                                                                                                                                                                              
	lLoguear = .T.                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function actualizarcursorasientodeajusteporinflacion( tccursorasiento, tccursormovimientosdelmes, tnmes, tnaño, toentidadcierre ) as void                                                                                                                 
		...
		lnParametros = pcount()
		lxParam1 = tccursorasiento
		lxParam2 = tccursormovimientosdelmes
		lxParam3 = tnmes
		lxParam4 = tnaño
		lxParam5 = toentidadcierre
		...
		return this.ObtenerResultado( 'Actualizarcursorasientodeajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function agregarreferenciaacierredeejercicioenasientosreversados( tncierreejercicio as integer, tcprimerasiento as string, tcsegundoasiento as string ) as void                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tncierreejercicio
		lxParam2 = tcprimerasiento
		lxParam3 = tcsegundoasiento
		...
		return this.ObtenerResultado( 'Agregarreferenciaacierredeejercicioenasientosreversados', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function crearcursorasiento( tccursor as string ) as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Crearcursorasiento', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarasientodeajusteporinflacion( toentidad as object ) as void                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Generarasientodeajusteporinflacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarasientosautomaticos( toentidad as object ) as object                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Generarasientosautomaticos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarasientosporcierreconajusteporinflacion( toentidad as object, tlasientodeajuste as boolean, tnclaseasiento as integer ) as void                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = toentidad
		lxParam2 = tlasientodeajuste
		lxParam3 = tnclaseasiento
		...
		return this.ObtenerResultado( 'Generarasientosporcierreconajusteporinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function llenarcursorconmovimientosdelmesqueajustanporinflacion( tcmes as string, tcaño as string, tccursor as string, tntipoasiento as integer ) as void                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Llenarcursorconmovimientosdelmesqueajustanporinflacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function llenarcursorcontabilizacionasientostipo( tocontabilizacion as object, tccursor as string ) as void                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tocontabilizacion
		lxParam2 = tccursor
		...
		return this.ObtenerResultado( 'Llenarcursorcontabilizacionasientostipo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function llenarcursorcontabilizacioncmv( tocontabilizacion as object, tccursor as string ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenarcursorcontabilizacioncmv', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercantidadgenerados( tclista as string) as string                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercantidadgenerados', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerfechadesdemesformateadaparasql( tcmes as string, tcaño as string ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerfechadesdemesformateadaparasql', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerfechahastamesformateadaparasql( tcmes as string, tcaño as string ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerfechahastamesformateadaparasql', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerfiltrodetiposdeasientos( tnasientosincluidos as integer ) as string                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tnasientosincluidos
		...
		return this.ObtenerResultado( 'Obtenerfiltrodetiposdeasientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerindicedeinflacion( tnmes, tnaño, tnañodelcierre, tnmesdelcierre, tccodigoindice ) as integer                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5
		...
		lxParam1 = tnmes
		lxParam2 = tnaño
		lxParam3 = tnañodelcierre
		lxParam4 = tnmesdelcierre
		lxParam5 = tccodigoindice
		...
		return this.ObtenerResultado( 'Obtenerindicedeinflacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function oentidadasiento_access() as void                                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oentidadasiento_access', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function oentidadindicesinflacion_access() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Oentidadindicesinflacion_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function realizacontabilizacioncostomercaderiavendida( toentidad as object ) as boolean                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function reversarasientosporcierrehistoricos( tncierreejercicio as integer ) as void                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Reversarasientosporcierrehistoricos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agregardatosextra( tocoleccion as object, toentidad as object ) as void                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Agregardatosextra', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function armarparametroscontabilizaporasientotipo( tocontabilizacion as object ) as string                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Armarparametroscontabilizaporasientotipo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function asignarfecha( txvalue ) as date                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Asignarfecha', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function cargarinformacion( toasiento as object ) as void                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	protected function generarasientodeajusteenentidad( tosolicitante as object, tccursor as string, tnclase as number ) as object                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tosolicitante
		lxParam2 = tccursor
		lxParam3 = tnclase
		...
		return this.ObtenerResultado( 'Generarasientodeajusteenentidad', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function generarasientos( tosolicitante as object, tccursor as string, tnclase as number ) as object                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Generarasientos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarcursorcierreejerciciopatrimonial( tocierre as object, tccursor as string ) as void                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenarcursorcierreejerciciopatrimonial', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenarcursorcierreejerciciorefundicion( tocierre as object, tccursor as string ) as void                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenarcursorcierreejerciciorefundicion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenaritem( todetalle as object, toitem as object ) as void                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenaritem', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function llenaritemdeajusteporinflacion( todetalle as object, toitem as object ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Llenaritemdeajusteporinflacion', lcParametros )
	EndFunc
