...
define class Din_DetalleAJUSTEDESTOCKStockafectadoauditoriaentransito as DetalleAjustecombinacion of DetalleAjustecombinacion.Prg
	...
	function Sumarizar() as boolean
		...
		with this
			...
			if this.lEsNavegacion
				if select( 'c_Stockafectadoauditoriaentransito' ) > 0 and reccount( 'c_Stockafectadoauditoriaentransito' ) > 0
					sum Cantidad;
						 to ;
						 lnSum_Cantidad
				endif
	...
	*--------------------------------------------------------------------------------------------------------
	function oItem_Access() as variant
		if !this.ldestroy and ( !vartype( this.oItem ) = 'O' or isnull( this.oItem ) )
			this.oItem = _Screen.zoo.crearobjeto( 'Din_ItemAJUSTEDESTOCKStockafectadoauditoriaentransito' )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Cargar() as Void
		...
		select c_Stockafectadoauditoriaentransito
		lcFiltro = this.ObtenerFiltro()
		scan for &lcFiltro
			loItem = createobject('ItemAuxiliar')

			loItem.codigo = c_Stockafectadoauditoriaentransito.codigo
			loItem.Comportamiento = c_Stockafectadoauditoriaentransito.Comportamiento
			loItem.NROITEM = c_Stockafectadoauditoriaentransito.NROITEM
			loItem.Articulo_PK = c_Stockafectadoauditoriaentransito.Articulo
			loItem.ArticuloDetalle = c_Stockafectadoauditoriaentransito.ArticuloDetalle
			loItem.Color_PK = c_Stockafectadoauditoriaentransito.Color
			loItem.ColorDetalle = c_Stockafectadoauditoriaentransito.ColorDetalle
			loItem.Talle = c_Stockafectadoauditoriaentransito.Talle
			loItem.StockAct = c_Stockafectadoauditoriaentransito.StockAct
			loItem.StockProy = c_Stockafectadoauditoriaentransito.StockProy
			loItem.Cantidad = c_Stockafectadoauditoriaentransito.Cantidad
			loItem.NroItem = lnI 
