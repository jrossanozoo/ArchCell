...
define class Mock_Entidadadicional2ad_sqlserver as MockBase of MockBase.prg

	cClase = 'Entidadadicional2ad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrupubea2( tctablatrabajo ) as string                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrupubea2', lcParametros )
	EndFunc
