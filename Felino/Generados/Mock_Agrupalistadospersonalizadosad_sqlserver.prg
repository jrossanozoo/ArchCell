...
define class Mock_Agrupalistadospersonalizadosad_sqlserver as MockBase of MockBase.prg

	cClase = 'Agrupalistadospersonalizadosad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetallereferencias( tcatributo as string ) as string                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Obtenercampodetallereferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetallereferencias( tccampos as string ) as string                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetallereferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetallereferencias( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                    
		...
		return this.ObtenerResultado( 'Obtenerdatosdetallereferencias', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_agrpltdsdet( tctablatrabajo ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_agrpltdsdet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetallereferencias( tccampos as string ) as string                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Parsearcamposdetallereferencias', lcParametros )
	EndFunc
