...
define class Mock_COLABORADORCONSULTASDESTOCK as MockBase of MockBase.prg

	cClase = 'COLABORADORCONSULTASDESTOCK'

	
	cAgrupamiento = ""                                                                                                                                                                                                                                        
	cBaseDeDatosActivaEnInicializacion= ""                                                                                                                                                                                                                    
	cCampoCantidad = ""                                                                                                                                                                                                                                       
	cFormatoFechaNet = ""                                                                                                                                                                                                                                     
	cTabla = ""                                                                                                                                                                                                                                               
	lDesarrollo = .f.                                                                                                                                                                                                                                         
	...
	*-----------------------------------------------------------------------------------------
	function debehacerarqueodecaja( tobdsacerrar ) as boolean                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Debehacerarqueodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerbds() as void                                                                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenerbds', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercajasabiertasenbd( tcbasededatos as string ) as object                                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercajasabiertasenbd', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercoleccionconunfiltro( tcatributo as string, txvalor as object ) as void                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenercoleccionconunfiltro', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercombinacionesconstockdearticulo( tofiltros as object, tcatributoscombinacion as string, tcatributoscombinacionasatributos as string ) as object                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tofiltros
		lxParam2 = tcatributoscombinacion
		lxParam3 = tcatributoscombinacionasatributos
		...
		return this.ObtenerResultado( 'Obtenercombinacionesconstockdearticulo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerdatosentidadvalor( tcbdacerrar, tccursor, tovalor ) as void                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tcbdacerrar
		lxParam2 = tccursor
		lxParam3 = tovalor
		...
		return this.ObtenerResultado( 'Obtenerdatosentidadvalor', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerfiltrosparaconsultastockcombinacion( toitem as object, toentidadstockcombinacion  as object ) as zoocoleccion of zoocoleccion.prg                                                                                                         
		...
		lnParametros = pcount()
		lxParam1 = toitem
		lxParam2 = toentidadstockcombinacion
		...
		return this.ObtenerResultado( 'Obtenerfiltrosparaconsultastockcombinacion', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerfiltrosparaconsultastockcombinacionesdearticulo( tcarticulo as string, toentidadstockcombinacion as object ) as object                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerfiltrosparaconsultastockcombinacionesdearticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerstockdisponible( tofiltros as zoocoleccion of zoocoleccion.prg ) as double                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerstockdisponible', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function olistadesucursales_access() as zoocoleccion of zoocoleccion.prg                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Olistadesucursales_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puedehacerarqueodecaja( tobdsacerrar ) as boolean                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Puedehacerarqueodecaja', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function agrupar( tccursor as string, tcatributos as string, tcatributoscombinacionasatributos as string ) as void                                                                                                                              
		...
		return this.ObtenerResultado( 'Agrupar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function existeelagrupamiento( tcagrupamiento ) as boolean                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Existeelagrupamiento', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenercombinacionesconstockdearticuloenbasededatos( tcsucursal as string, tofiltros as object, tcatributoscombinacion as string, tccursoracumulado as string ) as object                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4
		...
		return this.ObtenerResultado( 'Obtenercombinacionesconstockdearticuloenbasededatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerconsultaaejecutar( tcsucursal as string, tofiltros as zoocoleccion of zoocoleccion.prg ) as string                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerconsultaaejecutar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerconsultadecombinaciondearticuloaejecutar( tcsucursal as string, tofiltros as zoocoleccion of zoocoleccion.prg, tcatributoscombinacion as string ) as string                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Obtenerconsultadecombinaciondearticuloaejecutar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenerstockdisponibleenbasededatos( tcsucursal as string, tofiltros as zoocoleccion of zoocoleccion.prg ) as double                                                                                                                   
		...
		return this.ObtenerResultado( 'Obtenerstockdisponibleenbasededatos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenertabla( tcsucursal as string ) as string                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertabla', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	protected function obtenerwhere( tofiltros as zoocoleccion of zoocoleccion.prg ) as string                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
