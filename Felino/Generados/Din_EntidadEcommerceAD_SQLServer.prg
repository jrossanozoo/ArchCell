	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.ECOM ( "Fecimpo","Faltafw","Fecexpo","Fmodifw","Fectrans","Horaimpo","Hmodifw","Horaexpo","Bdmodifw","Bdaltafw","Haltafw","Saltafw","Esttrans","Zadsfw","Vmodifw","Ualtafw","Smodifw","Umodifw","Valtafw","Codigo","Valecamb","Cuenta","Codlista","Accion","Factsinper","Cuentacom","Vendedor","Buzon","Fecnov","Idvinc","Tipoecom","Transpor","Basededato","Motivo","Ultorder","Vacio","Dtosenvio","Generacan","Pago","Condpago","Valctacte","Cliedef","Telenvio","Descartar","Usaotrabd","Convenv","Conccolor","Conctalle","Concart","Cargaautov","Dtospago","Pedido","Origenst","Percctacte","Numero","Remito","Accionfe","Aplicenvio","Nrocarrito","Factmanual","Buzonfe","Pefactman","Factmcep","Pefactmcep","Enlaceop","Factmvc","Bdfe","Factelec","Pefactelec","Factecep","Datosret","Pefactecep","Factevc","Factfiscal","Observa","Pefactfisc","Factfcep","Pefactfcep","Factfvc","Pagado","Promos","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxEcomFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEcomFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEcomFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEcomFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEcomFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomCodigo ) + "'" >>, <<iif( lxEcomValecamb, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomCuenta ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomAccion ) + "'" >>, <<iif( lxEcomFactsinper, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomCuentacom ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomVendedor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomBuzon ) + "'" >>, <<"'" + this.ConvertirDateSql( lxEcomFecnov ) + "'" >>, <<lxEcomIdvinc >>, <<lxEcomTipoecom >>, <<"'" + this.FormatearTextoSql( lxEcomTranspor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomBasededato ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomMotivo ) + "'" >>, <<lxEcomUltorder >>, <<iif( lxEcomVacio, 1, 0 ) >>, <<iif( lxEcomDtosenvio, 1, 0 ) >>, <<iif( lxEcomGeneracan, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomPago ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomCondpago ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomValctacte ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomCliedef ) + "'" >>, <<iif( lxEcomTelenvio, 1, 0 ) >>, <<iif( lxEcomDescartar, 1, 0 ) >>, <<iif( lxEcomUsaotrabd, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomConvenv ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomConccolor ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomConctalle ) + "'" >>, <<"'" + this.FormatearTextoSql( lxEcomConcart ) + "'" >>, <<iif( lxEcomCargaautov, 1, 0 ) >>, <<iif( lxEcomDtospago, 1, 0 ) >>, <<iif( lxEcomPedido, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomOrigenst ) + "'" >>, <<iif( lxEcomPercctacte, 1, 0 ) >>, <<iif( lxEcomNumero, 1, 0 ) >>, <<iif( lxEcomRemito, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomAccionfe ) + "'" >>, <<lxEcomAplicenvio >>, <<iif( lxEcomNrocarrito, 1, 0 ) >>, <<iif( lxEcomFactmanual, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomBuzonfe ) + "'" >>, <<iif( lxEcomPefactman, 1, 0 ) >>, <<iif( lxEcomFactmcep, 1, 0 ) >>, <<iif( lxEcomPefactmcep, 1, 0 ) >>, <<iif( lxEcomEnlaceop, 1, 0 ) >>, <<iif( lxEcomFactmvc, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomBdfe ) + "'" >>, <<iif( lxEcomFactelec, 1, 0 ) >>, <<iif( lxEcomPefactelec, 1, 0 ) >>, <<iif( lxEcomFactecep, 1, 0 ) >>, <<iif( lxEcomDatosret, 1, 0 ) >>, <<iif( lxEcomPefactecep, 1, 0 ) >>, <<iif( lxEcomFactevc, 1, 0 ) >>, <<iif( lxEcomFactfiscal, 1, 0 ) >>, <<iif( lxEcomObserva, 1, 0 ) >>, <<iif( lxEcomPefactfisc, 1, 0 ) >>, <<iif( lxEcomFactfcep, 1, 0 ) >>, <<iif( lxEcomPefactfcep, 1, 0 ) >>, <<iif( lxEcomFactfvc, 1, 0 ) >>, <<iif( lxEcomPagado, 1, 0 ) >>, <<iif( lxEcomPromos, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxEcomObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.ECOM set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEcomFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxEcomFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxEcomFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxEcomFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxEcomFectrans ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxEcomHoraimpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxEcomHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxEcomHoraexpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEcomBdmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEcomBdaltafw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxEcomHaltafw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxEcomSaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxEcomEsttrans ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxEcomZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxEcomVmodifw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxEcomUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxEcomSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxEcomUmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxEcomValtafw ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxEcomCodigo ) + "'">>,"Valecamb" = <<iif( lxEcomValecamb, 1, 0 )>>,"Cuenta" = <<"'" + this.FormatearTextoSql( lxEcomCuenta ) + "'">>,"Codlista" = <<"'" + this.FormatearTextoSql( lxEcomCodlista ) + "'">>,"Accion" = <<"'" + this.FormatearTextoSql( lxEcomAccion ) + "'">>,"Factsinper" = <<iif( lxEcomFactsinper, 1, 0 )>>,"Cuentacom" = <<"'" + this.FormatearTextoSql( lxEcomCuentacom ) + "'">>,"Vendedor" = <<"'" + this.FormatearTextoSql( lxEcomVendedor ) + "'">>,"Buzon" = <<"'" + this.FormatearTextoSql( lxEcomBuzon ) + "'">>,"Fecnov" = <<"'" + this.ConvertirDateSql( lxEcomFecnov ) + "'">>,"Idvinc" = <<lxEcomIdvinc>>,"Tipoecom" = <<lxEcomTipoecom>>,"Transpor" = <<"'" + this.FormatearTextoSql( lxEcomTranspor ) + "'">>,"Basededato" = <<"'" + this.FormatearTextoSql( lxEcomBasededato ) + "'">>,"Motivo" = <<"'" + this.FormatearTextoSql( lxEcomMotivo ) + "'">>,"Ultorder" = <<lxEcomUltorder>>,"Vacio" = <<iif( lxEcomVacio, 1, 0 )>>,"Dtosenvio" = <<iif( lxEcomDtosenvio, 1, 0 )>>,"Generacan" = <<iif( lxEcomGeneracan, 1, 0 )>>,"Pago" = <<"'" + this.FormatearTextoSql( lxEcomPago ) + "'">>,"Condpago" = <<"'" + this.FormatearTextoSql( lxEcomCondpago ) + "'">>,"Valctacte" = <<"'" + this.FormatearTextoSql( lxEcomValctacte ) + "'">>,"Cliedef" = <<"'" + this.FormatearTextoSql( lxEcomCliedef ) + "'">>,"Telenvio" = <<iif( lxEcomTelenvio, 1, 0 )>>,"Descartar" = <<iif( lxEcomDescartar, 1, 0 )>>,"Usaotrabd" = <<iif( lxEcomUsaotrabd, 1, 0 )>>,"Convenv" = <<"'" + this.FormatearTextoSql( lxEcomConvenv ) + "'">>,"Conccolor" = <<"'" + this.FormatearTextoSql( lxEcomConccolor ) + "'">>,"Conctalle" = <<"'" + this.FormatearTextoSql( lxEcomConctalle ) + "'">>,"Concart" = <<"'" + this.FormatearTextoSql( lxEcomConcart ) + "'">>,"Cargaautov" = <<iif( lxEcomCargaautov, 1, 0 )>>,"Dtospago" = <<iif( lxEcomDtospago, 1, 0 )>>,"Pedido" = <<iif( lxEcomPedido, 1, 0 )>>,"Origenst" = <<"'" + this.FormatearTextoSql( lxEcomOrigenst ) + "'">>,"Percctacte" = <<iif( lxEcomPercctacte, 1, 0 )>>,"Numero" = <<iif( lxEcomNumero, 1, 0 )>>,"Remito" = <<iif( lxEcomRemito, 1, 0 )>>,"Accionfe" = <<"'" + this.FormatearTextoSql( lxEcomAccionfe ) + "'">>,"Aplicenvio" = <<lxEcomAplicenvio>>,"Nrocarrito" = <<iif( lxEcomNrocarrito, 1, 0 )>>,"Factmanual" = <<iif( lxEcomFactmanual, 1, 0 )>>,"Buzonfe" = <<"'" + this.FormatearTextoSql( lxEcomBuzonfe ) + "'">>,"Pefactman" = <<iif( lxEcomPefactman, 1, 0 )>>,"Factmcep" = <<iif( lxEcomFactmcep, 1, 0 )>>,"Pefactmcep" = <<iif( lxEcomPefactmcep, 1, 0 )>>,"Enlaceop" = <<iif( lxEcomEnlaceop, 1, 0 )>>,"Factmvc" = <<iif( lxEcomFactmvc, 1, 0 )>>,"Bdfe" = <<"'" + this.FormatearTextoSql( lxEcomBdfe ) + "'">>,"Factelec" = <<iif( lxEcomFactelec, 1, 0 )>>,"Pefactelec" = <<iif( lxEcomPefactelec, 1, 0 )>>,"Factecep" = <<iif( lxEcomFactecep, 1, 0 )>>,"Datosret" = <<iif( lxEcomDatosret, 1, 0 )>>,"Pefactecep" = <<iif( lxEcomPefactecep, 1, 0 )>>,"Factevc" = <<iif( lxEcomFactevc, 1, 0 )>>,"Factfiscal" = <<iif( lxEcomFactfiscal, 1, 0 )>>,"Observa" = <<iif( lxEcomObserva, 1, 0 )>>,"Pefactfisc" = <<iif( lxEcomPefactfisc, 1, 0 )>>,"Factfcep" = <<iif( lxEcomFactfcep, 1, 0 )>>,"Pefactfcep" = <<iif( lxEcomPefactfcep, 1, 0 )>>,"Factfvc" = <<iif( lxEcomFactfvc, 1, 0 )>>,"Pagado" = <<iif( lxEcomPagado, 1, 0 )>>,"Promos" = <<iif( lxEcomPromos, 1, 0 )>>,"Obs" = <<"'" + this.FormatearTextoSql( lxEcomObs ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxEcomCodigo ) + "'">> and  ECOM.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Codigo" as "Codigo", "Valecamb" as "Usavalecambio", "Cuenta" as "Descripcion", "Codlista" as "Listadeprecios", "Accion" as "Accion", "Factsinper" as "Facturarsinpersonalizar", "Cuentacom" as "Cuenta", "Vendedor" as "Vendedor", "Buzon" as "Buzon", "Fecnov" as "Fechanovedades", "Idvinc" as "Idvinculacion", "Tipoecom" as "Tipoecommerce", "Transpor" as "Transportista", "Basededato" as "Basededatos", "Motivo" as "Motivo", "Ultorder" as "Ultimaorder", "Vacio" as "Vacio", "Dtosenvio" as "Datosdeenvio", "Generacan" as "Generacancelacion", "Pago" as "Pago", "Condpago" as "Condicionpagopreferente", "Valctacte" as "Valorctacte", "Cliedef" as "Clientedefault", "Telenvio" as "Telefonodeenvio", "Descartar" as "Descartar", "Usaotrabd" as "Utilizastockotrabase", "Convenv" as "Concenvio", "Conccolor" as "Conccolor", "Conctalle" as "Conctalle", "Concart" as "Concarticulo", "Cargaautov" as "Cargaautomaticavalores", "Dtospago" as "Datosdepago", "Pedido" as "Pedido", "Origenst" as "Bdorigenstock", "Percctacte" as "Percepcionesactacte", "Numero" as "Numero", "Remito" as "Remito", "Accionfe" as "Accionfullenv", "Aplicenvio" as "Aplicarcostoenvio", "Nrocarrito" as "Numerodecarrito", "Factmanual" as "Facturamanual", "Buzonfe" as "Buzonfullenv", "Pefactman" as "Pedidofacturamanual", "Factmcep" as "Facturamanualconentregaposterior", "Pefactmcep" as "Pedidofacturamanualconentregapos", "Enlaceop" as "Enlacedelaoperacion", "Factmvc" as "Facturamanualconvtacont", "Bdfe" as "Basededatosfullenv", "Factelec" as "Facturaelectronica", "Pefactelec" as "Pedidofacturaelectronica", "Factecep" as "Facturaelectronicaconentregaposterior", "Datosret" as "Datosderetiro", "Pefactecep" as "Pedidofacturaelectronicaconentregapos", "Factevc" as "Facturaelectronicaconvtacont", "Factfiscal" as "Facturafiscal", "Observa" as "Observaciones", "Pefactfisc" as "Pedidofacturafiscal", "Factfcep" as "Facturafiscalconentregaposterior", "Pefactfcep" as "Pedidofacturafiscalconentregapos", "Factfvc" as "Facturafiscalconvtacont", "Pagado" as "Pagado", "Promos" as "Aplicarpromocionesautomaticas", "Obs" as "Observacion" from ZooLogic.ECOM where "Codigo" = <<"'" + this.FormatearTextoSql( lxEcomCodigo ) + "'">> and  ECOM.CODIGO != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Codigo" as "Codigo", "Valecamb" as "Usavalecambio", "Cuenta" as "Descripcion", "Codlista" as "Listadeprecios", "Accion" as "Accion", "Factsinper" as "Facturarsinpersonalizar", "Cuentacom" as "Cuenta", "Vendedor" as "Vendedor", "Buzon" as "Buzon", "Fecnov" as "Fechanovedades", "Idvinc" as "Idvinculacion", "Tipoecom" as "Tipoecommerce", "Transpor" as "Transportista", "Basededato" as "Basededatos", "Motivo" as "Motivo", "Ultorder" as "Ultimaorder", "Vacio" as "Vacio", "Dtosenvio" as "Datosdeenvio", "Generacan" as "Generacancelacion", "Pago" as "Pago", "Condpago" as "Condicionpagopreferente", "Valctacte" as "Valorctacte", "Cliedef" as "Clientedefault", "Telenvio" as "Telefonodeenvio", "Descartar" as "Descartar", "Usaotrabd" as "Utilizastockotrabase", "Convenv" as "Concenvio", "Conccolor" as "Conccolor", "Conctalle" as "Conctalle", "Concart" as "Concarticulo", "Cargaautov" as "Cargaautomaticavalores", "Dtospago" as "Datosdepago", "Pedido" as "Pedido", "Origenst" as "Bdorigenstock", "Percctacte" as "Percepcionesactacte", "Numero" as "Numero", "Remito" as "Remito", "Accionfe" as "Accionfullenv", "Aplicenvio" as "Aplicarcostoenvio", "Nrocarrito" as "Numerodecarrito", "Factmanual" as "Facturamanual", "Buzonfe" as "Buzonfullenv", "Pefactman" as "Pedidofacturamanual", "Factmcep" as "Facturamanualconentregaposterior", "Pefactmcep" as "Pedidofacturamanualconentregapos", "Enlaceop" as "Enlacedelaoperacion", "Factmvc" as "Facturamanualconvtacont", "Bdfe" as "Basededatosfullenv", "Factelec" as "Facturaelectronica", "Pefactelec" as "Pedidofacturaelectronica", "Factecep" as "Facturaelectronicaconentregaposterior", "Datosret" as "Datosderetiro", "Pefactecep" as "Pedidofacturaelectronicaconentregapos", "Factevc" as "Facturaelectronicaconvtacont", "Factfiscal" as "Facturafiscal", "Observa" as "Observaciones", "Pefactfisc" as "Pedidofacturafiscal", "Factfcep" as "Facturafiscalconentregaposterior", "Pefactfcep" as "Pedidofacturafiscalconentregapos", "Factfvc" as "Facturafiscalconvtacont", "Pagado" as "Pagado", "Promos" as "Aplicarpromocionesautomaticas", "Obs" as "Observacion" from ZooLogic.ECOM where  ECOM.CODIGO != '' order by CODIGO
			endtext
			use in select('c_ECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Codigo" as "Codigo", "Valecamb" as "Usavalecambio", "Cuenta" as "Descripcion", "Codlista" as "Listadeprecios", "Accion" as "Accion", "Factsinper" as "Facturarsinpersonalizar", "Cuentacom" as "Cuenta", "Vendedor" as "Vendedor", "Buzon" as "Buzon", "Fecnov" as "Fechanovedades", "Idvinc" as "Idvinculacion", "Tipoecom" as "Tipoecommerce", "Transpor" as "Transportista", "Basededato" as "Basededatos", "Motivo" as "Motivo", "Ultorder" as "Ultimaorder", "Vacio" as "Vacio", "Dtosenvio" as "Datosdeenvio", "Generacan" as "Generacancelacion", "Pago" as "Pago", "Condpago" as "Condicionpagopreferente", "Valctacte" as "Valorctacte", "Cliedef" as "Clientedefault", "Telenvio" as "Telefonodeenvio", "Descartar" as "Descartar", "Usaotrabd" as "Utilizastockotrabase", "Convenv" as "Concenvio", "Conccolor" as "Conccolor", "Conctalle" as "Conctalle", "Concart" as "Concarticulo", "Cargaautov" as "Cargaautomaticavalores", "Dtospago" as "Datosdepago", "Pedido" as "Pedido", "Origenst" as "Bdorigenstock", "Percctacte" as "Percepcionesactacte", "Numero" as "Numero", "Remito" as "Remito", "Accionfe" as "Accionfullenv", "Aplicenvio" as "Aplicarcostoenvio", "Nrocarrito" as "Numerodecarrito", "Factmanual" as "Facturamanual", "Buzonfe" as "Buzonfullenv", "Pefactman" as "Pedidofacturamanual", "Factmcep" as "Facturamanualconentregaposterior", "Pefactmcep" as "Pedidofacturamanualconentregapos", "Enlaceop" as "Enlacedelaoperacion", "Factmvc" as "Facturamanualconvtacont", "Bdfe" as "Basededatosfullenv", "Factelec" as "Facturaelectronica", "Pefactelec" as "Pedidofacturaelectronica", "Factecep" as "Facturaelectronicaconentregaposterior", "Datosret" as "Datosderetiro", "Pefactecep" as "Pedidofacturaelectronicaconentregapos", "Factevc" as "Facturaelectronicaconvtacont", "Factfiscal" as "Facturafiscal", "Observa" as "Observaciones", "Pefactfisc" as "Pedidofacturafiscal", "Factfcep" as "Facturafiscalconentregaposterior", "Pefactfcep" as "Pedidofacturafiscalconentregapos", "Factfvc" as "Facturafiscalconvtacont", "Pagado" as "Pagado", "Promos" as "Aplicarpromocionesautomaticas", "Obs" as "Observacion" from ZooLogic.ECOM where  funciones.padr( CODIGO, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ECOM.CODIGO != '' order by CODIGO
			endtext
			use in select('c_ECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Codigo" as "Codigo", "Valecamb" as "Usavalecambio", "Cuenta" as "Descripcion", "Codlista" as "Listadeprecios", "Accion" as "Accion", "Factsinper" as "Facturarsinpersonalizar", "Cuentacom" as "Cuenta", "Vendedor" as "Vendedor", "Buzon" as "Buzon", "Fecnov" as "Fechanovedades", "Idvinc" as "Idvinculacion", "Tipoecom" as "Tipoecommerce", "Transpor" as "Transportista", "Basededato" as "Basededatos", "Motivo" as "Motivo", "Ultorder" as "Ultimaorder", "Vacio" as "Vacio", "Dtosenvio" as "Datosdeenvio", "Generacan" as "Generacancelacion", "Pago" as "Pago", "Condpago" as "Condicionpagopreferente", "Valctacte" as "Valorctacte", "Cliedef" as "Clientedefault", "Telenvio" as "Telefonodeenvio", "Descartar" as "Descartar", "Usaotrabd" as "Utilizastockotrabase", "Convenv" as "Concenvio", "Conccolor" as "Conccolor", "Conctalle" as "Conctalle", "Concart" as "Concarticulo", "Cargaautov" as "Cargaautomaticavalores", "Dtospago" as "Datosdepago", "Pedido" as "Pedido", "Origenst" as "Bdorigenstock", "Percctacte" as "Percepcionesactacte", "Numero" as "Numero", "Remito" as "Remito", "Accionfe" as "Accionfullenv", "Aplicenvio" as "Aplicarcostoenvio", "Nrocarrito" as "Numerodecarrito", "Factmanual" as "Facturamanual", "Buzonfe" as "Buzonfullenv", "Pefactman" as "Pedidofacturamanual", "Factmcep" as "Facturamanualconentregaposterior", "Pefactmcep" as "Pedidofacturamanualconentregapos", "Enlaceop" as "Enlacedelaoperacion", "Factmvc" as "Facturamanualconvtacont", "Bdfe" as "Basededatosfullenv", "Factelec" as "Facturaelectronica", "Pefactelec" as "Pedidofacturaelectronica", "Factecep" as "Facturaelectronicaconentregaposterior", "Datosret" as "Datosderetiro", "Pefactecep" as "Pedidofacturaelectronicaconentregapos", "Factevc" as "Facturaelectronicaconvtacont", "Factfiscal" as "Facturafiscal", "Observa" as "Observaciones", "Pefactfisc" as "Pedidofacturafiscal", "Factfcep" as "Facturafiscalconentregaposterior", "Pefactfcep" as "Pedidofacturafiscalconentregapos", "Factfvc" as "Facturafiscalconvtacont", "Pagado" as "Pagado", "Promos" as "Aplicarpromocionesautomaticas", "Obs" as "Observacion" from ZooLogic.ECOM where  funciones.padr( CODIGO, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  ECOM.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_ECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Codigo" as "Codigo", "Valecamb" as "Usavalecambio", "Cuenta" as "Descripcion", "Codlista" as "Listadeprecios", "Accion" as "Accion", "Factsinper" as "Facturarsinpersonalizar", "Cuentacom" as "Cuenta", "Vendedor" as "Vendedor", "Buzon" as "Buzon", "Fecnov" as "Fechanovedades", "Idvinc" as "Idvinculacion", "Tipoecom" as "Tipoecommerce", "Transpor" as "Transportista", "Basededato" as "Basededatos", "Motivo" as "Motivo", "Ultorder" as "Ultimaorder", "Vacio" as "Vacio", "Dtosenvio" as "Datosdeenvio", "Generacan" as "Generacancelacion", "Pago" as "Pago", "Condpago" as "Condicionpagopreferente", "Valctacte" as "Valorctacte", "Cliedef" as "Clientedefault", "Telenvio" as "Telefonodeenvio", "Descartar" as "Descartar", "Usaotrabd" as "Utilizastockotrabase", "Convenv" as "Concenvio", "Conccolor" as "Conccolor", "Conctalle" as "Conctalle", "Concart" as "Concarticulo", "Cargaautov" as "Cargaautomaticavalores", "Dtospago" as "Datosdepago", "Pedido" as "Pedido", "Origenst" as "Bdorigenstock", "Percctacte" as "Percepcionesactacte", "Numero" as "Numero", "Remito" as "Remito", "Accionfe" as "Accionfullenv", "Aplicenvio" as "Aplicarcostoenvio", "Nrocarrito" as "Numerodecarrito", "Factmanual" as "Facturamanual", "Buzonfe" as "Buzonfullenv", "Pefactman" as "Pedidofacturamanual", "Factmcep" as "Facturamanualconentregaposterior", "Pefactmcep" as "Pedidofacturamanualconentregapos", "Enlaceop" as "Enlacedelaoperacion", "Factmvc" as "Facturamanualconvtacont", "Bdfe" as "Basededatosfullenv", "Factelec" as "Facturaelectronica", "Pefactelec" as "Pedidofacturaelectronica", "Factecep" as "Facturaelectronicaconentregaposterior", "Datosret" as "Datosderetiro", "Pefactecep" as "Pedidofacturaelectronicaconentregapos", "Factevc" as "Facturaelectronicaconvtacont", "Factfiscal" as "Facturafiscal", "Observa" as "Observaciones", "Pefactfisc" as "Pedidofacturafiscal", "Factfcep" as "Facturafiscalconentregaposterior", "Pefactfcep" as "Pedidofacturafiscalconentregapos", "Factfvc" as "Facturafiscalconvtacont", "Pagado" as "Pagado", "Promos" as "Aplicarpromocionesautomaticas", "Obs" as "Observacion" from ZooLogic.ECOM where  ECOM.CODIGO != '' order by CODIGO desc
			endtext
			use in select('c_ECOMMERCE')
			this.oConexion.EjecutarSql( lcSentencia, 'c_ECOMMERCE', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Faltafw,Fecexpo,Fmodifw,Fectrans,Horaimpo,Hmodifw,Horaexpo,Bdmodifw,Bdaltafw,Haltafw" + ;
",Saltafw,Esttrans,Zadsfw,Vmodifw,Ualtafw,Smodifw,Umodifw,Valtafw,Codigo,Valecamb,Cuenta,Codlista,Acc" + ;
"ion,Factsinper,Cuentacom,Vendedor,Buzon,Fecnov,Idvinc,Tipoecom,Transpor,Basededato,Motivo,Ultorder,V" + ;
"acio,Dtosenvio,Generacan,Pago,Condpago,Valctacte,Cliedef,Telenvio,Descartar,Usaotrabd,Convenv,Concco" + ;
"lor,Conctalle,Concart,Cargaautov,Dtospago,Pedido,Origenst,Percctacte,Numero,Remito,Accionfe,Aplicenv" + ;
"io,Nrocarrito,Factmanual,Buzonfe,Pefactman,Factmcep,Pefactmcep,Enlaceop,Factmvc,Bdfe,Factelec,Pefact" + ;
"elec,Factecep,Datosret,Pefactecep,Factevc,Factfiscal,Observa,Pefactfisc,Factfcep,Pefactfcep,Factfvc," + ;
"Pagado,Promos,Obs" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Horaimpo" as "Horaimpo", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Bdmodifw" as "Basededatosmodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Haltafw" as "Horaaltafw", "Saltafw" as "Seriealtafw", "Esttrans" as "Estadotransferencia", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Valtafw" as "Versionaltafw", "Codigo" as "Codigo", "Valecamb" as "Usavalecambio", "Cuenta" as "Descripcion", "Codlista" as "Listadeprecios", "Accion" as "Accion", "Factsinper" as "Facturarsinpersonalizar", "Cuentacom" as "Cuenta", "Vendedor" as "Vendedor", "Buzon" as "Buzon", "Fecnov" as "Fechanovedades", "Idvinc" as "Idvinculacion", "Tipoecom" as "Tipoecommerce", "Transpor" as "Transportista", "Basededato" as "Basededatos", "Motivo" as "Motivo", "Ultorder" as "Ultimaorder", "Vacio" as "Vacio", "Dtosenvio" as "Datosdeenvio", "Generacan" as "Generacancelacion", "Pago" as "Pago", "Condpago" as "Condicionpagopreferente", "Valctacte" as "Valorctacte", "Cliedef" as "Clientedefault", "Telenvio" as "Telefonodeenvio", "Descartar" as "Descartar", "Usaotrabd" as "Utilizastockotrabase", "Convenv" as "Concenvio", "Conccolor" as "Conccolor", "Conctalle" as "Conctalle", "Concart" as "Concarticulo", "Cargaautov" as "Cargaautomaticavalores", "Dtospago" as "Datosdepago", "Pedido" as "Pedido", "Origenst" as "Bdorigenstock", "Percctacte" as "Percepcionesactacte", "Numero" as "Numero", "Remito" as "Remito", "Accionfe" as "Accionfullenv", "Aplicenvio" as "Aplicarcostoenvio", "Nrocarrito" as "Numerodecarrito", "Factmanual" as "Facturamanual", "Buzonfe" as "Buzonfullenv", "Pefactman" as "Pedidofacturamanual", "Factmcep" as "Facturamanualconentregaposterior", "Pefactmcep" as "Pedidofacturamanualconentregapos", "Enlaceop" as "Enlacedelaoperacion", "Factmvc" as "Facturamanualconvtacont", "Bdfe" as "Basededatosfullenv", "Factelec" as "Facturaelectronica", "Pefactelec" as "Pedidofacturaelectronica", "Factecep" as "Facturaelectronicaconentregaposterior", "Datosret" as "Datosderetiro", "Pefactecep" as "Pedidofacturaelectronicaconentregapos", "Factevc" as "Facturaelectronicaconvtacont", "Factfiscal" as "Facturafiscal", "Observa" as "Observaciones", "Pefactfisc" as "Pedidofacturafiscal", "Factfcep" as "Facturafiscalconentregaposterior", "Pefactfcep" as "Pedidofacturafiscalconentregapos", "Factfvc" as "Facturafiscalconvtacont", "Pagado" as "Pagado", "Promos" as "Aplicarpromocionesautomaticas", "Obs" as "Observacion"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.ECOM set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxEcomFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxEcomFaltafw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxEcomFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxEcomFmodifw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxEcomFectrans ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxEcomHoraimpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxEcomHmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxEcomHoraexpo ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxEcomBdmodifw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxEcomBdaltafw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxEcomHaltafw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxEcomSaltafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxEcomEsttrans ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxEcomZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxEcomVmodifw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxEcomUaltafw ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxEcomSmodifw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxEcomUmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxEcomValtafw ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxEcomCodigo ) + "'">>, "Valecamb" = <<iif( lxEcomValecamb, 1, 0 )>>, "Cuenta" = <<"'" + this.FormatearTextoSql( lxEcomCuenta ) + "'">>, "Codlista" = <<"'" + this.FormatearTextoSql( lxEcomCodlista ) + "'">>, "Accion" = <<"'" + this.FormatearTextoSql( lxEcomAccion ) + "'">>, "Factsinper" = <<iif( lxEcomFactsinper, 1, 0 )>>, "Cuentacom" = <<"'" + this.FormatearTextoSql( lxEcomCuentacom ) + "'">>, "Vendedor" = <<"'" + this.FormatearTextoSql( lxEcomVendedor ) + "'">>, "Buzon" = <<"'" + this.FormatearTextoSql( lxEcomBuzon ) + "'">>, "Fecnov" = <<"'" + this.ConvertirDateSql( lxEcomFecnov ) + "'">>, "Idvinc" = <<lxEcomIdvinc>>, "Tipoecom" = <<lxEcomTipoecom>>, "Transpor" = <<"'" + this.FormatearTextoSql( lxEcomTranspor ) + "'">>, "Basededato" = <<"'" + this.FormatearTextoSql( lxEcomBasededato ) + "'">>, "Motivo" = <<"'" + this.FormatearTextoSql( lxEcomMotivo ) + "'">>, "Ultorder" = <<lxEcomUltorder>>, "Vacio" = <<iif( lxEcomVacio, 1, 0 )>>, "Dtosenvio" = <<iif( lxEcomDtosenvio, 1, 0 )>>, "Generacan" = <<iif( lxEcomGeneracan, 1, 0 )>>, "Pago" = <<"'" + this.FormatearTextoSql( lxEcomPago ) + "'">>, "Condpago" = <<"'" + this.FormatearTextoSql( lxEcomCondpago ) + "'">>, "Valctacte" = <<"'" + this.FormatearTextoSql( lxEcomValctacte ) + "'">>, "Cliedef" = <<"'" + this.FormatearTextoSql( lxEcomCliedef ) + "'">>, "Telenvio" = <<iif( lxEcomTelenvio, 1, 0 )>>, "Descartar" = <<iif( lxEcomDescartar, 1, 0 )>>, "Usaotrabd" = <<iif( lxEcomUsaotrabd, 1, 0 )>>, "Convenv" = <<"'" + this.FormatearTextoSql( lxEcomConvenv ) + "'">>, "Conccolor" = <<"'" + this.FormatearTextoSql( lxEcomConccolor ) + "'">>, "Conctalle" = <<"'" + this.FormatearTextoSql( lxEcomConctalle ) + "'">>, "Concart" = <<"'" + this.FormatearTextoSql( lxEcomConcart ) + "'">>, "Cargaautov" = <<iif( lxEcomCargaautov, 1, 0 )>>, "Dtospago" = <<iif( lxEcomDtospago, 1, 0 )>>, "Pedido" = <<iif( lxEcomPedido, 1, 0 )>>, "Origenst" = <<"'" + this.FormatearTextoSql( lxEcomOrigenst ) + "'">>, "Percctacte" = <<iif( lxEcomPercctacte, 1, 0 )>>, "Numero" = <<iif( lxEcomNumero, 1, 0 )>>, "Remito" = <<iif( lxEcomRemito, 1, 0 )>>, "Accionfe" = <<"'" + this.FormatearTextoSql( lxEcomAccionfe ) + "'">>, "Aplicenvio" = <<lxEcomAplicenvio>>, "Nrocarrito" = <<iif( lxEcomNrocarrito, 1, 0 )>>, "Factmanual" = <<iif( lxEcomFactmanual, 1, 0 )>>, "Buzonfe" = <<"'" + this.FormatearTextoSql( lxEcomBuzonfe ) + "'">>, "Pefactman" = <<iif( lxEcomPefactman, 1, 0 )>>, "Factmcep" = <<iif( lxEcomFactmcep, 1, 0 )>>, "Pefactmcep" = <<iif( lxEcomPefactmcep, 1, 0 )>>, "Enlaceop" = <<iif( lxEcomEnlaceop, 1, 0 )>>, "Factmvc" = <<iif( lxEcomFactmvc, 1, 0 )>>, "Bdfe" = <<"'" + this.FormatearTextoSql( lxEcomBdfe ) + "'">>, "Factelec" = <<iif( lxEcomFactelec, 1, 0 )>>, "Pefactelec" = <<iif( lxEcomPefactelec, 1, 0 )>>, "Factecep" = <<iif( lxEcomFactecep, 1, 0 )>>, "Datosret" = <<iif( lxEcomDatosret, 1, 0 )>>, "Pefactecep" = <<iif( lxEcomPefactecep, 1, 0 )>>, "Factevc" = <<iif( lxEcomFactevc, 1, 0 )>>, "Factfiscal" = <<iif( lxEcomFactfiscal, 1, 0 )>>, "Observa" = <<iif( lxEcomObserva, 1, 0 )>>, "Pefactfisc" = <<iif( lxEcomPefactfisc, 1, 0 )>>, "Factfcep" = <<iif( lxEcomFactfcep, 1, 0 )>>, "Pefactfcep" = <<iif( lxEcomPefactfcep, 1, 0 )>>, "Factfvc" = <<iif( lxEcomFactfvc, 1, 0 )>>, "Pagado" = <<iif( lxEcomPagado, 1, 0 )>>, "Promos" = <<iif( lxEcomPromos, 1, 0 )>>, "Obs" = <<"'" + this.FormatearTextoSql( lxEcomObs ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'ECOM' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.ECOM set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, VALECAMB = ] + Transform( iif( &lcCursor..VALECAMB, 1, 0 ))+ [, CUENTA = ] + "'" + this.FormatearTextoSql( &lcCursor..CUENTA ) + "'"+ [, CODLISTA = ] + "'" + this.FormatearTextoSql( &lcCursor..CODLISTA ) + "'"+ [, Accion = ] + "'" + this.FormatearTextoSql( &lcCursor..Accion ) + "'"+ [, FACTSINPER = ] + Transform( iif( &lcCursor..FACTSINPER, 1, 0 ))+ [, CUENTACOM = ] + "'" + this.FormatearTextoSql( &lcCursor..CUENTACOM ) + "'"+ [, VENDEDOR = ] + "'" + this.FormatearTextoSql( &lcCursor..VENDEDOR ) + "'"+ [, Buzon = ] + "'" + this.FormatearTextoSql( &lcCursor..Buzon ) + "'"+ [, FECNOV = ] + "'" + this.ConvertirDateSql( &lcCursor..FECNOV ) + "'"+ [, IDVinc = ] + transform( &lcCursor..IDVinc )+ [, TIPOECOM = ] + transform( &lcCursor..TIPOECOM )+ [, TRANSPOR = ] + "'" + this.FormatearTextoSql( &lcCursor..TRANSPOR ) + "'"+ [, Basededato = ] + "'" + this.FormatearTextoSql( &lcCursor..Basededato ) + "'"+ [, MOTIVO = ] + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'"+ [, ULTORDER = ] + transform( &lcCursor..ULTORDER )+ [, Vacio = ] + Transform( iif( &lcCursor..Vacio, 1, 0 ))+ [, DtosEnvio = ] + Transform( iif( &lcCursor..DtosEnvio, 1, 0 ))+ [, GeneraCan = ] + Transform( iif( &lcCursor..GeneraCan, 1, 0 ))+ [, PAGO = ] + "'" + this.FormatearTextoSql( &lcCursor..PAGO ) + "'"+ [, CONDPAGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CONDPAGO ) + "'"+ [, ValCtaCte = ] + "'" + this.FormatearTextoSql( &lcCursor..ValCtaCte ) + "'"+ [, CLIEDEF = ] + "'" + this.FormatearTextoSql( &lcCursor..CLIEDEF ) + "'"+ [, TelEnvio = ] + Transform( iif( &lcCursor..TelEnvio, 1, 0 ))+ [, Descartar = ] + Transform( iif( &lcCursor..Descartar, 1, 0 ))+ [, USAOTRABD = ] + Transform( iif( &lcCursor..USAOTRABD, 1, 0 ))+ [, ConvEnv = ] + "'" + this.FormatearTextoSql( &lcCursor..ConvEnv ) + "'"+ [, ConcColor = ] + "'" + this.FormatearTextoSql( &lcCursor..ConcColor ) + "'"+ [, ConcTalle = ] + "'" + this.FormatearTextoSql( &lcCursor..ConcTalle ) + "'"+ [, ConcArt = ] + "'" + this.FormatearTextoSql( &lcCursor..ConcArt ) + "'"+ [, CargaAutoV = ] + Transform( iif( &lcCursor..CargaAutoV, 1, 0 ))+ [, DtosPago = ] + Transform( iif( &lcCursor..DtosPago, 1, 0 ))+ [, Pedido = ] + Transform( iif( &lcCursor..Pedido, 1, 0 ))+ [, ORIGENST = ] + "'" + this.FormatearTextoSql( &lcCursor..ORIGENST ) + "'"+ [, PercCtaCte = ] + Transform( iif( &lcCursor..PercCtaCte, 1, 0 ))+ [, Numero = ] + Transform( iif( &lcCursor..Numero, 1, 0 ))+ [, Remito = ] + Transform( iif( &lcCursor..Remito, 1, 0 ))+ [, ACCIONFE = ] + "'" + this.FormatearTextoSql( &lcCursor..ACCIONFE ) + "'"+ [, APLICENVIO = ] + transform( &lcCursor..APLICENVIO )+ [, NroCarrito = ] + Transform( iif( &lcCursor..NroCarrito, 1, 0 ))+ [, FactManual = ] + Transform( iif( &lcCursor..FactManual, 1, 0 ))+ [, BUZONFE = ] + "'" + this.FormatearTextoSql( &lcCursor..BUZONFE ) + "'"+ [, PeFactMan = ] + Transform( iif( &lcCursor..PeFactMan, 1, 0 ))+ [, FactMcEP = ] + Transform( iif( &lcCursor..FactMcEP, 1, 0 ))+ [, PeFactMcEP = ] + Transform( iif( &lcCursor..PeFactMcEP, 1, 0 ))+ [, EnlaceOp = ] + Transform( iif( &lcCursor..EnlaceOp, 1, 0 ))+ [, FactMVC = ] + Transform( iif( &lcCursor..FactMVC, 1, 0 ))+ [, BDFE = ] + "'" + this.FormatearTextoSql( &lcCursor..BDFE ) + "'"+ [, FactElec = ] + Transform( iif( &lcCursor..FactElec, 1, 0 ))+ [, PeFactElec = ] + Transform( iif( &lcCursor..PeFactElec, 1, 0 ))+ [, FactEcEP = ] + Transform( iif( &lcCursor..FactEcEP, 1, 0 ))+ [, DatosRet = ] + Transform( iif( &lcCursor..DatosRet, 1, 0 ))+ [, PeFactEcEP = ] + Transform( iif( &lcCursor..PeFactEcEP, 1, 0 ))+ [, FactEVC = ] + Transform( iif( &lcCursor..FactEVC, 1, 0 ))+ [, FactFiscal = ] + Transform( iif( &lcCursor..FactFiscal, 1, 0 ))+ [, Observa = ] + Transform( iif( &lcCursor..Observa, 1, 0 ))+ [, PeFactFisc = ] + Transform( iif( &lcCursor..PeFactFisc, 1, 0 ))+ [, FactFcEP = ] + Transform( iif( &lcCursor..FactFcEP, 1, 0 ))+ [, PeFactFcEP = ] + Transform( iif( &lcCursor..PeFactFcEP, 1, 0 ))+ [, FactFVC = ] + Transform( iif( &lcCursor..FactFVC, 1, 0 ))+ [, Pagado = ] + Transform( iif( &lcCursor..Pagado, 1, 0 ))+ [, Promos = ] + Transform( iif( &lcCursor..Promos, 1, 0 ))+ [, OBS = ] + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'" + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" )
				...
				Text to lcCampos noShow
					 FECIMPO, FALTAFW, FECEXPO, FMODIFW, FECTRANS, HORAIMPO, HMODIFW, HORAEXPO, BDMODIFW, BDALTAFW, HALTAFW, SALTAFW, ESTTRANS, ZADSFW, VMODIFW, UALTAFW, SMODIFW, UMODIFW, VALTAFW, CODIGO, VALECAMB, CUENTA, CODLISTA, Accion, FACTSINPER, CUENTACOM, VENDEDOR, Buzon, FECNOV, IDVinc, TIPOECOM, TRANSPOR, Basededato, MOTIVO, ULTORDER, Vacio, DtosEnvio, GeneraCan, PAGO, CONDPAGO, ValCtaCte, CLIEDEF, TelEnvio, Descartar, USAOTRABD, ConvEnv, ConcColor, ConcTalle, ConcArt, CargaAutoV, DtosPago, Pedido, ORIGENST, PercCtaCte, Numero, Remito, ACCIONFE, APLICENVIO, NroCarrito, FactManual, BUZONFE, PeFactMan, FactMcEP, PeFactMcEP, EnlaceOp, FactMVC, BDFE, FactElec, PeFactElec, FactEcEP, DatosRet, PeFactEcEP, FactEVC, FactFiscal, Observa, PeFactFisc, FactFcEP, PeFactFcEP, FactFVC, Pagado, Promos, OBS
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'" + ',' + Transform( iif( &lcCursor..VALECAMB, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CUENTA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODLISTA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Accion ) + "'" + ',' + Transform( iif( &lcCursor..FACTSINPER, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CUENTACOM ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VENDEDOR ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Buzon ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECNOV ) + "'" + ',' + transform( &lcCursor..IDVinc ) + ',' + transform( &lcCursor..TIPOECOM ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRANSPOR ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Basededato ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MOTIVO ) + "'" + ',' + transform( &lcCursor..ULTORDER ) + ',' + Transform( iif( &lcCursor..Vacio, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..DtosEnvio, 1, 0 )) + ',' + Transform( iif( &lcCursor..GeneraCan, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..PAGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CONDPAGO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ValCtaCte ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..CLIEDEF ) + "'" + ',' + Transform( iif( &lcCursor..TelEnvio, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..Descartar, 1, 0 )) + ',' + Transform( iif( &lcCursor..USAOTRABD, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConvEnv ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConcColor ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConcTalle ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ConcArt ) + "'" + ',' + Transform( iif( &lcCursor..CargaAutoV, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..DtosPago, 1, 0 )) + ',' + Transform( iif( &lcCursor..Pedido, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ORIGENST ) + "'" + ',' + Transform( iif( &lcCursor..PercCtaCte, 1, 0 )) + ',' + Transform( iif( &lcCursor..Numero, 1, 0 )) + ',' + Transform( iif( &lcCursor..Remito, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ACCIONFE ) + "'" + ',' + transform( &lcCursor..APLICENVIO )
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..NroCarrito, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactManual, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..BUZONFE ) + "'" + ',' + Transform( iif( &lcCursor..PeFactMan, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactMcEP, 1, 0 )) + ',' + Transform( iif( &lcCursor..PeFactMcEP, 1, 0 )) + ',' + Transform( iif( &lcCursor..EnlaceOp, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactMVC, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDFE ) + "'" + ',' + Transform( iif( &lcCursor..FactElec, 1, 0 )) + ',' + Transform( iif( &lcCursor..PeFactElec, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactEcEP, 1, 0 )) + ',' + Transform( iif( &lcCursor..DatosRet, 1, 0 )) + ',' + Transform( iif( &lcCursor..PeFactEcEP, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactEVC, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactFiscal, 1, 0 ))
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..Observa, 1, 0 )) + ',' + Transform( iif( &lcCursor..PeFactFisc, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactFcEP, 1, 0 )) + ',' + Transform( iif( &lcCursor..PeFactFcEP, 1, 0 )) + ',' + Transform( iif( &lcCursor..FactFVC, 1, 0 )) + ',' + Transform( iif( &lcCursor..Pagado, 1, 0 )) + ',' + Transform( iif( &lcCursor..Promos, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..OBS ) + "'"
...
"idvinc" numeric( 20, 0 )  null, 
"tipoecom" numeric( 2, 0 )  null, 
"transpor" char( 6 )  null, 
...
"descartar" bit  null, 
"usaotrabd" bit  null, 
"convenv" char( 13 )  null, 
"conccolor" char( 2 )  null, 
"conctalle" char( 5 )  null, 
"concart" char( 13 )  null, 
"cargaautov" bit  null, 
"dtospago" bit  null, 
"pedido" bit  null, 
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.VALECAMB = isnull( d.VALECAMB, t.VALECAMB ),t.CUENTA = isnull( d.CUENTA, t.CUENTA ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.ACCION = isnull( d.ACCION, t.ACCION ),t.FACTSINPER = isnull( d.FACTSINPER, t.FACTSINPER ),t.CUENTACOM = isnull( d.CUENTACOM, t.CUENTACOM ),t.VENDEDOR = isnull( d.VENDEDOR, t.VENDEDOR ),t.BUZON = isnull( d.BUZON, t.BUZON ),t.FECNOV = isnull( d.FECNOV, t.FECNOV ),t.IDVINC = isnull( d.IDVINC, t.IDVINC ),t.TIPOECOM = isnull( d.TIPOECOM, t.TIPOECOM ),t.TRANSPOR = isnull( d.TRANSPOR, t.TRANSPOR ),t.BASEDEDATO = isnull( d.BASEDEDATO, t.BASEDEDATO ),t.MOTIVO = isnull( d.MOTIVO, t.MOTIVO ),t.ULTORDER = isnull( d.ULTORDER, t.ULTORDER ),t.VACIO = isnull( d.VACIO, t.VACIO ),t.DTOSENVIO = isnull( d.DTOSENVIO, t.DTOSENVIO ),t.GENERACAN = isnull( d.GENERACAN, t.GENERACAN ),t.PAGO = isnull( d.PAGO, t.PAGO ),t.CONDPAGO = isnull( d.CONDPAGO, t.CONDPAGO ),t.VALCTACTE = isnull( d.VALCTACTE, t.VALCTACTE ),t.CLIEDEF = isnull( d.CLIEDEF, t.CLIEDEF ),t.TELENVIO = isnull( d.TELENVIO, t.TELENVIO ),t.DESCARTAR = isnull( d.DESCARTAR, t.DESCARTAR ),t.USAOTRABD = isnull( d.USAOTRABD, t.USAOTRABD ),t.CONVENV = isnull( d.CONVENV, t.CONVENV ),t.CONCCOLOR = isnull( d.CONCCOLOR, t.CONCCOLOR ),t.CONCTALLE = isnull( d.CONCTALLE, t.CONCTALLE ),t.CONCART = isnull( d.CONCART, t.CONCART ),t.CARGAAUTOV = isnull( d.CARGAAUTOV, t.CARGAAUTOV ),t.DTOSPAGO = isnull( d.DTOSPAGO, t.DTOSPAGO ),t.PEDIDO = isnull( d.PEDIDO, t.PEDIDO ),t.ORIGENST = isnull( d.ORIGENST, t.ORIGENST ),t.PERCCTACTE = isnull( d.PERCCTACTE, t.PERCCTACTE ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.REMITO = isnull( d.REMITO, t.REMITO ),t.ACCIONFE = isnull( d.ACCIONFE, t.ACCIONFE ),t.APLICENVIO = isnull( d.APLICENVIO, t.APLICENVIO ),t.NROCARRITO = isnull( d.NROCARRITO, t.NROCARRITO ),t.FACTMANUAL = isnull( d.FACTMANUAL, t.FACTMANUAL ),t.BUZONFE = isnull( d.BUZONFE, t.BUZONFE ),t.PEFACTMAN = isnull( d.PEFACTMAN, t.PEFACTMAN ),t.FACTMCEP = isnull( d.FACTMCEP, t.FACTMCEP ),t.PEFACTMCEP = isnull( d.PEFACTMCEP, t.PEFACTMCEP ),t.ENLACEOP = isnull( d.ENLACEOP, t.ENLACEOP ),t.FACTMVC = isnull( d.FACTMVC, t.FACTMVC ),t.BDFE = isnull( d.BDFE, t.BDFE ),t.FACTELEC = isnull( d.FACTELEC, t.FACTELEC ),t.PEFACTELEC = isnull( d.PEFACTELEC, t.PEFACTELEC ),t.FACTECEP = isnull( d.FACTECEP, t.FACTECEP ),t.DATOSRET = isnull( d.DATOSRET, t.DATOSRET ),t.PEFACTECEP = isnull( d.PEFACTECEP, t.PEFACTECEP ),t.FACTEVC = isnull( d.FACTEVC, t.FACTEVC ),t.FACTFISCAL = isnull( d.FACTFISCAL, t.FACTFISCAL ),t.OBSERVA = isnull( d.OBSERVA, t.OBSERVA ),t.PEFACTFISC = isnull( d.PEFACTFISC, t.PEFACTFISC ),t.FACTFCEP = isnull( d.FACTFCEP, t.FACTFCEP ),t.PEFACTFCEP = isnull( d.PEFACTFCEP, t.PEFACTFCEP ),t.FACTFVC = isnull( d.FACTFVC, t.FACTFVC ),t.PAGADO = isnull( d.PAGADO, t.PAGADO ),t.PROMOS = isnull( d.PROMOS, t.PROMOS ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.ECOM t inner join deleted d 
							 on t.CODIGO = d.CODIGO
				-- Fin Updates
				insert into ZooLogic.ECOM(Fecimpo,Faltafw,Fecexpo,Fmodifw,Fectrans,Horaimpo,Hmodifw,Horaexpo,Bdmodifw,Bdaltafw,Haltafw,Saltafw,Esttrans,Zadsfw,Vmodifw,Ualtafw,Smodifw,Umodifw,Valtafw,Codigo,Valecamb,Cuenta,Codlista,Accion,Factsinper,Cuentacom,Vendedor,Buzon,Fecnov,Idvinc,Tipoecom,Transpor,Basededato,Motivo,Ultorder,Vacio,Dtosenvio,Generacan,Pago,Condpago,Valctacte,Cliedef,Telenvio,Descartar,Usaotrabd,Convenv,Conccolor,Conctalle,Concart,Cargaautov,Dtospago,Pedido,Origenst,Percctacte,Numero,Remito,Accionfe,Aplicenvio,Nrocarrito,Factmanual,Buzonfe,Pefactman,Factmcep,Pefactmcep,Enlaceop,Factmvc,Bdfe,Factelec,Pefactelec,Factecep,Datosret,Pefactecep,Factevc,Factfiscal,Observa,Pefactfisc,Factfcep,Pefactfcep,Factfvc,Pagado,Promos,Obs)
					Select isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.HORAIMPO,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.BDMODIFW,''),isnull( d.BDALTAFW,''),convert( char(8), getdate(), 108 ),isnull( d.SALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.UALTAFW,''),isnull( d.SMODIFW,''),isnull( d.UMODIFW,''),isnull( d.VALTAFW,''),isnull( d.CODIGO,''),isnull( d.VALECAMB,0),isnull( d.CUENTA,''),isnull( d.CODLISTA,''),isnull( d.ACCION,''),isnull( d.FACTSINPER,0),isnull( d.CUENTACOM,''),isnull( d.VENDEDOR,''),isnull( d.BUZON,''),isnull( d.FECNOV,''),isnull( d.IDVINC,0),isnull( d.TIPOECOM,0),isnull( d.TRANSPOR,''),isnull( d.BASEDEDATO,''),isnull( d.MOTIVO,''),isnull( d.ULTORDER,0),isnull( d.VACIO,0),isnull( d.DTOSENVIO,0),isnull( d.GENERACAN,0),isnull( d.PAGO,''),isnull( d.CONDPAGO,''),isnull( d.VALCTACTE,''),isnull( d.CLIEDEF,''),isnull( d.TELENVIO,0),isnull( d.DESCARTAR,0),isnull( d.USAOTRABD,0),isnull( d.CONVENV,''),isnull( d.CONCCOLOR,''),isnull( d.CONCTALLE,''),isnull( d.CONCART,''),isnull( d.CARGAAUTOV,0),isnull( d.DTOSPAGO,0),isnull( d.PEDIDO,0),isnull( d.ORIGENST,''),isnull( d.PERCCTACTE,0),isnull( d.NUMERO,0),isnull( d.REMITO,0),isnull( d.ACCIONFE,''),isnull( d.APLICENVIO,0),isnull( d.NROCARRITO,0),isnull( d.FACTMANUAL,0),isnull( d.BUZONFE,''),isnull( d.PEFACTMAN,0),isnull( d.FACTMCEP,0),isnull( d.PEFACTMCEP,0),isnull( d.ENLACEOP,0),isnull( d.FACTMVC,0),isnull( d.BDFE,''),isnull( d.FACTELEC,0),isnull( d.PEFACTELEC,0),isnull( d.FACTECEP,0),isnull( d.DATOSRET,0),isnull( d.PEFACTECEP,0),isnull( d.FACTEVC,0),isnull( d.FACTFISCAL,0),isnull( d.OBSERVA,0),isnull( d.PEFACTFISC,0),isnull( d.FACTFCEP,0),isnull( d.PEFACTFCEP,0),isnull( d.FACTFVC,0),isnull( d.PAGADO,0),isnull( d.PROMOS,0),isnull( d.OBS,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_ECOMMERCE' ) < 1
				...
				Try
					...
					.Conctalle = nvl( c_ECOMMERCE.Conctalle, [] )
...
<VFPData xml:space="preserve">
	...
	<row entidad="ECOMMERCE                               " atributo="FECHATRANSFERENCIA                      " tabla="ECOM           " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ECOMMERCE                               " atributo="ESTADOTRANSFERENCIA                     " tabla="ECOM           " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ECOMMERCE                               " atributo="VENDEDOR                                " tabla="ECOM           " campo="VENDEDOR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="VENDEDOR                                " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Vendedor                                                                                                                                                        " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="BUZON                                   " tabla="ECOM           " campo="BUZON     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Buzón                                                                                                                                                           " dominio="COMBOBUZON                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="FECHANOVEDADES                          " tabla="ECOM           " campo="FECNOV    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="Obtener novedades a partir de                                                                                                                                   " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="4" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="IDVINCULACION                           " tabla="ECOM           " campo="IDVINC    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="ID vinculación                                                                                                                                                  " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="TIPOECOMMERCE                           " tabla="ECOM           " campo="TIPOECOM  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Tipo ecommerce                                                                                                                                                  " dominio="COMBOXML                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="TRANSPORTISTA                           " tabla="ECOM           " campo="TRANSPOR  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="TRANSPORTISTA                           " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Transportista                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="BASEDEDATOS                             " tabla="ECOM           " campo="BASEDEDATO" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="11" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Base de datos                                                                                                                                                   " dominio="COMBOSUCURSALESECOMMERCE      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="ECOMMERCE                               " atributo="CLIENTEDEFAULT                          " tabla="ECOM           " campo="CLIEDEF   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLIENTE                                 " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="434" etiqueta="Cliente Dragonfish                                                                                                                                              " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="7" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="TELEFONODEENVIO                         " tabla="ECOM           " campo="TELENVIO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="436" etiqueta="Teléfono de envío                                                                                                                                               " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="7" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="DESCARTAR                               " tabla="ECOM           " campo="DESCARTAR " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="438" etiqueta="Descartar                                                                                                                                                       " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="6" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="UTILIZASTOCKOTRABASE                    " tabla="ECOM           " campo="USAOTRABD " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="L         " longitud="1" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="440" etiqueta="Utilizar stock de otra base de datos                                                                                                                            " dominio="SINOBOOL                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="2" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="CONCENVIO                               " tabla="ECOM           " campo="CONVENV   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="Concepto para envio                                                                                                                                             " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="CONCCOLOR                               " tabla="ECOM           " campo="CONCCOLOR " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="COLOR                                   " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="444" etiqueta="Color del concepto para envío                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="11" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="CONCTALLE                               " tabla="ECOM           " campo="CONCTALLE " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="5" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="446" etiqueta="Talle del concepto para envío                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="12" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ECOMMERCE                               " atributo="CONCARTICULO                            " tabla="ECOM           " campo="CONCART   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="ARTICULO                                " tipodato="C         " longitud="13" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="448" etiqueta="Vinculación por defecto                                                                                                                                         " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="2" subgrupo="3" orden="13" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVALORES       " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="429" etiqueta="Detalle Val.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVALORES On ECOM.PAGO = XVALORES.CLCOD And  XVALORES.CLCOD != '' AND XVALORES.CLCOD != ''                                                                                                                                                          " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="VALOR                                   " atributo="DESCRIPCION                             " tabla="XVALORES       " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="433" etiqueta="Detalle Val.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join XVALORES On ECOM.VALCTACTE = XVALORES.CLCOD And  XVALORES.CLCOD != '' AND XVALORES.CLCOD != ''                                                                                                                                                     " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="CLIENTE                                 " atributo="NOMBRE                                  " tabla="CLI            " campo="CLNOM     " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="435" etiqueta="Detalle Cli.                                                                                                                                                    " dominio="TEXTOBUSQUEDA                 " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join CLI On ECOM.CLIEDEF = CLI.CLCOD And  CLI.CLCOD != ''                                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ARTICULO                                " atributo="DESCRIPCION                             " tabla="ART            " campo="ARTDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="443" etiqueta="Detalle Con.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ART On ECOM.CONVENV = ART.ARTCOD And  ART.ARTCOD != ''                                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="COLOR                                   " atributo="DESCRIPCION                             " tabla="COL            " campo="COLDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="445" etiqueta="Detalle Col.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join COL On ECOM.CONCCOLOR = COL.COLCOD And  COL.COLCOD != ''                                                                                                                                                                                           " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="ARTICULO                                " atributo="DESCRIPCION                             " tabla="ART            " campo="ARTDES    " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="40" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="449" etiqueta="Detalle Vin.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join ART On ECOM.CONCART = ART.ARTCOD And  ART.ARTCOD != ''                                                                                                                                                                                             " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
