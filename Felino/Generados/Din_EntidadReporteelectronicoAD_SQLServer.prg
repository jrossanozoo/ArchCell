...
define class Din_EntidadREPORTEELECTRONICOAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxRepoelecFmodifw, lxRepoelecFecimpo, lxRepoelecFectrans, lxRepoelecFecexpo, lxRepoelecFaltafw, lxRepoelecZadsfw, lxRepoelecNumero, lxRepoelecSmodifw, lxRepoelecSaltafw, lxRepoelecUaltafw, lxRepoelecValtafw, lxRepoelecVmodifw, lxRepoelecUmodifw, lxRepoelecZadsfw, lxRepoelecHmodifw, lxRepoelecBdaltafw, lxRepoelecHoraimpo, lxRepoelecBdmodifw, lxRepoelecEsttrans, lxRepoelecHaltafw, lxRepoelecHoraexpo, lxRepoelecCodint, lxRepoelecFaltafw, lxRepoelecPtoventa, lxRepoelecDesafip, lxRepoelecDesaudi, lxRepoelecFecddeafip, lxRepoelecTipodes, lxRepoelecFecddeaudi, lxRepoelecFechtaafip, lxRepoelecFechtaaudi, lxRepoelecRutaafip, lxRepoelecNroddeaudi, lxRepoelecNrohtaaud, lxRepoelecRutaaudi, lxRepoelecObs
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.REPOELEC ( "Fmodifw","Fecimpo","Fectrans","Fecexpo","Faltafw","Zadsfw","Numero","Smodifw","Saltafw","Ualtafw","Valtafw","Vmodifw","Umodifw","Hmodifw","Bdaltafw","Horaimpo","Bdmodifw","Esttrans","Haltafw","Horaexpo","Codint","Ptoventa","Desafip","Desaudi","Fecddeafip","Tipodes","Fecddeaudi","Fechtaafip","Fechtaaudi","Rutaafip","Nroddeaudi","Nrohtaaud","Rutaaudi","Obs" ) values ( <<"'" + this.ConvertirDateSql( lxRepoelecFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepoelecFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepoelecFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepoelecFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepoelecFaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecZadsfw ) + "'" >>, <<lxRepoelecNumero >>, <<"'" + this.FormatearTextoSql( lxRepoelecSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecCodint ) + "'" >>, <<lxRepoelecPtoventa >>, <<iif( lxRepoelecDesafip, 1, 0 ) >>, <<iif( lxRepoelecDesaudi, 1, 0 ) >>, <<"'" + this.ConvertirDateSql( lxRepoelecFecddeafip ) + "'" >>, <<lxRepoelecTipodes >>, <<"'" + this.ConvertirDateSql( lxRepoelecFecddeaudi ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepoelecFechtaafip ) + "'" >>, <<"'" + this.ConvertirDateSql( lxRepoelecFechtaaudi ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecRutaafip ) + "'" >>, <<lxRepoelecNroddeaudi >>, <<lxRepoelecNrohtaaud >>, <<"'" + this.FormatearTextoSql( lxRepoelecRutaaudi ) + "'" >>, <<"'" + this.FormatearTextoSql( lxRepoelecObs ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.REPOELEC set "Fmodifw" = <<"'" + this.ConvertirDateSql( lxRepoelecFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxRepoelecFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxRepoelecFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxRepoelecFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxRepoelecFaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxRepoelecZadsfw ) + "'">>,"Numero" = <<lxRepoelecNumero>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxRepoelecSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxRepoelecSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxRepoelecUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxRepoelecValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxRepoelecVmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxRepoelecUmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxRepoelecHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxRepoelecBdaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxRepoelecHoraimpo ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxRepoelecBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxRepoelecEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxRepoelecHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxRepoelecHoraexpo ) + "'">>,"Codint" = <<"'" + this.FormatearTextoSql( lxRepoelecCodint ) + "'">>,"Ptoventa" = <<lxRepoelecPtoventa>>,"Desafip" = <<iif( lxRepoelecDesafip, 1, 0 )>>,"Desaudi" = <<iif( lxRepoelecDesaudi, 1, 0 )>>,"Fecddeafip" = <<"'" + this.ConvertirDateSql( lxRepoelecFecddeafip ) + "'">>,"Tipodes" = <<lxRepoelecTipodes>>,"Fecddeaudi" = <<"'" + this.ConvertirDateSql( lxRepoelecFecddeaudi ) + "'">>,"Fechtaafip" = <<"'" + this.ConvertirDateSql( lxRepoelecFechtaafip ) + "'">>,"Fechtaaudi" = <<"'" + this.ConvertirDateSql( lxRepoelecFechtaaudi ) + "'">>,"Rutaafip" = <<"'" + this.FormatearTextoSql( lxRepoelecRutaafip ) + "'">>,"Nroddeaudi" = <<lxRepoelecNroddeaudi>>,"Nrohtaaud" = <<lxRepoelecNrohtaaud>>,"Rutaaudi" = <<"'" + this.FormatearTextoSql( lxRepoelecRutaaudi ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxRepoelecObs ) + "'">> where "Codint" = <<"'" + this.FormatearTextoSql( lxRepoelecCodint ) + "'">> and  REPOELEC.CODINT != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Zadsfw" as "Acciones", "Numero" as "Numero", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Codint" as "Codint", "Faltafw" as "Fecha", "Ptoventa" as "Puntodeventa", "Desafip" as "Descargaafip", "Desaudi" as "Descargaauditoria", "Fecddeafip" as "Fechadesdeafip", "Tipodes" as "Tipodescargaauditoria", "Fecddeaudi" as "Fechadesdeauditoria", "Fechtaafip" as "Fechahastaafip", "Fechtaaudi" as "Fechahastaauditoria", "Rutaafip" as "Rutaafip", "Nroddeaudi" as "Numerodesdeauditoria", "Nrohtaaud" as "Numerohastaauditoria", "Rutaaudi" as "Rutaauditoria", "Obs" as "Observacion" from ZooLogic.REPOELEC where "Codint" = <<"'" + this.FormatearTextoSql( lxRepoelecCodint ) + "'">> and  REPOELEC.CODINT != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Fmodifw,Fecimpo,Fectrans,Fecexpo,Faltafw,Zadsfw,Numero,Smodifw,Saltafw,Ualtafw,Valtafw,Vmodi" + ;
"fw,Umodifw,Hmodifw,Bdaltafw,Horaimpo,Bdmodifw,Esttrans,Haltafw,Horaexpo,Codint,Ptoventa,Desafip,Desa" + ;
			...
			if reccount( 'curSeek' ) > 0
				...
				Else
					...
					Text to lcCampos noShow
						 FMODIFW, FECIMPO, FECTRANS, FECEXPO, FALTAFW, ZADSFW, Numero, SMODIFW, SALTAFW, UALTAFW, VALTAFW, VMODIFW, UMODIFW, ZADSFW, HMODIFW, BDALTAFW, HORAIMPO, BDMODIFW, ESTTRANS, HALTAFW, HORAEXPO, CodInt, FAltaFW, PtoVenta, DesAFIP, DesAudi, FecDdeAFIP, TipoDes, FecDdeAudi, FecHtaAFIP, FecHtaAudi, RutaAFIP, NroDdeAudi, NroHtaAud, RutaAudi, Obs
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + transform( &lcCursor..Numero )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.NUMERO = isnull( d.NUMERO, t.NUMERO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.CODINT = isnull( d.CODINT, t.CODINT ),t.PTOVENTA = isnull( d.PTOVENTA, t.PTOVENTA ),t.DESAFIP = isnull( d.DESAFIP, t.DESAFIP ),t.DESAUDI = isnull( d.DESAUDI, t.DESAUDI ),t.FECDDEAFIP = isnull( d.FECDDEAFIP, t.FECDDEAFIP ),t.TIPODES = isnull( d.TIPODES, t.TIPODES ),t.FECDDEAUDI = isnull( d.FECDDEAUDI, t.FECDDEAUDI ),t.FECHTAAFIP = isnull( d.FECHTAAFIP, t.FECHTAAFIP ),t.FECHTAAUDI = isnull( d.FECHTAAUDI, t.FECHTAAUDI ),t.RUTAAFIP = isnull( d.RUTAAFIP, t.RUTAAFIP ),t.NRODDEAUDI = isnull( d.NRODDEAUDI, t.NRODDEAUDI ),t.NROHTAAUD = isnull( d.NROHTAAUD, t.NROHTAAUD ),t.RUTAAUDI = isnull( d.RUTAAUDI, t.RUTAAUDI ),t.OBS = isnull( d.OBS, t.OBS )
					from ZooLogic.REPOELEC t inner join deleted d 
							 on t.CodInt = d.CodInt
							 and  t.Numero = d.Numero
				-- Fin Updates
				insert into ZooLogic.REPOELEC(Fmodifw,Fecimpo,Fectrans,Fecexpo,Faltafw,Zadsfw,Numero,Smodifw,Saltafw,Ualtafw,Valtafw,Vmodifw,Umodifw,Hmodifw,Bdaltafw,Horaimpo,Bdmodifw,Esttrans,Haltafw,Horaexpo,Codint,Ptoventa,Desafip,Desaudi,Fecddeafip,Tipodes,Fecddeaudi,Fechtaafip,Fechtaaudi,Rutaafip,Nroddeaudi,Nrohtaaud,Rutaaudi,Obs)
					Select isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.ZADSFW,''),isnull( d.NUMERO,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.VMODIFW,''),isnull( d.UMODIFW,''),isnull( d.HMODIFW,''),isnull( d.BDALTAFW,''),isnull( d.HORAIMPO,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.CODINT,''),isnull( d.PTOVENTA,0),isnull( d.DESAFIP,0),isnull( d.DESAUDI,0),isnull( d.FECDDEAFIP,''),isnull( d.TIPODES,0),isnull( d.FECDDEAUDI,''),isnull( d.FECHTAAFIP,''),isnull( d.FECHTAAUDI,''),isnull( d.RUTAAFIP,''),isnull( d.NRODDEAUDI,0),isnull( d.NROHTAAUD,0),isnull( d.RUTAAUDI,''),isnull( d.OBS,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="REPORTEELECTRONICO                      " atributo="FECHATRANSFERENCIA                      " tabla="REPOELEC       " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REPORTEELECTRONICO                      " atributo="ESTADOTRANSFERENCIA                     " tabla="REPOELEC       " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="REPORTEELECTRONICO                      " atributo="FECHAHASTAAUDITORIA                     " tabla="REPOELEC       " campo="FECHTAAUDI" claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="209" etiqueta="Fecha hasta                                                                                                                                                     " dominio="FECHACALENDARIO               " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="20" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
