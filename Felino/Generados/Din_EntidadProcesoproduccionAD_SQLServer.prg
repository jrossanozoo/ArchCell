	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.PROCPRODUC ( "Fecexpo","Fmodifw","Fecimpo","Faltafw","Fectrans","Timestamp","Smodifw","Saltafw","Ualtafw","Valtafw","Umodifw","Zadsfw","Vmodifw","Hmodifw","Horaexpo","Horaimpo","Bdaltafw","Bdmodifw","Esttrans","Haltafw","Obs","Rubro","Codigo","Descrip","Clasif" ) values ( <<"'" + this.ConvertirDateSql( lxProcproducFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProcproducFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProcproducFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProcproducFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxProcproducFectrans ) + "'" >>, <<lxProcproducTimestamp >>, <<"'" + this.FormatearTextoSql( lxProcproducSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducObs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducRubro ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducDescrip ) + "'" >>, <<"'" + this.FormatearTextoSql( lxProcproducClasif ) + "'" >> )
			endtext
		...
		this.oEntidad.Timestamp = lxProcproducTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.PROCPRODUC set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxProcproducFecexpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxProcproducFmodifw ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxProcproducFecimpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxProcproducFaltafw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxProcproducFectrans ) + "'">>,"Timestamp" = <<lxProcproducTimestamp>>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxProcproducSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxProcproducSaltafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxProcproducUaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxProcproducValtafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxProcproducUmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxProcproducZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxProcproducVmodifw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxProcproducHmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxProcproducHoraexpo ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxProcproducHoraimpo ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxProcproducBdaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxProcproducBdmodifw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxProcproducEsttrans ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxProcproducHaltafw ) + "'">>,"Obs" = <<"'" + this.FormatearTextoSql( lxProcproducObs ) + "'">>,"Rubro" = <<"'" + this.FormatearTextoSql( lxProcproducRubro ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxProcproducCodigo ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxProcproducDescrip ) + "'">>,"Clasif" = <<"'" + this.FormatearTextoSql( lxProcproducClasif ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxProcproducCodigo ) + "'">> and  PROCPRODUC.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Rubro" as "Rubro", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion" from ZooLogic.PROCPRODUC where  PROCPRODUC.CODIGO != '' order by Codigo
			endtext
			use in select('c_PROCESOPRODUCCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PROCESOPRODUCCION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Rubro" as "Rubro", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion" from ZooLogic.PROCPRODUC where  funciones.padr( Codigo, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PROCPRODUC.CODIGO != '' order by Codigo
			endtext
			use in select('c_PROCESOPRODUCCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PROCESOPRODUCCION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Rubro" as "Rubro", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion" from ZooLogic.PROCPRODUC where  funciones.padr( Codigo, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  PROCPRODUC.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_PROCESOPRODUCCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PROCESOPRODUCCION', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Rubro" as "Rubro", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion" from ZooLogic.PROCPRODUC where  PROCPRODUC.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_PROCESOPRODUCCION')
			this.oConexion.EjecutarSql( lcSentencia, 'c_PROCESOPRODUCCION', set( 'Datasession' ) )
			Endwith
...
"adsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Haltafw,Obs,Rubro,Codigo,Descrip," + ;
"Clasif" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Fecexpo" as "Fechaexpo", "Fmodifw" as "Fechamodificacionfw", "Fecimpo" as "Fechaimpo", "Faltafw" as "Fechaaltafw", "Fectrans" as "Fechatransferencia", "Timestamp" as "Timestamp", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Ualtafw" as "Usuarioaltafw", "Valtafw" as "Versionaltafw", "Umodifw" as "Usuariomodificacionfw", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Hmodifw" as "Horamodificacionfw", "Horaexpo" as "Horaexpo", "Horaimpo" as "Horaimpo", "Bdaltafw" as "Basededatosaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Esttrans" as "Estadotransferencia", "Haltafw" as "Horaaltafw", "Obs" as "Obs", "Rubro" as "Rubro", "Codigo" as "Codigo", "Descrip" as "Descripcion", "Clasif" as "Clasificacion"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.PROCPRODUC set "Fecexpo" = <<"'" + this.ConvertirDateSql( lxProcproducFecexpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxProcproducFmodifw ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxProcproducFecimpo ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxProcproducFaltafw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxProcproducFectrans ) + "'">>, "Timestamp" = <<lxProcproducTimestamp>>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxProcproducSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxProcproducSaltafw ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxProcproducUaltafw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxProcproducValtafw ) + "'">>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxProcproducUmodifw ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxProcproducZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxProcproducVmodifw ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxProcproducHmodifw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxProcproducHoraexpo ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxProcproducHoraimpo ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxProcproducBdaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxProcproducBdmodifw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxProcproducEsttrans ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxProcproducHaltafw ) + "'">>, "Obs" = <<"'" + this.FormatearTextoSql( lxProcproducObs ) + "'">>, "Rubro" = <<"'" + this.FormatearTextoSql( lxProcproducRubro ) + "'">>, "Codigo" = <<"'" + this.FormatearTextoSql( lxProcproducCodigo ) + "'">>, "Descrip" = <<"'" + this.FormatearTextoSql( lxProcproducDescrip ) + "'">>, "Clasif" = <<"'" + this.FormatearTextoSql( lxProcproducClasif ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'PROCPRODUC' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		EndWith
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.PROCPRODUC set  FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, Obs = ] + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"+ [, Rubro = ] + "'" + this.FormatearTextoSql( &lcCursor..Rubro ) + "'"+ [, Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'"+ [, Descrip = ] + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'"+ [, Clasif = ] + "'" + this.FormatearTextoSql( &lcCursor..Clasif ) + "'" + [ Where Codigo = ] + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" )
				...
				Text to lcCampos noShow
					 FECEXPO, FMODIFW, FECIMPO, FALTAFW, FECTRANS, TIMESTAMP, SMODIFW, SALTAFW, UALTAFW, VALTAFW, UMODIFW, ZADSFW, VMODIFW, HMODIFW, HORAEXPO, HORAIMPO, BDALTAFW, BDMODIFW, ESTTRANS, HALTAFW, Obs, Rubro, Codigo, Descrip, Clasif
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Obs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..Rubro ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Codigo ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Descrip ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..Clasif ) + "'"
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.OBS = isnull( d.OBS, t.OBS ),t.RUBRO = isnull( d.RUBRO, t.RUBRO ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.DESCRIP = isnull( d.DESCRIP, t.DESCRIP ),t.CLASIF = isnull( d.CLASIF, t.CLASIF )
					from ZooLogic.PROCPRODUC t inner join deleted d 
							 on t.Codigo = d.Codigo
				-- Fin Updates
				insert into ZooLogic.PROCPRODUC(Fecexpo,Fmodifw,Fecimpo,Faltafw,Fectrans,Timestamp,Smodifw,Saltafw,Ualtafw,Valtafw,Umodifw,Zadsfw,Vmodifw,Hmodifw,Horaexpo,Horaimpo,Bdaltafw,Bdmodifw,Esttrans,Haltafw,Obs,Rubro,Codigo,Descrip,Clasif)
					Select isnull( d.FECEXPO,''),isnull( d.FMODIFW,''),isnull( d.FECIMPO,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECTRANS,''),isnull( d.TIMESTAMP,0),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.UALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UMODIFW,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.HMODIFW,''),isnull( d.HORAEXPO,''),isnull( d.HORAIMPO,''),isnull( d.BDALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.ESTTRANS,''),convert( char(8), getdate(), 108 ),isnull( d.OBS,''),isnull( d.RUBRO,''),isnull( d.CODIGO,''),isnull( d.DESCRIP,''),isnull( d.CLASIF,'')
		...
		with this.oEntidad
			...
			if reccount( 'c_PROCESOPRODUCCION' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_PROCESOPRODUCCION.Timestamp, 0 )
...
<VFPData xml:space="preserve">
	...
	<row entidad="PROCESOPRODUCCION                       " atributo="FECHATRANSFERENCIA                      " tabla="PROCPRODUC     " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PROCESOPRODUCCION                       " atributo="TIMESTAMP                               " tabla="PROCPRODUC     " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PROCESOPRODUCCION                       " atributo="ESTADOTRANSFERENCIA                     " tabla="PROCPRODUC     " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PROCESOPRODUCCION                       " atributo="RUBRO                                   " tabla="PROCPRODUC     " campo="RUBRO     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="RUBROPRODUCCION                         " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Rubro                                                                                                                                                           " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PROCESOPRODUCCION                       " atributo="CLASIFICACION                           " tabla="PROCPRODUC     " campo="CLASIF    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="CLASIFICACIONPRODUCCION                 " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Clasificación                                                                                                                                                   " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
