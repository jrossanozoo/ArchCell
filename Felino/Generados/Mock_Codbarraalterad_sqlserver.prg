...
define class Mock_Codbarraalterad_sqlserver as MockBase of MockBase.prg

	cClase = 'Codbarraalterad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetallecodbardetalle( tcatributo as string ) as string                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Obtenercampodetallecodbardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetallecodbardetalle( tccampos as string ) as string                                                                                                                                                                          
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetallecodbardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetallecodbardetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                  
		...
		return this.ObtenerResultado( 'Obtenerdatosdetallecodbardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_codbaralterdet( tctablatrabajo ) as string                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_codbaralterdet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetallecodbardetalle( tccampos as string ) as string                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Parsearcamposdetallecodbardetalle', lcParametros )
	EndFunc
