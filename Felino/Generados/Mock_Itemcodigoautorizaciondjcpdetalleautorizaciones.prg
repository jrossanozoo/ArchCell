...
define class Mock_Itemcodigoautorizaciondjcpdetalleautorizaciones as MockBase of MockBase.prg

	cClase = 'Itemcodigoautorizaciondjcpdetalleautorizaciones'
	...
	*-----------------------------------------------------------------------------------------
	function codigoautorizacion_assign( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Codigoautorizacion_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function codigodjcp_assign( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Codigodjcp_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigoautorizacion( txval as variant ) as void                                                                                                                                                                                            
		...
		return this.ObtenerResultado( 'Setear_codigoautorizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_codigodjcp( txval as variant ) as void                                                                                                                                                                                                    
		...
		return this.ObtenerResultado( 'Setear_codigodjcp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigoautorizacion( txval as variant ) as boolean                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Validar_codigoautorizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_codigodjcp( txval as variant ) as boolean                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Validar_codigodjcp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigoautorizacion() as void                                                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Valorsugeridocodigoautorizacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridocodigodjcp() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Valorsugeridocodigodjcp', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridoruta() as void                                                                                                                                                                                                                      
		...
		return this.ObtenerResultado( 'Valorsugeridoruta', lcParametros )
	EndFunc
