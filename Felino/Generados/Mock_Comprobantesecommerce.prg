...
define class Mock_comprobantesecommerce as MockBase of MockBase.prg
	...
	cCaracteres = ""                                                                                                                                                                                                                                          
	cContexto = ""                                                                                                                                                                                                                                            
	cDescripcion =  "Herramienta de generación de comprobantes ecommerce"                                                                                                                                                                                     
	...
	lHabilitarDetalleOperaciones = .T.                                                                                                                                                                                                                        
	lHabilitarEcommerce_PK = .T.                                                                                                                                                                                                                              
	...
	oColErrComprobantesSinCAE = null                                                                                                                                                                                                                          
	oColErrores = null                                                                                                                                                                                                                                        
	oColaboradorComandosDOS = null                                                                                                                                                                                                                            
	oColaboradorJsonConvert = null                                                                                                                                                                                                                            
	oColaboradorNotificacionesPorMail = null                                                                                                                                                                                                                  
	oColeccionVS = null                                                                                                                                                                                                                                       
	oColeccionVSFW = null                                                                                                                                                                                                                                     
	oComponenteComprobante = null                                                                                                                                                                                                                             
	oComportamientoCodigoSugerido = null                                                                                                                                                                                                                      
	oDatosTareaProgramada = null                                                                                                                                                                                                                              
	oExtension = null                                                                                                                                                                                                                                         
	oGestorDeMail = null                                                                                                                                                                                                                                      
	oInformacion = null                                                                                                                                                                                                                                       
	oLogueo = null                                                                                                                                                                                                                                            
	...
	*-----------------------------------------------------------------------------------------
	function actualizarhuboerrores() as void                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizarhuboerrores', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function actualizaritem( tccomp as integer, tccursor as string ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Actualizaritem', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function armarcursorarticulos( lccursorarticulos as string, lccursor as string ) as void                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = lccursorarticulos
		lxParam2 = lccursor
		...
		return this.ObtenerResultado( 'Armarcursorarticulos', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function armarcursorbuzones( lccursorbuzones as string ) as string                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = lccursorbuzones
		...
		return this.ObtenerResultado( 'Armarcursorbuzones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function armarcursorclientesecom( lccursorclientesecom as string, lccursor as string )as void                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = lccursorclientesecom
		lxParam2 = lccursor
		...
		return this.ObtenerResultado( 'Armarcursorclientesecom', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function armarcursoroperacionessinarticulo( lccursorpublic as string, lccursor as string ) as void                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = lccursorpublic
		lxParam2 = lccursor
		...
		return this.ObtenerResultado( 'Armarcursoroperacionessinarticulo', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cambiosdetalledetalleoperaciones() as void                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Cambiosdetalledetalleoperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargardatosclienteecommerce( toentidad, tcclientedragon, tooperacion ) as void                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Cargardatosclienteecommerce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function cargaroperaciones( tcconsulta, tcplataforma, tcbuzon, tcbasededatos, tcaccion, tcbuzonfullenv, tcbasededatosfullenv, tcaccionfullenv, tlutilizastockotrabase, tcbdorigenstock ) as void                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		lxParam3 = tcbuzon
		lxParam4 = tcbasededatos
		lxParam5 = tcaccion
		lxParam6 = tcbuzonfullenv
		lxParam7 = tcbasededatosfullenv
		lxParam8 = tcaccionfullenv
		lxParam9 = tlutilizastockotrabase
		lxParam10 = tcbdorigenstock
		...
		return this.ObtenerResultado( 'Cargaroperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function desmarcaroperacion( tcguidoperacion as string ) as void                                                                                                                                                                                          
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Desmarcaroperacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function detalleoperaciones_access() as variant                                                                                                                                                                                                           
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'detalleoperaciones_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'detalleoperaciones_access', lcParametros )			endif		endif		if !this.ldestroy and ( !vartype( this.Detalleoperaciones ) = 'O' or isnull( this.Detalleoperaciones ) )			this.Detalleoperaciones = this.crearobjeto( 'DetalleComprobantesecommerceDetalleoperaciones' )			this.Detalleoperaciones.inicializar()			this.enlazar( 'Detalleoperaciones.EventoObtenerLogueo', 'inyectarLogueo' )			this.enlazar( 'Detalleoperaciones.EventoObtenerInformacion', 'inyectarInformacion' )			bindevent( this.Detalleoperaciones, 'CambioSumarizado', this, 'CambiosDetalleDetalleoperaciones', 1)			this.enlazar( 'Detalleoperaciones.EventoAdvertirLimitePorDiseno', 'EventoAdvertirLimitePorDiseno')			this.enlazar( 'Detalleoperaciones.EventoCancelarCargaLimitePorDiseno', 'EventoCancelarCargaLimitePorDiseno')			this.Detalleoperaciones.lVerificarLimitesEnDisenoImpresion = .t.		endif		return this.Detalleoperaciones
	EndFunc

	*-----------------------------------------------------------------------------------------
	function determinarcomprobante( tntipocomprobante as integer, tnentrega as integer ) as string                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Determinarcomprobante', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function determinarsucursal( tcsucursal as string ) as string                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Determinarsucursal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eliminarregistro() as void                                                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eliminarregistro', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function enviaremaildeerrorpersonalizado( tcmensajeerror as string ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcmensajeerror
	...
	*-----------------------------------------------------------------------------------------
	function enviarmensajeriaparaconfiguraciondeparametrosenviodemails( tcparametrosnoconfig as string ) as void                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcparametrosnoconfig
		...
		return this.ObtenerResultado( 'Enviarmensajeriaparaconfiguraciondeparametrosenviodemails', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esconsumidorfinal( tcclienteecommerce as string, tccursorclientesecom as string ) as boolean                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcclienteecommerce
		lxParam2 = tccursorclientesecom
		...
		return this.ObtenerResultado( 'Esconsumidorfinal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function esfacturaenbaseapedido( tctipocomp as string ) as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Esfacturaenbaseapedido', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function estantodaslasacciones() as boolean                                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Estantodaslasacciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventodeshabilitardetalle( tldeshabilitar ) as void                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Eventodeshabilitardetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventopedirdatostareaprogramada() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventopedirdatostareaprogramada', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function eventorefrescardetalle( tlutilizastockotrabase as boolean ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function eventoresaltaroperaciones() as void                                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventoresaltaroperaciones', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function eventorestaurarvaloresdelcomboacciones() as void                                                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Eventorestaurarvaloresdelcomboacciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarcomprobantes( tnacciones ) as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Generarcomprobantes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarnuevofiltradoyprocesar( tcplataforma as string, tcbasededatos as string ) as void                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Generarnuevofiltradoyprocesar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function generarscript( toplataformas as zoocoleccion of zoocoleccion.prg ) as void                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = toplataformas
		...
		return this.ObtenerResultado( 'Generarscript', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarscriptytareaprogramada( ) as void                                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Generarscriptytareaprogramada', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generartareaprogramada( tntiempoelegido as integer ) as void                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tntiempoelegido
		...
		return this.ObtenerResultado( 'Generartareaprogramada', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function generarvaledecambio( tccursor as string, tccomp as string ) as void                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Generarvaledecambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function grabarclientesecommerce( tccliente as string, tcclientedragon as string, tccursorclientesecom as string ) as void                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3
		...
		return this.ObtenerResultado( 'Grabarclientesecommerce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function hayqueeliminar( tnacciones as integer ) as boolean                                                                                                                                                                                               
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Hayqueeliminar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function hayquegenerarvaledecambio( tccursor as string ) as boolean                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Hayquegenerarvaledecambio', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function inyectarentidad( loentidad ) as void                                                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function lhabilitardetalleoperaciones_assign( txval as variant ) as void                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'lhabilitardetalleoperaciones_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'lhabilitardetalleoperaciones_assign', lcParametros )			endif		endif		this.lHabilitarDetalleOperaciones = txVal		this.DetalleOperaciones.habilitarItems( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function limpiaraccionensegundoplanooperaciones( toitem ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function loguearerrorcompadjunto() as void                                                                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
	...
	*-----------------------------------------------------------------------------------------
	function notieneoperaciones() as boolean                                                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Notieneoperaciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerclientedragon( tcclienteecom as string ) as string                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tcclienteecom
	...
	*-----------------------------------------------------------------------------------------
	function obtenercomprobanteagenerar( tccomprobante as string ) as string                                                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercomprobanteagenerar', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenercondicionarticulodura( tlgeneracancelacion as boolean ) as string                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1

		lnParametros = pcount()
		lxParam1 = tlgeneracancelacion
		...
		return this.ObtenerResultado( 'Obtenercondicionarticulodura', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosparagenerarcancelacion( tctabladatoscomprobantebase as string, tcguidoperacion as string ) as object                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tctabladatoscomprobantebase
		...
		return this.ObtenerResultado( 'Obtenerdatosparagenerarcancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdestinobuzon( tcbuzon as string, tccursorbuzones as string ) as string                                                                                                                                                                    
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tcbuzon
		lxParam2 = tccursorbuzones
		...
		return this.ObtenerResultado( 'Obtenerdestinobuzon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerjoinplataformadura( tcbasededatos as string, tlgeneracancelacion as boolean ) as string                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Obtenerjoinplataformadura', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function obtenerjsondatosecommerce( tccodigoplataforma as string, tnidvinculacion as integer, tntipoecommerce as integer, tcidshipping as string, tcstoreorder as string ) as string                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3, lxParam4, lxParam5

		lnParametros = pcount()
		lxParam1 = tccodigoplataforma
		lxParam2 = tnidvinculacion
		lxParam3 = tntipoecommerce
		lxParam4 = tcidshipping
		lxParam5 = tcstoreorder
		...
		return this.ObtenerResultado( 'Obtenerjsondatosecommerce', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenermontolimitesinpersonalizar( tctipocomprobante as string ) as double                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenermontolimitesinpersonalizar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertipodeentrega( tccomprobante as string ) as integer                                                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenertipodeentrega', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocolaboradorcomandosdos_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorcomandosdos_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorcomandosdos_access', lcParametros )			endif		endif		if !this.ldestroy and !vartype( this.oColaboradorComandosDOS ) = 'O'			this.oColaboradorComandosDOS = _screen.Zoo.CrearObjeto( "ColaboradorComandosDOS" )		endif		return this.oColaboradorComandosDOS
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocolaboradorjsonconvert_access() as variant                                                                                                                                                                                                      
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradorjsonconvert_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradorjsonconvert_access', lcParametros )			endif		endif		if !this.ldestroy and !vartype( this.oColaboradorJsonConvert ) = 'O'			this.oColaboradorJsonConvert = _screen.Zoo.CrearObjeto( "ColaboradorJsonConvert" )		endif		return this.oColaboradorJsonConvert
	EndFunc

	*-----------------------------------------------------------------------------------------
	function ocolaboradornotificacionespormail_access() as variant                                                                                                                                                                                            
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocolaboradornotificacionespormail_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocolaboradornotificacionespormail_access', lcParametros )			endif		endif		if type( "this.oColaboradorNotificacionesPorMail" ) != 'O' or isnull( this.oColaboradorNotificacionesPorMail )			this.oColaboradorNotificacionesPorMail = newobject( "ColaboradorNotificacionesPorMail", "ColaboradorNotificacionesPorMail.prg" )		endif		return this.oColaboradorNotificacionesPorMail
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function ocomponentecomprobante_access() as variant                                                                                                                                                                                                       
		lnParametros = pcount()lcParametros = ''		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'ocomponentecomprobante_access', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'ocomponentecomprobante_access', lcParametros )			endif		endif		if type( "this.oComponenteComprobante" ) != 'O' or isnull( this.oComponenteComprobante )			this.oComponenteComprobante = _screen.zoo.instanciarcomponente( "componentecomprobante" )		endif		return this.oComponenteComprobante
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function operacionespendientes_assign( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'operacionespendientes_assign', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'operacionespendientes_assign', lcParametros )			endif		endif		Local lxValOld As Variant		lxValOld = this.Operacionespendientes		local lxVal as Variant		lxVal = txVal		if This.CargaManual()			if this.Validar_Operacionespendientes( lxVal )				this.Setear_Operacionespendientes( lxVal )			EndIf		Else			This.Setear_Operacionespendientes( lxVal )		EndIf		dodefault( lxVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function permitefacturarsinpersonalizar( tccursor as string, tccursorclientesecom as string ) as boolean                                                                                                                                                  
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Permitefacturarsinpersonalizar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function puedocontinuarporcomprobantedelmismotipo( tccursor as string ) as boolean                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Puedocontinuarporcomprobantedelmismotipo', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function puedomarcaroperacionenproceso( tcguidoperacion as string ) as boolean                                                                                                                                                                            
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Puedomarcaroperacionenproceso', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seleccionarclientedragon( tcclientedragonenope as string, tcclienteecom as string, tcclientedragonencliecom as string ) as string                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2, lxParam3

		lnParametros = pcount()
		lxParam1 = tcclientedragonenope
		lxParam2 = tcclienteecom
		lxParam3 = tcclientedragonencliecom
		...
		return this.ObtenerResultado( 'Seleccionarclientedragon', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_operacionespendientes( txval as variant ) as void                                                                                                                                                                                         
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'setear_operacionespendientes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'setear_operacionespendientes', lcParametros )			endif		endif		this.Operacionespendientes = txVal		dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function seteosporerror( tnoperacion as integer, tccursor as string ) as void                                                                                                                                                                             
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Seteosporerror', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function tienecomprobantebaseparaaplicarcancelacion( tcguidoperacion as string ) as string                                                                                                                                                                
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Tienecomprobantebaseparaaplicarcancelacion', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_operacionespendientes( txval as variant ) as boolean                                                                                                                                                                                     
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer, ;		lnIdMetodo as Integer, lnIdClase as Integer, lxParam1lnParametros = pcount()lxParam1 = txvallcParametros = ''		for lni = 1 to lnParametros			lcParam = 'lxParam' + alltrim(str(lni))			lcParametros = lcParametros + iif( !empty(lcParametros),',','') + iif( vartype( &lcParam ) = 'O' or isnull(&lcParam), "'*OBJETO'", goLibrerias.ValorAString( &lcParam ) )		endfor		lnIdClase = _screen.Mocks.BuscarMock( 'COMPROBANTESECOMMERCE' )		if lnIdClase > 0			lnIdMetodo =  _screen.Mocks.BuscarMetodo( lnIdClase, 'validar_operacionespendientes', lcParametros )			if lnIdMetodo > 0				return this.ObtenerResultado( 'validar_operacionespendientes', lcParametros )			endif		endif		Return dodefault( txVal )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validaracciones() as number                                                                                                                                                                                                                      
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validaracciones', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarbasededatos( tccursor as string ) as boolean                                                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
	...
	*-----------------------------------------------------------------------------------------
	function validarclientes( tccursor as string, tccursorclientesecom as string ) as boolean                                                                                                                                                                 
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2
		...
		return this.ObtenerResultado( 'Validarclientes', lcParametros )
	EndFunc

	*-----------------------------------------------------------------------------------------
	function validarconfiguraciondeparametrosenviodemails() as void                                                                                                                                                                                           
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validarconfiguraciondeparametrosenviodemails', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validargeneraciondecomprobantes() as void                                                                                                                                                                                                        
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Validargeneraciondecomprobantes', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validarvinculacionesdearticulos( tccursor as string, tccursorpublic as string ) as boolean                                                                                                                                                       
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1, lxParam2

		lnParametros = pcount()
		lxParam1 = tccursor
		lxParam2 = tccursorpublic
		...
		return this.ObtenerResultado( 'Validarvinculacionesdearticulos', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	protected function obtenercondicionoperaciondura( tlgeneracancelacion as boolean ) as string                                                                                                                                                              
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		local lxParam1
		...
		return this.ObtenerResultado( 'Obtenercondicionoperaciondura', lcParametros )
	EndFunc
