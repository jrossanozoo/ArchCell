...
define class Din_EntidadPREPARACIONDEMERCADERIA as Ent_ComprobanteDeVentasSinValores of Ent_ComprobanteDeVentasSinValores.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function ObtenerFuncionalidades() as String
		return '<DESCUENTOAUTOMATICO><TRANSMODOSEGURODB><VENTAS><PICKING><IMPOSEGURACONCORTE><INTERVINIENTE><COMPLETADESDEVENTAS><ANULABLE><FILTROESPECIFICO>'
	Endfunc
	*--------------------------------------------------------------------------------------------------------
