...
define class Din_EntidadNOTADEDEBITOELECTRONICAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxComprobantevFecimpo, lxComprobantevFectrans, lxComprobantevFecexpo, lxComprobantevFd2, lxComprobantevFmodifw, lxComprobantevFaltafw, lxComprobantevIdcaja, lxComprobantevMr, lxComprobantevFpodes1, lxComprobantevRecpor, lxComprobantevFperson, lxComprobantevFturno, lxComprobantevNrodgirela, lxComprobantevDesmntosi3, lxComprobantevFajxre, lxComprobantevMr2, lxComprobantevDesmntosi2, lxComprobantevFactsec, lxComprobantevTotalcant, lxComprobantevMdcimpu, lxComprobantevRecmntosi1, lxComprobantevSubtotsisi, lxComprobantevSubtotcisi, lxComprobantevSignomov, lxComprobantevCondivalp, lxComprobantevFacttipo, lxComprobantevFsubtot, lxComprobantevDesmntosi1, lxComprobantevFsubton, lxComprobantevRecmntosi2, lxComprobantevDesmntosi, lxComprobantevTimestamp, lxComprobantevFpodes2, lxComprobantevRecmntosi, lxComprobantevRecmnto1, lxComprobantevRecmnto2, lxComprobantevRecmnto, lxComprobantevFcompfis, lxComprobantevNoper, lxComprobantevDesauto, lxComprobantevContinrela, lxComprobantevAnulado, lxComprobantevEsttrans, lxComprobantevBdaltafw, lxComprobantevSerierela, lxComprobantevBdmodifw, lxComprobantevDescfw, lxComprobantevHmodifw, lxComprobantevZadsfw, lxComprobantevHoraexpo, lxComprobantevHaltafw, lxComprobantevOpecomm, lxComprobantevHoraimpo, lxComprobantevSmodifw, lxComprobantevSaltafw, lxComprobantevValtafw, lxComprobantevUaltafw, lxComprobantevUmodifw, lxComprobantevVmodifw, lxComprobantevIdajuste, lxComprobantevSimbmon, lxComprobantevFhora, lxComprobantevMonsis, lxComprobantevIdvuelto, lxComprobantevMotdescdev, lxComprobantevFobs, lxComprobantevFletra, lxComprobantevFfch, lxComprobantevMd1, lxComprobantevFcliente, lxComprobantevMd2, lxComprobantevFmtdes1, lxComprobantevFmtdes2, lxComprobantevCodigo, lxComprobantevFven, lxComprobantevFptoven, lxComprobantevDeuda, lxComprobantevFmtdes3, lxComprobantevMoneda, lxComprobantevFnumcomp, lxComprobantevTotdescsi, lxComprobantevTdci, lxComprobantevSitfisccli, lxComprobantevCodlista, lxComprobantevFcuit, lxComprobantevCotiz, lxComprobantevEmail, lxComprobantevFvuelto, lxComprobantevFtotal, lxComprobantevFpodes, lxComprobantevFdescu, lxComprobantevMd3, lxComprobantevMr1, lxComprobantevPercepcion, lxComprobantevGravamen, lxComprobantevFimpuesto, lxComprobantevTotrecarsi, lxComprobantevTotrecar, lxComprobantevTrci, lxComprobantevTotdesc, lxComprobantevTotimpue, lxComprobantevIvasis, lxComprobantevTipocrela, lxComprobantevLetrarela, lxComprobantevPuntorela, lxComprobantevNumerorela, lxComprobantevFeccrela, lxComprobantevContingenc
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.COMPROBANTEV ( "Fecimpo","Fectrans","Fecexpo","Fd2","Fmodifw","Faltafw","Idcaja","Mr","Fpodes1","Recpor","Fperson","Fturno","Nrodgirela","Desmntosi3","Fajxre","Mr2","Desmntosi2","Factsec","Totalcant","Mdcimpu","Recmntosi1","Subtotsisi","Subtotcisi","Signomov","Condivalp","Facttipo","Fsubtot","Desmntosi1","Fsubton","Recmntosi2","Desmntosi","Timestamp","Fpodes2","Recmntosi","Recmnto1","Recmnto2","Recmnto","Fcompfis","Noper","Desauto","Continrela","Anulado","Esttrans","Bdaltafw","Serierela","Bdmodifw","Descfw","Hmodifw","Zadsfw","Horaexpo","Haltafw","Opecomm","Horaimpo","Smodifw","Saltafw","Valtafw","Ualtafw","Umodifw","Vmodifw","Idajuste","Simbmon","Fhora","Monsis","Idvuelto","Motdescdev","Fobs","Fletra","Ffch","Md1","Fcliente","Md2","Fmtdes1","Fmtdes2","Codigo","Fven","Fptoven","Deuda","Fmtdes3","Moneda","Fnumcomp","Totdescsi","Tdci","Sitfisccli","Codlista","Fcuit","Cotiz","Email","Fvuelto","Ftotal","Fpodes","Fdescu","Md3","Mr1","Percepcion","Gravamen","Fimpuesto","Totrecarsi","Totrecar","Trci","Totdesc","Totimpue","Ivasis","Tipocrela","Letrarela","Puntorela","Numerorela","Feccrela","Contingenc" ) values ( <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'" >>, <<lxComprobantevIdcaja >>, <<lxComprobantevMr >>, <<lxComprobantevFpodes1 >>, <<lxComprobantevRecpor >>, <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'" >>, <<lxComprobantevFturno >>, <<lxComprobantevNrodgirela >>, <<lxComprobantevDesmntosi3 >>, <<lxComprobantevFajxre >>, <<lxComprobantevMr2 >>, <<lxComprobantevDesmntosi2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'" >>, <<lxComprobantevTotalcant >>, <<lxComprobantevMdcimpu >>, <<lxComprobantevRecmntosi1 >>, <<lxComprobantevSubtotsisi >>, <<lxComprobantevSubtotcisi >>, <<lxComprobantevSignomov >>, <<lxComprobantevCondivalp >>, <<lxComprobantevFacttipo >>, <<lxComprobantevFsubtot >>, <<lxComprobantevDesmntosi1 >>, <<lxComprobantevFsubton >>, <<lxComprobantevRecmntosi2 >>, <<lxComprobantevDesmntosi >>, <<lxComprobantevTimestamp >>, <<lxComprobantevFpodes2 >>, <<lxComprobantevRecmntosi >>, <<lxComprobantevRecmnto1 >>, <<lxComprobantevRecmnto2 >>, <<lxComprobantevRecmnto >>, <<iif( lxComprobantevFcompfis, 1, 0 ) >>, <<iif( lxComprobantevNoper, 1, 0 ) >>, <<iif( lxComprobantevDesauto, 1, 0 ) >>, <<iif( lxComprobantevContinrela, 1, 0 ) >>, <<iif( lxComprobantevAnulado, 1, 0 ) >>, <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSerierela ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'" >>, <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'" >>, <<lxComprobantevMd1 >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'" >>, <<lxComprobantevMd2 >>, <<lxComprobantevFmtdes1 >>, <<lxComprobantevFmtdes2 >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'" >>, <<lxComprobantevFptoven >>, <<lxComprobantevDeuda >>, <<lxComprobantevFmtdes3 >>, <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'" >>, <<lxComprobantevFnumcomp >>, <<lxComprobantevTotdescsi >>, <<lxComprobantevTdci >>, <<lxComprobantevSitfisccli >>, <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'" >>, <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'" >>, <<lxComprobantevCotiz >>, <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'" >>, <<lxComprobantevFvuelto >>, <<lxComprobantevFtotal >>, <<lxComprobantevFpodes >>, <<lxComprobantevFdescu >>, <<lxComprobantevMd3 >>, <<lxComprobantevMr1 >>, <<lxComprobantevPercepcion >>, <<lxComprobantevGravamen >>, <<lxComprobantevFimpuesto >>, <<lxComprobantevTotrecarsi >>, <<lxComprobantevTotrecar >>, <<lxComprobantevTrci >>, <<lxComprobantevTotdesc >>, <<lxComprobantevTotimpue >>, <<lxComprobantevIvasis >>, <<lxComprobantevTipocrela >>, <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'" >>, <<lxComprobantevPuntorela >>, <<lxComprobantevNumerorela >>, <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'" >>, <<iif( lxComprobantevContingenc, 1, 0 ) >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.COMPROBANTEV set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxComprobantevFectrans ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxComprobantevFecexpo ) + "'">>,"Fd2" = <<"'" + this.ConvertirDateSql( lxComprobantevFd2 ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxComprobantevFmodifw ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxComprobantevFaltafw ) + "'">>,"Idcaja" = <<lxComprobantevIdcaja>>,"Mr" = <<lxComprobantevMr>>,"Fpodes1" = <<lxComprobantevFpodes1>>,"Recpor" = <<lxComprobantevRecpor>>,"Fperson" = <<"'" + this.FormatearTextoSql( lxComprobantevFperson ) + "'">>,"Fturno" = <<lxComprobantevFturno>>,"Nrodgirela" = <<lxComprobantevNrodgirela>>,"Desmntosi3" = <<lxComprobantevDesmntosi3>>,"Fajxre" = <<lxComprobantevFajxre>>,"Mr2" = <<lxComprobantevMr2>>,"Desmntosi2" = <<lxComprobantevDesmntosi2>>,"Factsec" = <<"'" + this.FormatearTextoSql( lxComprobantevFactsec ) + "'">>,"Totalcant" = <<lxComprobantevTotalcant>>,"Mdcimpu" = <<lxComprobantevMdcimpu>>,"Recmntosi1" = <<lxComprobantevRecmntosi1>>,"Subtotsisi" = <<lxComprobantevSubtotsisi>>,"Subtotcisi" = <<lxComprobantevSubtotcisi>>,"Signomov" = <<lxComprobantevSignomov>>,"Condivalp" = <<lxComprobantevCondivalp>>,"Facttipo" = <<lxComprobantevFacttipo>>,"Fsubtot" = <<lxComprobantevFsubtot>>,"Desmntosi1" = <<lxComprobantevDesmntosi1>>,"Fsubton" = <<lxComprobantevFsubton>>,"Recmntosi2" = <<lxComprobantevRecmntosi2>>,"Desmntosi" = <<lxComprobantevDesmntosi>>,"Timestamp" = <<lxComprobantevTimestamp>>,"Fpodes2" = <<lxComprobantevFpodes2>>,"Recmntosi" = <<lxComprobantevRecmntosi>>,"Recmnto1" = <<lxComprobantevRecmnto1>>,"Recmnto2" = <<lxComprobantevRecmnto2>>,"Recmnto" = <<lxComprobantevRecmnto>>,"Fcompfis" = <<iif( lxComprobantevFcompfis, 1, 0 )>>,"Noper" = <<iif( lxComprobantevNoper, 1, 0 )>>,"Desauto" = <<iif( lxComprobantevDesauto, 1, 0 )>>,"Continrela" = <<iif( lxComprobantevContinrela, 1, 0 )>>,"Anulado" = <<iif( lxComprobantevAnulado, 1, 0 )>>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxComprobantevEsttrans ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdaltafw ) + "'">>,"Serierela" = <<"'" + this.FormatearTextoSql( lxComprobantevSerierela ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevBdmodifw ) + "'">>,"Descfw" = <<"'" + this.FormatearTextoSql( lxComprobantevDescfw ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevHmodifw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxComprobantevZadsfw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraexpo ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevHaltafw ) + "'">>,"Opecomm" = <<"'" + this.FormatearTextoSql( lxComprobantevOpecomm ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxComprobantevHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxComprobantevSaltafw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevValtafw ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxComprobantevUaltafw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevUmodifw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxComprobantevVmodifw ) + "'">>,"Idajuste" = <<"'" + this.FormatearTextoSql( lxComprobantevIdajuste ) + "'">>,"Simbmon" = <<"'" + this.FormatearTextoSql( lxComprobantevSimbmon ) + "'">>,"Fhora" = <<"'" + this.FormatearTextoSql( lxComprobantevFhora ) + "'">>,"Monsis" = <<"'" + this.FormatearTextoSql( lxComprobantevMonsis ) + "'">>,"Idvuelto" = <<"'" + this.FormatearTextoSql( lxComprobantevIdvuelto ) + "'">>,"Motdescdev" = <<"'" + this.FormatearTextoSql( lxComprobantevMotdescdev ) + "'">>,"Fobs" = <<"'" + this.FormatearTextoSql( lxComprobantevFobs ) + "'">>,"Fletra" = <<"'" + this.FormatearTextoSql( lxComprobantevFletra ) + "'">>,"Ffch" = <<"'" + this.ConvertirDateSql( lxComprobantevFfch ) + "'">>,"Md1" = <<lxComprobantevMd1>>,"Fcliente" = <<"'" + this.FormatearTextoSql( lxComprobantevFcliente ) + "'">>,"Md2" = <<lxComprobantevMd2>>,"Fmtdes1" = <<lxComprobantevFmtdes1>>,"Fmtdes2" = <<lxComprobantevFmtdes2>>,"Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">>,"Fven" = <<"'" + this.FormatearTextoSql( lxComprobantevFven ) + "'">>,"Fptoven" = <<lxComprobantevFptoven>>,"Deuda" = <<lxComprobantevDeuda>>,"Fmtdes3" = <<lxComprobantevFmtdes3>>,"Moneda" = <<"'" + this.FormatearTextoSql( lxComprobantevMoneda ) + "'">>,"Fnumcomp" = <<lxComprobantevFnumcomp>>,"Totdescsi" = <<lxComprobantevTotdescsi>>,"Tdci" = <<lxComprobantevTdci>>,"Sitfisccli" = <<lxComprobantevSitfisccli>>,"Codlista" = <<"'" + this.FormatearTextoSql( lxComprobantevCodlista ) + "'">>,"Fcuit" = <<"'" + this.FormatearTextoSql( lxComprobantevFcuit ) + "'">>,"Cotiz" = <<lxComprobantevCotiz>>,"Email" = <<"'" + this.FormatearTextoSql( lxComprobantevEmail ) + "'">>,"Fvuelto" = <<lxComprobantevFvuelto>>,"Ftotal" = <<lxComprobantevFtotal>>,"Fpodes" = <<lxComprobantevFpodes>>,"Fdescu" = <<lxComprobantevFdescu>>,"Md3" = <<lxComprobantevMd3>>,"Mr1" = <<lxComprobantevMr1>>,"Percepcion" = <<lxComprobantevPercepcion>>,"Gravamen" = <<lxComprobantevGravamen>>,"Fimpuesto" = <<lxComprobantevFimpuesto>>,"Totrecarsi" = <<lxComprobantevTotrecarsi>>,"Totrecar" = <<lxComprobantevTotrecar>>,"Trci" = <<lxComprobantevTrci>>,"Totdesc" = <<lxComprobantevTotdesc>>,"Totimpue" = <<lxComprobantevTotimpue>>,"Ivasis" = <<lxComprobantevIvasis>>,"Tipocrela" = <<lxComprobantevTipocrela>>,"Letrarela" = <<"'" + this.FormatearTextoSql( lxComprobantevLetrarela ) + "'">>,"Puntorela" = <<lxComprobantevPuntorela>>,"Numerorela" = <<lxComprobantevNumerorela>>,"Feccrela" = <<"'" + this.ConvertirDateSql( lxComprobantevFeccrela ) + "'">>,"Contingenc" = <<iif( lxComprobantevContingenc, 1, 0 )>> where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 29 OR COMPROBANTEV.FACTTIPO = 56) << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Idcaja" as "Caja", "Mr" as "Recargomonto", "Fpodes1" as "Porcentajedescuento1", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Nrodgirela" as "Numerodgicpterelacionado", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fajxre" as "Ajustesporredondeos", "Mr2" as "Recargomonto2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Timestamp" as "Timestamp", "Fpodes2" as "Porcentajedescuento2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto" as "Recargomontoconimpuestos", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Desauto" as "Descuentoautomatico", "Continrela" as "Contingenciacpterelacionado", "Anulado" as "Anulado", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Serierela" as "Seriedgicpterelacionado", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Idajuste" as "Codigoajuste", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Monsis" as "Monedasistema", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fletra" as "Letra", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fven" as "Vendedor", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Sitfisccli" as "Situacionfiscal", "Codlista" as "Listadeprecios", "Fcuit" as "Cuit", "Cotiz" as "Cotizacion", "Email" as "Email", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Contingenc" as "Contingencia" from ZooLogic.COMPROBANTEV where "Codigo" = <<"'" + this.FormatearTextoSql( lxComprobantevCodigo ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 29 OR COMPROBANTEV.FACTTIPO = 56)
			endtext
			...
			text to lcSentencia textmerge noshow
				select "Montobase" as "Montobase", "Minimoper" as "Minimo", "Porcen" as "Porcentaje", "Sirecert" as "Certificadosire", "Minoimp" as "Minimonoimponible", "Monto" as "Monto", "Nroitem" as "Nroitem", "Sirecs" as "Codseguridadsire", "Base" as "Basedecalculo", "Regimenimp" as "Regimenimpositivo", "Tipoi" as "Tipoimpuesto", "Codint" as "Codigointerno", "Codimp" as "Codigoimpuesto", "Descri" as "Descripcion", "Jurid" as "Jurisdiccion", "Ccod" as "Codigo", "Artpercep" as "Rg5329porcentaje", "Artperce" as "Rg5329aplicaporarticulo" from ZooLogic.impVentas where cCod = <<"'" + this.FormatearTextoSql( c_NOTADEDEBITOELECTRONICA.CODIGO ) + "'">> Order by NroItem
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Idcaja" as "Caja", "Mr" as "Recargomonto", "Fpodes1" as "Porcentajedescuento1", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Nrodgirela" as "Numerodgicpterelacionado", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fajxre" as "Ajustesporredondeos", "Mr2" as "Recargomonto2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Timestamp" as "Timestamp", "Fpodes2" as "Porcentajedescuento2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto" as "Recargomontoconimpuestos", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Desauto" as "Descuentoautomatico", "Continrela" as "Contingenciacpterelacionado", "Anulado" as "Anulado", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Serierela" as "Seriedgicpterelacionado", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Idajuste" as "Codigoajuste", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Monsis" as "Monedasistema", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fletra" as "Letra", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fven" as "Vendedor", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Sitfisccli" as "Situacionfiscal", "Codlista" as "Listadeprecios", "Fcuit" as "Cuit", "Cotiz" as "Cotizacion", "Email" as "Email", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Contingenc" as "Contingencia" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 29 OR COMPROBANTEV.FACTTIPO = 56) order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_NOTADEDEBITOELECTRONICA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Idcaja" as "Caja", "Mr" as "Recargomonto", "Fpodes1" as "Porcentajedescuento1", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Nrodgirela" as "Numerodgicpterelacionado", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fajxre" as "Ajustesporredondeos", "Mr2" as "Recargomonto2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Timestamp" as "Timestamp", "Fpodes2" as "Porcentajedescuento2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto" as "Recargomontoconimpuestos", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Desauto" as "Descuentoautomatico", "Continrela" as "Contingenciacpterelacionado", "Anulado" as "Anulado", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Serierela" as "Seriedgicpterelacionado", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Idajuste" as "Codigoajuste", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Monsis" as "Monedasistema", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fletra" as "Letra", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fven" as "Vendedor", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Sitfisccli" as "Situacionfiscal", "Codlista" as "Listadeprecios", "Fcuit" as "Cuit", "Cotiz" as "Cotizacion", "Email" as "Email", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Contingenc" as "Contingencia" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 29 OR COMPROBANTEV.FACTTIPO = 56) order by FACTTIPO,FLETRA,FPTOVEN,FNUMCOMP,FACTSEC
			endtext
			use in select('c_NOTADEDEBITOELECTRONICA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Idcaja" as "Caja", "Mr" as "Recargomonto", "Fpodes1" as "Porcentajedescuento1", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Nrodgirela" as "Numerodgicpterelacionado", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fajxre" as "Ajustesporredondeos", "Mr2" as "Recargomonto2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Timestamp" as "Timestamp", "Fpodes2" as "Porcentajedescuento2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto" as "Recargomontoconimpuestos", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Desauto" as "Descuentoautomatico", "Continrela" as "Contingenciacpterelacionado", "Anulado" as "Anulado", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Serierela" as "Seriedgicpterelacionado", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Idajuste" as "Codigoajuste", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Monsis" as "Monedasistema", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fletra" as "Letra", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fven" as "Vendedor", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Sitfisccli" as "Situacionfiscal", "Codlista" as "Listadeprecios", "Fcuit" as "Cuit", "Cotiz" as "Cotizacion", "Email" as "Email", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Contingenc" as "Contingencia" from ZooLogic.COMPROBANTEV where  str( FACTTIPO, 2, 0) + funciones.padr( FLETRA, 1, ' ' ) + str( FPTOVEN, 4, 0) + str( FNUMCOMP, 8, 0) + funciones.padr( FACTSEC, 2, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 29 OR COMPROBANTEV.FACTTIPO = 56) order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_NOTADEDEBITOELECTRONICA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Ultimo() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fecexpo" as "Fechaexpo", "Fd2" as "Fechamodificacion", "Fmodifw" as "Fechamodificacionfw", "Faltafw" as "Fechaaltafw", "Idcaja" as "Caja", "Mr" as "Recargomonto", "Fpodes1" as "Porcentajedescuento1", "Recpor" as "Recargoporcentaje", "Fperson" as "Cliente", "Fturno" as "Turno", "Nrodgirela" as "Numerodgicpterelacionado", "Desmntosi3" as "Montodescuentosinimpuestos3", "Fajxre" as "Ajustesporredondeos", "Mr2" as "Recargomonto2", "Desmntosi2" as "Montodescuentosinimpuestos2", "Factsec" as "Secuencia", "Totalcant" as "Totalcantidad", "Mdcimpu" as "Montodescuentoconimpuestos", "Recmntosi1" as "Recargomontosinimpuestos1", "Subtotsisi" as "Subtotalsinimpuestossobreitems", "Subtotcisi" as "Subtotalconimpuestossobreitems", "Signomov" as "Signodemovimiento", "Condivalp" as "Condicioniva", "Facttipo" as "Tipocomprobante", "Fsubtot" as "Subtotalbruto", "Desmntosi1" as "Montodescuentosinimpuestos1", "Fsubton" as "Subtotalneto", "Recmntosi2" as "Recargomontosinimpuestos2", "Desmntosi" as "Montodescuentosinimpuestos", "Timestamp" as "Timestamp", "Fpodes2" as "Porcentajedescuento2", "Recmntosi" as "Recargomontosinimpuestos", "Recmnto1" as "Recargomontoconimpuestos1", "Recmnto2" as "Recargomontoconimpuestos2", "Recmnto" as "Recargomontoconimpuestos", "Fcompfis" as "Comprobantefiscal", "Noper" as "Nocalculapercepcion", "Desauto" as "Descuentoautomatico", "Continrela" as "Contingenciacpterelacionado", "Anulado" as "Anulado", "Esttrans" as "Estadotransferencia", "Bdaltafw" as "Basededatosaltafw", "Serierela" as "Seriedgicpterelacionado", "Bdmodifw" as "Basededatosmodificacionfw", "Descfw" as "Descripcionfw", "Hmodifw" as "Horamodificacionfw", "Zadsfw" as "Zadsfw", "Horaexpo" as "Horaexpo", "Haltafw" as "Horaaltafw", "Opecomm" as "Nroopecommerce", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Valtafw" as "Versionaltafw", "Ualtafw" as "Usuarioaltafw", "Umodifw" as "Usuariomodificacionfw", "Vmodifw" as "Versionmodificacionfw", "Idajuste" as "Codigoajuste", "Simbmon" as "Simbolomonetariocomprobante", "Fhora" as "Hora", "Monsis" as "Monedasistema", "Idvuelto" as "Idvuelto", "Motdescdev" as "Codigomotivodescuentoensubtotal", "Fobs" as "Obs", "Fletra" as "Letra", "Ffch" as "Fecha", "Md1" as "Montodescuento1", "Fcliente" as "Clientedescripcion", "Md2" as "Montodescuento2", "Fmtdes1" as "Montodescuentoconimpuestos1", "Fmtdes2" as "Montodescuentoconimpuestos2", "Codigo" as "Codigo", "Fven" as "Vendedor", "Fptoven" as "Puntodeventa", "Deuda" as "Deuda", "Fmtdes3" as "Montodescuentoconimpuestos3", "Moneda" as "Monedacomprobante", "Fnumcomp" as "Numero", "Totdescsi" as "Totaldescuentossinimpuestos", "Tdci" as "Totaldescuentosconimpuestos", "Sitfisccli" as "Situacionfiscal", "Codlista" as "Listadeprecios", "Fcuit" as "Cuit", "Cotiz" as "Cotizacion", "Email" as "Email", "Fvuelto" as "Vuelto", "Ftotal" as "Total", "Fpodes" as "Porcentajedescuento", "Fdescu" as "Descuento", "Md3" as "Montodescuento3", "Mr1" as "Recargomonto1", "Percepcion" as "Percepciones", "Gravamen" as "Gravamenes", "Fimpuesto" as "Impuestos", "Totrecarsi" as "Totalrecargossinimpuestos", "Totrecar" as "Totalrecargos", "Trci" as "Totalrecargosconimpuestos", "Totdesc" as "Totaldescuentos", "Totimpue" as "Totalimpuestos", "Ivasis" as "Ivadelsistema", "Tipocrela" as "Tipocpterelacionado", "Letrarela" as "Letracpterelacionado", "Puntorela" as "Puntodeventacpterelacionado", "Numerorela" as "Numerocpterelacionado", "Feccrela" as "Fechacpterelacionado", "Contingenc" as "Contingencia" from ZooLogic.COMPROBANTEV where  COMPROBANTEV.CODIGO != '' AND (COMPROBANTEV.FACTTIPO = 29 OR COMPROBANTEV.FACTTIPO = 56) order by FACTTIPO desc,FLETRA desc,FPTOVEN desc,FNUMCOMP desc,FACTSEC desc
			endtext
			use in select('c_NOTADEDEBITOELECTRONICA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_NOTADEDEBITOELECTRONICA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			local lcXml as string
			lcXml = this.oConexion.EjecutarSql( "select Fecimpo,Fectrans,Fecexpo,Fd2,Fmodifw,Faltafw,Idcaja,Mr,Fpodes1,Recpor,Fperson,Fturno,Nrodgir" + ;
"ela,Desmntosi3,Fajxre,Mr2,Desmntosi2,Factsec,Totalcant,Mdcimpu,Recmntosi1,Subtotsisi,Subtotcisi,Sign" + ;
"omov,Condivalp,Facttipo,Fsubtot,Desmntosi1,Fsubton,Recmntosi2,Desmntosi,Timestamp,Fpodes2,Recmntosi," + ;
"Recmnto1,Recmnto2,Recmnto,Fcompfis,Noper,Desauto,Continrela,Anulado,Esttrans,Bdaltafw,Serierela,Bdmo" + ;
"difw,Descfw,Hmodifw,Zadsfw,Horaexpo,Haltafw,Opecomm,Horaimpo,Smodifw,Saltafw,Valtafw,Ualtafw,Umodifw" + ;
",Vmodifw,Idajuste,Simbmon,Fhora,Monsis,Idvuelto,Motdescdev,Fobs,Fletra,Ffch,Md1,Fcliente,Md2,Fmtdes1" + ;
",Fmtdes2,Codigo,Fven,Fptoven,Deuda,Fmtdes3,Moneda,Fnumcomp,Totdescsi,Tdci,Sitfisccli,Codlista,Fcuit," + ;
"Cotiz,Email,Fvuelto,Ftotal,Fpodes,Fdescu,Md3,Mr1,Percepcion,Gravamen,Fimpuesto,Totrecarsi,Totrecar,T" + ;
"rci,Totdesc,Totimpue,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela,Contingenc" + ;
			...
			if reccount( 'curSeek' ) > 0
					...
					if This.ActualizaEnRecepcion() 
						if this.oEntidad.cContexto == 'C'
							if curSeek.ANULADO
								...
								this.oConexion.EjecutarSql( [UPDATE ZooLogic.COMPROBANTEV set  FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FD2 = ] + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, IdCaja = ] + transform( &lcCursor..IdCaja )+ [, MR = ] + transform( &lcCursor..MR )+ [, FPODES1 = ] + transform( &lcCursor..FPODES1 )+ [, RecPor = ] + transform( &lcCursor..RecPor )+ [, FPerson = ] + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'"+ [, FTurno = ] + transform( &lcCursor..FTurno )+ [, NroDGIRela = ] + transform( &lcCursor..NroDGIRela )+ [, DesMntoSI3 = ] + transform( &lcCursor..DesMntoSI3 )+ [, FAjXRe = ] + transform( &lcCursor..FAjXRe )+ [, MR2 = ] + transform( &lcCursor..MR2 )+ [, DesMntoSI2 = ] + transform( &lcCursor..DesMntoSI2 )+ [, FACTSEC = ] + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'"+ [, TotalCant = ] + transform( &lcCursor..TotalCant )+ [, MDCIMPU = ] + transform( &lcCursor..MDCIMPU )+ [, RecMntoSI1 = ] + transform( &lcCursor..RecMntoSI1 )+ [, SubTotSISI = ] + transform( &lcCursor..SubTotSISI )+ [, SubTotCISI = ] + transform( &lcCursor..SubTotCISI )+ [, signomov = ] + transform( &lcCursor..signomov )+ [, CondivaLp = ] + transform( &lcCursor..CondivaLp )+ [, FACTTIPO = ] + transform( &lcCursor..FACTTIPO )+ [, FSubTOT = ] + transform( &lcCursor..FSubTOT )+ [, DesMntoSI1 = ] + transform( &lcCursor..DesMntoSI1 )+ [, fSubToN = ] + transform( &lcCursor..fSubToN )+ [, RecMntoSI2 = ] + transform( &lcCursor..RecMntoSI2 )+ [, DesMntoSI = ] + transform( &lcCursor..DesMntoSI )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, FPODES2 = ] + transform( &lcCursor..FPODES2 )+ [, RecMntoSI = ] + transform( &lcCursor..RecMntoSI )+ [, RecMnto1 = ] + transform( &lcCursor..RecMnto1 )+ [, RecMnto2 = ] + transform( &lcCursor..RecMnto2 )+ [, RecMnto = ] + transform( &lcCursor..RecMnto )+ [, FCOMPFIS = ] + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 ))+ [, noper = ] + Transform( iif( &lcCursor..noper, 1, 0 ))+ [, DesAuto = ] + Transform( iif( &lcCursor..DesAuto, 1, 0 ))+ [, ContinRela = ] + Transform( iif( &lcCursor..ContinRela, 1, 0 ))+ [, Anulado = ] + Transform( iif( &lcCursor..Anulado, 1, 0 ))+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, SerieRela = ] + "'" + this.FormatearTextoSql( &lcCursor..SerieRela ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, DescFW = ] + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, OPEcomm = ] + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, idAjuste = ] + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'"+ [, SimbMon = ] + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'"+ [, FHORA = ] + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'"+ [, MonSis = ] + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'"+ [, idVuelto = ] + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'"+ [, MotDescDev = ] + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'"+ [, FObs = ] + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"+ [, FLETRA = ] + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'"+ [, FFCH = ] + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'"+ [, MD1 = ] + transform( &lcCursor..MD1 )+ [, FCLIENTE = ] + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'"+ [, MD2 = ] + transform( &lcCursor..MD2 )+ [, FMTDES1 = ] + transform( &lcCursor..FMTDES1 )+ [, FMTDES2 = ] + transform( &lcCursor..FMTDES2 )+ [, CODIGO = ] + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"+ [, FVEN = ] + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'"+ [, FPTOVEN = ] + transform( &lcCursor..FPTOVEN )+ [, Deuda = ] + transform( &lcCursor..Deuda )+ [, FMTDES3 = ] + transform( &lcCursor..FMTDES3 )+ [, Moneda = ] + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'"+ [, FNUMCOMP = ] + transform( &lcCursor..FNUMCOMP )+ [, totdescSI = ] + transform( &lcCursor..totdescSI )+ [, TDCI = ] + transform( &lcCursor..TDCI )+ [, SitFiscCli = ] + transform( &lcCursor..SitFiscCli )+ [, CodLista = ] + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'"+ [, fCuit = ] + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'"+ [, Cotiz = ] + transform( &lcCursor..Cotiz )+ [, Email = ] + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'"+ [, FVuelto = ] + transform( &lcCursor..FVuelto )+ [, FTotal = ] + transform( &lcCursor..FTotal )+ [, FPODES = ] + transform( &lcCursor..FPODES )+ [, fDescu = ] + transform( &lcCursor..fDescu )+ [, MD3 = ] + transform( &lcCursor..MD3 )+ [, MR1 = ] + transform( &lcCursor..MR1 )+ [, percepcion = ] + transform( &lcCursor..percepcion )+ [, gravamen = ] + transform( &lcCursor..gravamen )+ [, fImpuesto = ] + transform( &lcCursor..fImpuesto )+ [, totrecarSI = ] + transform( &lcCursor..totrecarSI )+ [, totrecar = ] + transform( &lcCursor..totrecar )+ [, TRCI = ] + transform( &lcCursor..TRCI )+ [, totdesc = ] + transform( &lcCursor..totdesc )+ [, totimpue = ] + transform( &lcCursor..totimpue )+ [, IvaSis = ] + transform( &lcCursor..IvaSis )+ [, TipoCRela = ] + transform( &lcCursor..TipoCRela )+ [, letraRela = ] + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'"+ [, puntoRela = ] + transform( &lcCursor..puntoRela )+ [, numeroRela = ] + transform( &lcCursor..numeroRela )+ [, FecCRela = ] + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'"+ [, Contingenc = ] + Transform( iif( &lcCursor..Contingenc, 1, 0 )) + [ Where CODIGO = ] + "'" + this.FormatearTextoSql( lcValorABuscar ) + "'" )
				...
				Else
					...
					Text to lcCampos noShow
						 FECIMPO, FECTRANS, FECEXPO, FD2, FMODIFW, FALTAFW, IdCaja, MR, FPODES1, RecPor, FPerson, FTurno, NroDGIRela, DesMntoSI3, FAjXRe, MR2, DesMntoSI2, FACTSEC, TotalCant, MDCIMPU, RecMntoSI1, SubTotSISI, SubTotCISI, signomov, CondivaLp, FACTTIPO, FSubTOT, DesMntoSI1, fSubToN, RecMntoSI2, DesMntoSI, TIMESTAMP, FPODES2, RecMntoSI, RecMnto1, RecMnto2, RecMnto, FCOMPFIS, noper, DesAuto, ContinRela, Anulado, ESTTRANS, BDALTAFW, SerieRela, BDMODIFW, DescFW, HMODIFW, ZADSFW, HORAEXPO, HALTAFW, OPEcomm, HORAIMPO, SMODIFW, SALTAFW, VALTAFW, UALTAFW, UMODIFW, VMODIFW, idAjuste, SimbMon, FHORA, MonSis, idVuelto, MotDescDev, FObs, FLETRA, FFCH, MD1, FCLIENTE, MD2, FMTDES1, FMTDES2, CODIGO, FVEN, FPTOVEN, Deuda, FMTDES3, Moneda, FNUMCOMP, totdescSI, TDCI, SitFiscCli, CodLista, fCuit, Cotiz, Email, FVuelto, FTotal, FPODES, fDescu, MD3, MR1, percepcion, gravamen, fImpuesto, totrecarSI, totrecar, TRCI, totdesc, totimpue, IvaSis, TipoCRela, letraRela, puntoRela, numeroRela, FecCRela, Contingenc
					EndText
					local lcValoresCampos as string
lcValoresCampos = ''
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FD2 ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FALTAFW ) + "'" + ',' + transform( &lcCursor..IdCaja )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MR ) + ',' + transform( &lcCursor..FPODES1 ) + ',' + transform( &lcCursor..RecPor ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FPerson ) + "'" + ',' + transform( &lcCursor..FTurno ) + ',' + transform( &lcCursor..NroDGIRela ) + ',' + transform( &lcCursor..DesMntoSI3 ) + ',' + transform( &lcCursor..FAjXRe ) + ',' + transform( &lcCursor..MR2 ) + ',' + transform( &lcCursor..DesMntoSI2 )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FACTSEC ) + "'" + ',' + transform( &lcCursor..TotalCant ) + ',' + transform( &lcCursor..MDCIMPU ) + ',' + transform( &lcCursor..RecMntoSI1 ) + ',' + transform( &lcCursor..SubTotSISI ) + ',' + transform( &lcCursor..SubTotCISI ) + ',' + transform( &lcCursor..signomov ) + ',' + transform( &lcCursor..CondivaLp ) + ',' + transform( &lcCursor..FACTTIPO ) + ',' + transform( &lcCursor..FSubTOT )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..DesMntoSI1 ) + ',' + transform( &lcCursor..fSubToN ) + ',' + transform( &lcCursor..RecMntoSI2 ) + ',' + transform( &lcCursor..DesMntoSI ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + transform( &lcCursor..FPODES2 ) + ',' + transform( &lcCursor..RecMntoSI ) + ',' + transform( &lcCursor..RecMnto1 ) + ',' + transform( &lcCursor..RecMnto2 ) + ',' + transform( &lcCursor..RecMnto )
lcValoresCampos = lcValoresCampos  + ',' + Transform( iif( &lcCursor..FCOMPFIS, 1, 0 )) + ',' + Transform( iif( &lcCursor..noper, 1, 0 )) + ',' + Transform( iif( &lcCursor..DesAuto, 1, 0 )) + ',' + Transform( iif( &lcCursor..ContinRela, 1, 0 )) + ',' + Transform( iif( &lcCursor..Anulado, 1, 0 )) + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SerieRela ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..DescFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..OPEcomm ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..idAjuste ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SimbMon ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FHORA ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MonSis ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..idVuelto ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..MotDescDev ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..FObs ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FLETRA ) + "'" + ',' + "'" + this.ConvertirDateSql( &lcCursor..FFCH ) + "'" + ',' + transform( &lcCursor..MD1 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..FCLIENTE ) + "'" + ',' + transform( &lcCursor..MD2 ) + ',' + transform( &lcCursor..FMTDES1 ) + ',' + transform( &lcCursor..FMTDES2 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..CODIGO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..FVEN ) + "'" + ',' + transform( &lcCursor..FPTOVEN ) + ',' + transform( &lcCursor..Deuda ) + ',' + transform( &lcCursor..FMTDES3 ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Moneda ) + "'" + ',' + transform( &lcCursor..FNUMCOMP ) + ',' + transform( &lcCursor..totdescSI ) + ',' + transform( &lcCursor..TDCI ) + ',' + transform( &lcCursor..SitFiscCli )
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..CodLista ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..fCuit ) + "'" + ',' + transform( &lcCursor..Cotiz ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..Email ) + "'" + ',' + transform( &lcCursor..FVuelto ) + ',' + transform( &lcCursor..FTotal ) + ',' + transform( &lcCursor..FPODES ) + ',' + transform( &lcCursor..fDescu ) + ',' + transform( &lcCursor..MD3 )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..MR1 ) + ',' + transform( &lcCursor..percepcion ) + ',' + transform( &lcCursor..gravamen ) + ',' + transform( &lcCursor..fImpuesto ) + ',' + transform( &lcCursor..totrecarSI ) + ',' + transform( &lcCursor..totrecar ) + ',' + transform( &lcCursor..TRCI ) + ',' + transform( &lcCursor..totdesc ) + ',' + transform( &lcCursor..totimpue ) + ',' + transform( &lcCursor..IvaSis )
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TipoCRela ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..letraRela ) + "'" + ',' + transform( &lcCursor..puntoRela ) + ',' + transform( &lcCursor..numeroRela ) + ',' + "'" + this.ConvertirDateSql( &lcCursor..FecCRela ) + "'" + ',' + Transform( iif( &lcCursor..Contingenc, 1, 0 ))
	...
	Function EsAliasDeProceso( tcAlias As String, tcPrefijo as string ) As Boolean
		...
		Do Case
			...
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICA_ZADSFW'
				llRetorno = .T.
			Case  lcAlias == lcPrefijo + 'NOTADEDEBITOELECTRONICA_FOBS'
				llRetorno = .T.
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FD2 = isnull( d.FD2, t.FD2 ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.IDCAJA = isnull( d.IDCAJA, t.IDCAJA ),t.MR = isnull( d.MR, t.MR ),t.FPODES1 = isnull( d.FPODES1, t.FPODES1 ),t.RECPOR = isnull( d.RECPOR, t.RECPOR ),t.FPERSON = isnull( d.FPERSON, t.FPERSON ),t.FTURNO = isnull( d.FTURNO, t.FTURNO ),t.NRODGIRELA = isnull( d.NRODGIRELA, t.NRODGIRELA ),t.DESMNTOSI3 = isnull( d.DESMNTOSI3, t.DESMNTOSI3 ),t.FAJXRE = isnull( d.FAJXRE, t.FAJXRE ),t.MR2 = isnull( d.MR2, t.MR2 ),t.DESMNTOSI2 = isnull( d.DESMNTOSI2, t.DESMNTOSI2 ),t.FACTSEC = isnull( d.FACTSEC, t.FACTSEC ),t.TOTALCANT = isnull( d.TOTALCANT, t.TOTALCANT ),t.MDCIMPU = isnull( d.MDCIMPU, t.MDCIMPU ),t.RECMNTOSI1 = isnull( d.RECMNTOSI1, t.RECMNTOSI1 ),t.SUBTOTSISI = isnull( d.SUBTOTSISI, t.SUBTOTSISI ),t.SUBTOTCISI = isnull( d.SUBTOTCISI, t.SUBTOTCISI ),t.SIGNOMOV = isnull( d.SIGNOMOV, t.SIGNOMOV ),t.CONDIVALP = isnull( d.CONDIVALP, t.CONDIVALP ),t.FACTTIPO = isnull( d.FACTTIPO, t.FACTTIPO ),t.FSUBTOT = isnull( d.FSUBTOT, t.FSUBTOT ),t.DESMNTOSI1 = isnull( d.DESMNTOSI1, t.DESMNTOSI1 ),t.FSUBTON = isnull( d.FSUBTON, t.FSUBTON ),t.RECMNTOSI2 = isnull( d.RECMNTOSI2, t.RECMNTOSI2 ),t.DESMNTOSI = isnull( d.DESMNTOSI, t.DESMNTOSI ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.FPODES2 = isnull( d.FPODES2, t.FPODES2 ),t.RECMNTOSI = isnull( d.RECMNTOSI, t.RECMNTOSI ),t.RECMNTO1 = isnull( d.RECMNTO1, t.RECMNTO1 ),t.RECMNTO2 = isnull( d.RECMNTO2, t.RECMNTO2 ),t.RECMNTO = isnull( d.RECMNTO, t.RECMNTO ),t.FCOMPFIS = isnull( d.FCOMPFIS, t.FCOMPFIS ),t.NOPER = isnull( d.NOPER, t.NOPER ),t.DESAUTO = isnull( d.DESAUTO, t.DESAUTO ),t.CONTINRELA = isnull( d.CONTINRELA, t.CONTINRELA ),t.ANULADO = isnull( d.ANULADO, t.ANULADO ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.SERIERELA = isnull( d.SERIERELA, t.SERIERELA ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.DESCFW = isnull( d.DESCFW, t.DESCFW ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.OPECOMM = isnull( d.OPECOMM, t.OPECOMM ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.IDAJUSTE = isnull( d.IDAJUSTE, t.IDAJUSTE ),t.SIMBMON = isnull( d.SIMBMON, t.SIMBMON ),t.FHORA = isnull( d.FHORA, t.FHORA ),t.MONSIS = isnull( d.MONSIS, t.MONSIS ),t.IDVUELTO = isnull( d.IDVUELTO, t.IDVUELTO ),t.MOTDESCDEV = isnull( d.MOTDESCDEV, t.MOTDESCDEV ),t.FOBS = isnull( d.FOBS, t.FOBS ),t.FLETRA = isnull( d.FLETRA, t.FLETRA ),t.FFCH = isnull( d.FFCH, t.FFCH ),t.MD1 = isnull( d.MD1, t.MD1 ),t.FCLIENTE = isnull( d.FCLIENTE, t.FCLIENTE ),t.MD2 = isnull( d.MD2, t.MD2 ),t.FMTDES1 = isnull( d.FMTDES1, t.FMTDES1 ),t.FMTDES2 = isnull( d.FMTDES2, t.FMTDES2 ),t.CODIGO = isnull( d.CODIGO, t.CODIGO ),t.FVEN = isnull( d.FVEN, t.FVEN ),t.FPTOVEN = isnull( d.FPTOVEN, t.FPTOVEN ),t.DEUDA = isnull( d.DEUDA, t.DEUDA ),t.FMTDES3 = isnull( d.FMTDES3, t.FMTDES3 ),t.MONEDA = isnull( d.MONEDA, t.MONEDA ),t.FNUMCOMP = isnull( d.FNUMCOMP, t.FNUMCOMP ),t.TOTDESCSI = isnull( d.TOTDESCSI, t.TOTDESCSI ),t.TDCI = isnull( d.TDCI, t.TDCI ),t.SITFISCCLI = isnull( d.SITFISCCLI, t.SITFISCCLI ),t.CODLISTA = isnull( d.CODLISTA, t.CODLISTA ),t.FCUIT = isnull( d.FCUIT, t.FCUIT ),t.COTIZ = isnull( d.COTIZ, t.COTIZ ),t.EMAIL = isnull( d.EMAIL, t.EMAIL ),t.FVUELTO = isnull( d.FVUELTO, t.FVUELTO ),t.FTOTAL = isnull( d.FTOTAL, t.FTOTAL ),t.FPODES = isnull( d.FPODES, t.FPODES ),t.FDESCU = isnull( d.FDESCU, t.FDESCU ),t.MD3 = isnull( d.MD3, t.MD3 ),t.MR1 = isnull( d.MR1, t.MR1 ),t.PERCEPCION = isnull( d.PERCEPCION, t.PERCEPCION ),t.GRAVAMEN = isnull( d.GRAVAMEN, t.GRAVAMEN ),t.FIMPUESTO = isnull( d.FIMPUESTO, t.FIMPUESTO ),t.TOTRECARSI = isnull( d.TOTRECARSI, t.TOTRECARSI ),t.TOTRECAR = isnull( d.TOTRECAR, t.TOTRECAR ),t.TRCI = isnull( d.TRCI, t.TRCI ),t.TOTDESC = isnull( d.TOTDESC, t.TOTDESC ),t.TOTIMPUE = isnull( d.TOTIMPUE, t.TOTIMPUE ),t.IVASIS = isnull( d.IVASIS, t.IVASIS ),t.TIPOCRELA = isnull( d.TIPOCRELA, t.TIPOCRELA ),t.LETRARELA = isnull( d.LETRARELA, t.LETRARELA ),t.PUNTORELA = isnull( d.PUNTORELA, t.PUNTORELA ),t.NUMERORELA = isnull( d.NUMERORELA, t.NUMERORELA ),t.FECCRELA = isnull( d.FECCRELA, t.FECCRELA ),t.CONTINGENC = isnull( d.CONTINGENC, t.CONTINGENC )
				...
				-- Fin Updates
				insert into ZooLogic.COMPROBANTEV(Fecimpo,Fectrans,Fecexpo,Fd2,Fmodifw,Faltafw,Idcaja,Mr,Fpodes1,Recpor,Fperson,Fturno,Nrodgirela,Desmntosi3,Fajxre,Mr2,Desmntosi2,Factsec,Totalcant,Mdcimpu,Recmntosi1,Subtotsisi,Subtotcisi,Signomov,Condivalp,Facttipo,Fsubtot,Desmntosi1,Fsubton,Recmntosi2,Desmntosi,Timestamp,Fpodes2,Recmntosi,Recmnto1,Recmnto2,Recmnto,Fcompfis,Noper,Desauto,Continrela,Anulado,Esttrans,Bdaltafw,Serierela,Bdmodifw,Descfw,Hmodifw,Zadsfw,Horaexpo,Haltafw,Opecomm,Horaimpo,Smodifw,Saltafw,Valtafw,Ualtafw,Umodifw,Vmodifw,Idajuste,Simbmon,Fhora,Monsis,Idvuelto,Motdescdev,Fobs,Fletra,Ffch,Md1,Fcliente,Md2,Fmtdes1,Fmtdes2,Codigo,Fven,Fptoven,Deuda,Fmtdes3,Moneda,Fnumcomp,Totdescsi,Tdci,Sitfisccli,Codlista,Fcuit,Cotiz,Email,Fvuelto,Ftotal,Fpodes,Fdescu,Md3,Mr1,Percepcion,Gravamen,Fimpuesto,Totrecarsi,Totrecar,Trci,Totdesc,Totimpue,Ivasis,Tipocrela,Letrarela,Puntorela,Numerorela,Feccrela,Contingenc)
					Select isnull( d.FECIMPO,''),isnull( d.FECTRANS,''),isnull( d.FECEXPO,''),isnull( d.FD2,''),isnull( d.FMODIFW,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.IDCAJA,0),isnull( d.MR,0),isnull( d.FPODES1,0),isnull( d.RECPOR,0),isnull( d.FPERSON,''),isnull( d.FTURNO,0),isnull( d.NRODGIRELA,0),isnull( d.DESMNTOSI3,0),isnull( d.FAJXRE,0),isnull( d.MR2,0),isnull( d.DESMNTOSI2,0),isnull( d.FACTSEC,''),isnull( d.TOTALCANT,0),isnull( d.MDCIMPU,0),isnull( d.RECMNTOSI1,0),isnull( d.SUBTOTSISI,0),isnull( d.SUBTOTCISI,0),isnull( d.SIGNOMOV,0),isnull( d.CONDIVALP,0),isnull( d.FACTTIPO,0),isnull( d.FSUBTOT,0),isnull( d.DESMNTOSI1,0),isnull( d.FSUBTON,0),isnull( d.RECMNTOSI2,0),isnull( d.DESMNTOSI,0),isnull( d.TIMESTAMP,0),isnull( d.FPODES2,0),isnull( d.RECMNTOSI,0),isnull( d.RECMNTO1,0),isnull( d.RECMNTO2,0),isnull( d.RECMNTO,0),isnull( d.FCOMPFIS,0),isnull( d.NOPER,0),isnull( d.DESAUTO,0),isnull( d.CONTINRELA,0),isnull( d.ANULADO,0),isnull( d.ESTTRANS,''),isnull( d.BDALTAFW,''),isnull( d.SERIERELA,''),isnull( d.BDMODIFW,''),isnull( d.DESCFW,''),isnull( d.HMODIFW,''),isnull( d.ZADSFW,''),isnull( d.HORAEXPO,''),convert( char(8), getdate(), 108 ),isnull( d.OPECOMM,''),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.VALTAFW,''),isnull( d.UALTAFW,''),isnull( d.UMODIFW,''),isnull( d.VMODIFW,''),isnull( d.IDAJUSTE,''),isnull( d.SIMBMON,''),isnull( d.FHORA,''),isnull( d.MONSIS,''),isnull( d.IDVUELTO,''),isnull( d.MOTDESCDEV,''),isnull( d.FOBS,''),isnull( d.FLETRA,''),isnull( d.FFCH,''),isnull( d.MD1,0),isnull( d.FCLIENTE,''),isnull( d.MD2,0),isnull( d.FMTDES1,0),isnull( d.FMTDES2,0),isnull( d.CODIGO,''),isnull( d.FVEN,''),isnull( d.FPTOVEN,0),isnull( d.DEUDA,0),isnull( d.FMTDES3,0),isnull( d.MONEDA,''),isnull( d.FNUMCOMP,0),isnull( d.TOTDESCSI,0),isnull( d.TDCI,0),isnull( d.SITFISCCLI,0),isnull( d.CODLISTA,''),isnull( d.FCUIT,''),isnull( d.COTIZ,0),isnull( d.EMAIL,''),isnull( d.FVUELTO,0),isnull( d.FTOTAL,0),isnull( d.FPODES,0),isnull( d.FDESCU,0),isnull( d.MD3,0),isnull( d.MR1,0),isnull( d.PERCEPCION,0),isnull( d.GRAVAMEN,0),isnull( d.FIMPUESTO,0),isnull( d.TOTRECARSI,0),isnull( d.TOTRECAR,0),isnull( d.TRCI,0),isnull( d.TOTDESC,0),isnull( d.TOTIMPUE,0),isnull( d.IVASIS,0),isnull( d.TIPOCRELA,0),isnull( d.LETRARELA,''),isnull( d.PUNTORELA,0),isnull( d.NUMERORELA,0),isnull( d.FECCRELA,''),isnull( d.CONTINGENC,0)
...
<VFPData xml:space="preserve">
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="RECARGOMONTO2                           " tabla="COMPROBANTEV   " campo="MR2       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Monto recargo 2                                                                                                                                                 " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="8" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="TIPOCOMPROBANTE                         " tabla="COMPROBANTEV   " campo="FACTTIPO  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="2" decimales="0" valorsugerido="=29                                                                                                                                                                                                                                                           " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="1" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="MONTODESCUENTO1                         " tabla="COMPROBANTEV   " campo="MD1       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="Monto descuento 1                                                                                                                                               " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="3" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="CLIENTEDESCRIPCION                      " tabla="COMPROBANTEV   " campo="FCLIENTE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="                                                                                                                                                                " dominio="CODIGOCLIENTECOMPROBANTE      " detalle="false" tipo="E" atributoforaneo="Cliente.Nombre                                                                                                                                                                                                                                                " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="DEUDA                                   " tabla="COMPROBANTEV   " campo="DEUDA     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="430" etiqueta="Saldo de cta. cte.                                                                                                                                              " dominio="FECHASALDO                    " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="MONEDACOMPROBANTE                       " tabla="COMPROBANTEV   " campo="MONEDA    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="MONEDA                                  " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="432" etiqueta="Moneda                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="COTIZACION                              " tabla="COMPROBANTEV   " campo="COTIZ     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="5" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="436" etiqueta="Cotización                                                                                                                                                      " dominio="NUMERICONONEGATIVO            " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="CAE                                     " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="442" etiqueta="C.A.E.                                                                                                                                                          " dominio="CAE                           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="FECHAVENCIMIENTOCAE                     " tabla="               " campo="          " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="444" etiqueta="Vto C.A.E.                                                                                                                                                      " dominio="CAE                           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="6" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="PORCENTAJEDESCUENTO                     " tabla="COMPROBANTEV   " campo="FPODES    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="6" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="446" etiqueta="Des%                                                                                                                                                            " dominio="DESCUENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="0" orden="10" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="MONTODESCUENTO3                         " tabla="COMPROBANTEV   " campo="MD3       " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="15" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="450" etiqueta="Monto descuento 3                                                                                                                                               " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="5" orden="30" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="TOTALIMPUESTOS                          " tabla="COMPROBANTEV   " campo="TOTIMPUE  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="8" decimales="2" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="460" etiqueta="Impuestos                                                                                                                                                       " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="3" subgrupo="26" orden="60" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="NOTADEDEBITOELECTRONICA                 " atributo="PUNTODEVENTACPTERELACIONADO             " tabla="COMPROBANTEV   " campo="PUNTORELA " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="4" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="466" etiqueta="Pto. de venta comprobante asociado                                                                                                                              " dominio="COMPROBANTERELACIONADO        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="92" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
