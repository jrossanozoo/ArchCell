...
define class Mock_Itemremitoelectronicodetallederemitos as MockBase of MockBase.prg

	cClase = 'Itemremitoelectronicodetallederemitos'
	...
	*-----------------------------------------------------------------------------------------
	function completardatosremito() as void                                                                                                                                                                                                                   
		local lcParametros as string, lcParam as string, lni as integer, lnParametros as integer
		...
		return this.ObtenerResultado( 'Completardatosremito', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function comprobante_access() as variant                                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Comprobante_access', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function comprobante_pk_assign( txval as variant ) as void                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Comprobante_pk_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function importeneto_assign( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Importeneto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function importetotal_assign( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Importetotal_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function noterminadodevuelto_assign( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Noterminadodevuelto_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function procesado_assign( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Procesado_assign', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function remito_despuesdeasignar() as void                                                                                                                                                                                                                
		...
		return this.ObtenerResultado( 'Remito_despuesdeasignar', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_importeneto( txval as variant ) as void                                                                                                                                                                                                   
		...
		return this.ObtenerResultado( 'Setear_importeneto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_importetotal( txval as variant ) as void                                                                                                                                                                                                  
		...
		return this.ObtenerResultado( 'Setear_importetotal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_noterminadodevuelto( txval as variant ) as void                                                                                                                                                                                           
		...
		return this.ObtenerResultado( 'Setear_noterminadodevuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function setear_procesado( txval as variant ) as void                                                                                                                                                                                                     
		...
		return this.ObtenerResultado( 'Setear_procesado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_importeneto( txval as variant ) as boolean                                                                                                                                                                                               
		...
		return this.ObtenerResultado( 'Validar_importeneto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_importetotal( txval as variant ) as boolean                                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Validar_importetotal', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_noterminadodevuelto( txval as variant ) as boolean                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Validar_noterminadodevuelto', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function validar_procesado( txval as variant ) as boolean                                                                                                                                                                                                 
		...
		return this.ObtenerResultado( 'Validar_procesado', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function valorsugeridonoterminadodevuelto() as void                                                                                                                                                                                                       
		...
		return this.ObtenerResultado( 'Valorsugeridonoterminadodevuelto', lcParametros )
	EndFunc
