...
define class Din_EntidadTRANSPORTISTAAD_SQLServer as AccesoDatosEntidad_SqlServer of AccesoDatosEntidad_SqlServer.prg
	...
	*--------------------------------------------------------------------------------------------------------
	function Insertar() as boolean
		...
		with this.oEntidad
			local  lxTraCd1, lxTraFaltafw, lxTraFecexpo, lxTraFecimpo, lxTraFmodifw, lxTraFectrans, lxTraTrcalle, lxTraTriva, lxTraTimestamp, lxTraUmodifw, lxTraHaltafw, lxTraHoraexpo, lxTraHmodifw, lxTraHoraimpo, lxTraSmodifw, lxTraSaltafw, lxTraBdaltafw, lxTraTrtlf, lxTraZadsfw, lxTraVmodifw, lxTraValtafw, lxTraEsttrans, lxTraUaltafw, lxTraBdmodifw, lxTraTimagen, lxTraTrcod, lxTraTrobs, lxTraTrcuit, lxTraTrnro, lxTraTrnom, lxTraTrloc, lxTraTrmovil, lxTraTrtipodoc, lxTraTrpiso, lxTraTrcp, lxTraTrfax, lxTraTremail, lxTraTrnrodoc, lxTraTrdepto, lxTraTrprv, lxTraTrpageweb, lxTraTrpais, lxTraTrmsn
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.TRA ( "Cd1","Faltafw","Fecexpo","Fecimpo","Fmodifw","Fectrans","Trcalle","Triva","Timestamp","Umodifw","Haltafw","Horaexpo","Hmodifw","Horaimpo","Smodifw","Saltafw","Bdaltafw","Trtlf","Zadsfw","Vmodifw","Valtafw","Esttrans","Ualtafw","Bdmodifw","Timagen","Trcod","Trobs","Trcuit","Trnro","Trnom","Trloc","Trmovil","Trtipodoc","Trpiso","Trcp","Trfax","Tremail","Trnrodoc","Trdepto","Trprv","Trpageweb","Trpais","Trmsn" ) values ( <<"'" + this.ConvertirDateSql( lxTraCd1 ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTraFaltafw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTraFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTraFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTraFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxTraFectrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrcalle ) + "'" >>, <<lxTraTriva >>, <<lxTraTimestamp >>, <<"'" + this.FormatearTextoSql( lxTraUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrtlf ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTimagen ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrcod ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrcuit ) + "'" >>, <<lxTraTrnro >>, <<"'" + this.FormatearTextoSql( lxTraTrnom ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrloc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrmovil ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrtipodoc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrpiso ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrcp ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrfax ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTremail ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrnrodoc ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrdepto ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrprv ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrpageweb ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrpais ) + "'" >>, <<"'" + this.FormatearTextoSql( lxTraTrmsn ) + "'" >> )
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.TRA set "Cd1" = <<"'" + this.ConvertirDateSql( lxTraCd1 ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxTraFaltafw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxTraFecexpo ) + "'">>,"Fecimpo" = <<"'" + this.ConvertirDateSql( lxTraFecimpo ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxTraFmodifw ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxTraFectrans ) + "'">>,"Trcalle" = <<"'" + this.FormatearTextoSql( lxTraTrcalle ) + "'">>,"Triva" = <<lxTraTriva>>,"Timestamp" = <<lxTraTimestamp>>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxTraUmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxTraHaltafw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxTraHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxTraHmodifw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxTraHoraimpo ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxTraSmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxTraSaltafw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTraBdaltafw ) + "'">>,"Trtlf" = <<"'" + this.FormatearTextoSql( lxTraTrtlf ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxTraZadsfw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxTraVmodifw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxTraValtafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxTraEsttrans ) + "'">>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxTraUaltafw ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTraBdmodifw ) + "'">>,"Timagen" = <<"'" + this.FormatearTextoSql( lxTraTimagen ) + "'">>,"Trcod" = <<"'" + this.FormatearTextoSql( lxTraTrcod ) + "'">>,"Trobs" = <<"'" + this.FormatearTextoSql( lxTraTrobs ) + "'">>,"Trcuit" = <<"'" + this.FormatearTextoSql( lxTraTrcuit ) + "'">>,"Trnro" = <<lxTraTrnro>>,"Trnom" = <<"'" + this.FormatearTextoSql( lxTraTrnom ) + "'">>,"Trloc" = <<"'" + this.FormatearTextoSql( lxTraTrloc ) + "'">>,"Trmovil" = <<"'" + this.FormatearTextoSql( lxTraTrmovil ) + "'">>,"Trtipodoc" = <<"'" + this.FormatearTextoSql( lxTraTrtipodoc ) + "'">>,"Trpiso" = <<"'" + this.FormatearTextoSql( lxTraTrpiso ) + "'">>,"Trcp" = <<"'" + this.FormatearTextoSql( lxTraTrcp ) + "'">>,"Trfax" = <<"'" + this.FormatearTextoSql( lxTraTrfax ) + "'">>,"Tremail" = <<"'" + this.FormatearTextoSql( lxTraTremail ) + "'">>,"Trnrodoc" = <<"'" + this.FormatearTextoSql( lxTraTrnrodoc ) + "'">>,"Trdepto" = <<"'" + this.FormatearTextoSql( lxTraTrdepto ) + "'">>,"Trprv" = <<"'" + this.FormatearTextoSql( lxTraTrprv ) + "'">>,"Trpageweb" = <<"'" + this.FormatearTextoSql( lxTraTrpageweb ) + "'">>,"Trpais" = <<"'" + this.FormatearTextoSql( lxTraTrpais ) + "'">>,"Trmsn" = <<"'" + this.FormatearTextoSql( lxTraTrmsn ) + "'">> where "Trcod" = <<"'" + this.FormatearTextoSql( lxTraTrcod ) + "'">> and  TRA.TRCOD != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorClavePrimaria( tlLlenarAtributos as Boolean ) as Boolean
		...
		with this.oEntidad
			...
			text to lcSentencia textmerge noshow
				select "Cd1" as "Fechaultimamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Trcalle" as "Calle", "Triva" as "Situacionfiscal", "Timestamp" as "Timestamp", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Bdaltafw" as "Basededatosaltafw", "Trtlf" as "Telefono", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timagen" as "Imagen", "Trcod" as "Codigo", "Trobs" as "Observacion", "Trcuit" as "Cuit", "Trnro" as "Numero", "Trnom" as "Nombre", "Trloc" as "Localidad", "Trmovil" as "Movil", "Trtipodoc" as "Tipodocumento", "Trpiso" as "Piso", "Trcp" as "Codigopostal", "Trfax" as "Fax", "Tremail" as "Email", "Trnrodoc" as "Nrodocumento", "Trdepto" as "Departamento", "Trprv" as "Provincia", "Trpageweb" as "Paginaweb", "Trpais" as "Pais", "Trmsn" as "Messenger" from ZooLogic.TRA where "Trcod" = <<"'" + this.FormatearTextoSql( lxTraTrcod ) + "'">> and  TRA.TRCOD != ''
			endtext
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Cd1" as "Fechaultimamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Trcalle" as "Calle", "Triva" as "Situacionfiscal", "Timestamp" as "Timestamp", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Bdaltafw" as "Basededatosaltafw", "Trtlf" as "Telefono", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timagen" as "Imagen", "Trcod" as "Codigo", "Trobs" as "Observacion", "Trcuit" as "Cuit", "Trnro" as "Numero", "Trnom" as "Nombre", "Trloc" as "Localidad", "Trmovil" as "Movil", "Trtipodoc" as "Tipodocumento", "Trpiso" as "Piso", "Trcp" as "Codigopostal", "Trfax" as "Fax", "Tremail" as "Email", "Trnrodoc" as "Nrodocumento", "Trdepto" as "Departamento", "Trprv" as "Provincia", "Trpageweb" as "Paginaweb", "Trpais" as "Pais", "Trmsn" as "Messenger" from ZooLogic.TRA where  TRA.TRCOD != '' order by TRCOD
			endtext
			use in select('c_TRANSPORTISTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSPORTISTA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Cd1" as "Fechaultimamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Trcalle" as "Calle", "Triva" as "Situacionfiscal", "Timestamp" as "Timestamp", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Bdaltafw" as "Basededatosaltafw", "Trtlf" as "Telefono", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timagen" as "Imagen", "Trcod" as "Codigo", "Trobs" as "Observacion", "Trcuit" as "Cuit", "Trnro" as "Numero", "Trnom" as "Nombre", "Trloc" as "Localidad", "Trmovil" as "Movil", "Trtipodoc" as "Tipodocumento", "Trpiso" as "Piso", "Trcp" as "Codigopostal", "Trfax" as "Fax", "Tremail" as "Email", "Trnrodoc" as "Nrodocumento", "Trdepto" as "Departamento", "Trprv" as "Provincia", "Trpageweb" as "Paginaweb", "Trpais" as "Pais", "Trmsn" as "Messenger" from ZooLogic.TRA where  funciones.padr( TRCOD, 6, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  TRA.TRCOD != '' order by TRCOD
			endtext
			use in select('c_TRANSPORTISTA')
			this.oConexion.EjecutarSql( lcSentencia, 'c_TRANSPORTISTA', set( 'Datasession' ) )
			local lcSentencia as string
	...
	*--------------------------------------------------------------------------------------------------------
	function ConsultarPorAtributoSecundario( tcAtributo ) as Boolean
		...
		with this
			...
			lcXml = this.oConexion.EjecutarSql( "select Cd1,Faltafw,Fecexpo,Fecimpo,Fmodifw,Fectrans,Trcalle,Triva,Timestamp,Umodifw,Haltafw,Horaexp" + ;
"o,Hmodifw,Horaimpo,Smodifw,Saltafw,Bdaltafw,Trtlf,Zadsfw,Vmodifw,Valtafw,Esttrans,Ualtafw,Bdmodifw,T" + ;
"imagen,Trcod,Trobs,Trcuit,Trnro,Trnom,Trloc,Trmovil,Trtipodoc,Trpiso,Trcp,Trfax,Tremail,Trnrodoc,Trd" + ;
"epto,Trprv,Trpageweb,Trpais,Trmsn" + ;
		...
		if empty( tcFunc )
			If empty( tcAtributos )
				text to lcAtributos textmerge noshow
					"Cd1" as "Fechaultimamodificacion", "Faltafw" as "Fechaaltafw", "Fecexpo" as "Fechaexpo", "Fecimpo" as "Fechaimpo", "Fmodifw" as "Fechamodificacionfw", "Fectrans" as "Fechatransferencia", "Trcalle" as "Calle", "Triva" as "Situacionfiscal", "Timestamp" as "Timestamp", "Umodifw" as "Usuariomodificacionfw", "Haltafw" as "Horaaltafw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Horaimpo" as "Horaimpo", "Smodifw" as "Seriemodificacionfw", "Saltafw" as "Seriealtafw", "Bdaltafw" as "Basededatosaltafw", "Trtlf" as "Telefono", "Zadsfw" as "Zadsfw", "Vmodifw" as "Versionmodificacionfw", "Valtafw" as "Versionaltafw", "Esttrans" as "Estadotransferencia", "Ualtafw" as "Usuarioaltafw", "Bdmodifw" as "Basededatosmodificacionfw", "Timagen" as "Imagen", "Trcod" as "Codigo", "Trobs" as "Observacion", "Trcuit" as "Cuit", "Trnro" as "Numero", "Trnom" as "Nombre", "Trloc" as "Localidad", "Trmovil" as "Movil", "Trtipodoc" as "Tipodocumento", "Trpiso" as "Piso", "Trcp" as "Codigopostal", "Trfax" as "Fax", "Tremail" as "Email", "Trnrodoc" as "Nrodocumento", "Trdepto" as "Departamento", "Trprv" as "Provincia", "Trpageweb" as "Paginaweb", "Trpais" as "Pais", "Trmsn" as "Messenger"
				endtext
			Else
	...
	function ObtenerSentenciasUpdate() as zooColeccion of zooColeccion.prg
		...
		With this
			...
			text to lcSentencia noshow textmerge
				update ZooLogic.TRA set "Cd1" = <<"'" + this.ConvertirDateSql( lxTraCd1 ) + "'">>, "Faltafw" = <<"'" + this.ConvertirDateSql( lxTraFaltafw ) + "'">>, "Fecexpo" = <<"'" + this.ConvertirDateSql( lxTraFecexpo ) + "'">>, "Fecimpo" = <<"'" + this.ConvertirDateSql( lxTraFecimpo ) + "'">>, "Fmodifw" = <<"'" + this.ConvertirDateSql( lxTraFmodifw ) + "'">>, "Fectrans" = <<"'" + this.ConvertirDateSql( lxTraFectrans ) + "'">>, "Trcalle" = <<"'" + this.FormatearTextoSql( lxTraTrcalle ) + "'">>, "Triva" = <<lxTraTriva>>, "Timestamp" = <<lxTraTimestamp>>, "Umodifw" = <<"'" + this.FormatearTextoSql( lxTraUmodifw ) + "'">>, "Haltafw" = <<"'" + this.FormatearTextoSql( lxTraHaltafw ) + "'">>, "Horaexpo" = <<"'" + this.FormatearTextoSql( lxTraHoraexpo ) + "'">>, "Hmodifw" = <<"'" + this.FormatearTextoSql( lxTraHmodifw ) + "'">>, "Horaimpo" = <<"'" + this.FormatearTextoSql( lxTraHoraimpo ) + "'">>, "Smodifw" = <<"'" + this.FormatearTextoSql( lxTraSmodifw ) + "'">>, "Saltafw" = <<"'" + this.FormatearTextoSql( lxTraSaltafw ) + "'">>, "Bdaltafw" = <<"'" + this.FormatearTextoSql( lxTraBdaltafw ) + "'">>, "Trtlf" = <<"'" + this.FormatearTextoSql( lxTraTrtlf ) + "'">>, "Zadsfw" = <<"'" + this.FormatearTextoSql( lxTraZadsfw ) + "'">>, "Vmodifw" = <<"'" + this.FormatearTextoSql( lxTraVmodifw ) + "'">>, "Valtafw" = <<"'" + this.FormatearTextoSql( lxTraValtafw ) + "'">>, "Esttrans" = <<"'" + this.FormatearTextoSql( lxTraEsttrans ) + "'">>, "Ualtafw" = <<"'" + this.FormatearTextoSql( lxTraUaltafw ) + "'">>, "Bdmodifw" = <<"'" + this.FormatearTextoSql( lxTraBdmodifw ) + "'">>, "Timagen" = <<"'" + this.FormatearTextoSql( lxTraTimagen ) + "'">>, "Trcod" = <<"'" + this.FormatearTextoSql( lxTraTrcod ) + "'">>, "Trobs" = <<"'" + this.FormatearTextoSql( lxTraTrobs ) + "'">>, "Trcuit" = <<"'" + this.FormatearTextoSql( lxTraTrcuit ) + "'">>, "Trnro" = <<lxTraTrnro>>, "Trnom" = <<"'" + this.FormatearTextoSql( lxTraTrnom ) + "'">>, "Trloc" = <<"'" + this.FormatearTextoSql( lxTraTrloc ) + "'">>, "Trmovil" = <<"'" + this.FormatearTextoSql( lxTraTrmovil ) + "'">>, "Trtipodoc" = <<"'" + this.FormatearTextoSql( lxTraTrtipodoc ) + "'">>, "Trpiso" = <<"'" + this.FormatearTextoSql( lxTraTrpiso ) + "'">>, "Trcp" = <<"'" + this.FormatearTextoSql( lxTraTrcp ) + "'">>, "Trfax" = <<"'" + this.FormatearTextoSql( lxTraTrfax ) + "'">>, "Tremail" = <<"'" + this.FormatearTextoSql( lxTraTremail ) + "'">>, "Trnrodoc" = <<"'" + this.FormatearTextoSql( lxTraTrnrodoc ) + "'">>, "Trdepto" = <<"'" + this.FormatearTextoSql( lxTraTrdepto ) + "'">>, "Trprv" = <<"'" + this.FormatearTextoSql( lxTraTrprv ) + "'">>, "Trpageweb" = <<"'" + this.FormatearTextoSql( lxTraTrpageweb ) + "'">>, "Trpais" = <<"'" + this.FormatearTextoSql( lxTraTrpais ) + "'">>, "Trmsn" = <<"'" + this.FormatearTextoSql( lxTraTrmsn ) + "'">> where << lcFiltro >>
			endtext
		loColeccion.cTabla = 'TRA' 
		loColeccion.agregar( strtran(  lcSentencia, chr( 9 ), '' ) )
		...
		scan all
			...
			if reccount( 'curSeek' ) > 0
				if This.ActualizaEnRecepcion() and Evaluate( "dtos( " + lcCursor + ".FModiFW ) + " + lcCursor + ".HModiFW >= dtos( goServicios.Librerias.ObtenerFechaFormateada( CurSeek.FModiFW ) )+ CurSeek.HModiFW" )
					...
					this.oConexion.EjecutarSql( [UPDATE ZooLogic.TRA set  CD1 = ] + "'" + this.ConvertirDateSql( &lcCursor..CD1 ) + "'"+ [, FECEXPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECEXPO ) + "'"+ [, FECIMPO = ] + "'" + this.ConvertirDateSql( &lcCursor..FECIMPO ) + "'"+ [, FMODIFW = ] + "'" + this.ConvertirDateSql( &lcCursor..FMODIFW ) + "'"+ [, FECTRANS = ] + "'" + this.ConvertirDateSql( &lcCursor..FECTRANS ) + "'"+ [, TRCalle = ] + "'" + this.FormatearTextoSql( &lcCursor..TRCalle ) + "'"+ [, TRIVA = ] + transform( &lcCursor..TRIVA )+ [, TIMESTAMP = ] + transform( &lcCursor..TIMESTAMP )+ [, UMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'"+ [, HORAEXPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'"+ [, HMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'"+ [, HORAIMPO = ] + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"+ [, SMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'"+ [, TRTLF = ] + "'" + this.FormatearTextoSql( &lcCursor..TRTLF ) + "'"+ [, ZADSFW = ] + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'"+ [, VMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'"+ [, ESTTRANS = ] + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'"+ [, BDMODIFW = ] + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'"+ [, TIMAGEN = ] + "'" + this.FormatearTextoSql( &lcCursor..TIMAGEN ) + "'"+ [, TRCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..TRCOD ) + "'"+ [, TROBS = ] + "'" + this.FormatearTextoSql( &lcCursor..TROBS ) + "'"+ [, TRCUIT = ] + "'" + this.FormatearTextoSql( &lcCursor..TRCUIT ) + "'"+ [, TRNro = ] + transform( &lcCursor..TRNro )+ [, TRNOM = ] + "'" + this.FormatearTextoSql( &lcCursor..TRNOM ) + "'"+ [, TRLOC = ] + "'" + this.FormatearTextoSql( &lcCursor..TRLOC ) + "'"+ [, TRMovil = ] + "'" + this.FormatearTextoSql( &lcCursor..TRMovil ) + "'"+ [, TRTIPODOC = ] + "'" + this.FormatearTextoSql( &lcCursor..TRTIPODOC ) + "'"+ [, TRPiso = ] + "'" + this.FormatearTextoSql( &lcCursor..TRPiso ) + "'"+ [, TRCP = ] + "'" + this.FormatearTextoSql( &lcCursor..TRCP ) + "'"+ [, TRFAX = ] + "'" + this.FormatearTextoSql( &lcCursor..TRFAX ) + "'"+ [, TREMAIL = ] + "'" + this.FormatearTextoSql( &lcCursor..TREMAIL ) + "'"+ [, TRNRODOC = ] + "'" + this.FormatearTextoSql( &lcCursor..TRNRODOC ) + "'"+ [, TRDEPTO = ] + "'" + this.FormatearTextoSql( &lcCursor..TRDEPTO ) + "'"+ [, TRPRV = ] + "'" + this.FormatearTextoSql( &lcCursor..TRPRV ) + "'"+ [, TRPAGEWEB = ] + "'" + this.FormatearTextoSql( &lcCursor..TRPAGEWEB ) + "'"+ [, TRPAIS = ] + "'" + this.FormatearTextoSql( &lcCursor..TRPAIS ) + "'"+ [, TRMSN = ] + "'" + this.FormatearTextoSql( &lcCursor..TRMSN ) + "'" + [ Where TRCOD = ] + "'" + this.FormatearTextoSql( &lcCursor..TRCOD ) + "'" )
				...
				Text to lcCampos noShow
					 CD1, FALTAFW, FECEXPO, FECIMPO, FMODIFW, FECTRANS, TRCalle, TRIVA, TIMESTAMP, UMODIFW, HALTAFW, HORAEXPO, HMODIFW, HORAIMPO, SMODIFW, SALTAFW, BDALTAFW, TRTLF, ZADSFW, VMODIFW, VALTAFW, ESTTRANS, UALTAFW, BDMODIFW, TIMAGEN, TRCOD, TROBS, TRCUIT, TRNro, TRNOM, TRLOC, TRMovil, TRTIPODOC, TRPiso, TRCP, TRFAX, TREMAIL, TRNRODOC, TRDEPTO, TRPRV, TRPAGEWEB, TRPAIS, TRMSN
				EndText
...
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TRIVA ) + ',' + transform( &lcCursor..TIMESTAMP ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..UMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAEXPO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..HORAIMPO ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..SMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..SALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRTLF ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..ZADSFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..VALTAFW ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..ESTTRANS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..UALTAFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..BDMODIFW ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TIMAGEN ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRCOD ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TROBS ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRCUIT ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + transform( &lcCursor..TRNro ) + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRNOM ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRLOC ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRMovil ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRTIPODOC ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRPiso ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRCP ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRFAX ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TREMAIL ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRNRODOC ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRDEPTO ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRPRV ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRPAGEWEB ) + "'" + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRPAIS ) + "'"
lcValoresCampos = lcValoresCampos  + ',' + "'" + this.FormatearTextoSql( &lcCursor..TRMSN ) + "'"
lcValoresCampos = substr(lcValoresCampos,2) 
	...
	*--------------------------------------------------------------------------------------------------------
	protected function CrearCursorMemo( tcCursorACrear as String, tcTablaConMemo as String ) as Void
		create cursor &tcCursorACrear ( TRCOD C (6) , Orden N(16), texto C(80))
	endfunc
...
*--------------------------------------------------------------------------------------------------------
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			As
			Begin
				Update t Set t.CD1 = isnull( d.CD1, t.CD1 ),t.FALTAFW = isnull( d.FALTAFW, t.FALTAFW ),t.FECEXPO = isnull( d.FECEXPO, t.FECEXPO ),t.FECIMPO = isnull( d.FECIMPO, t.FECIMPO ),t.FMODIFW = isnull( d.FMODIFW, t.FMODIFW ),t.FECTRANS = isnull( d.FECTRANS, t.FECTRANS ),t.TRCALLE = isnull( d.TRCALLE, t.TRCALLE ),t.TRIVA = isnull( d.TRIVA, t.TRIVA ),t.TIMESTAMP = isnull( d.TIMESTAMP, t.TIMESTAMP ),t.UMODIFW = isnull( d.UMODIFW, t.UMODIFW ),t.HALTAFW = isnull( d.HALTAFW, t.HALTAFW ),t.HORAEXPO = isnull( d.HORAEXPO, t.HORAEXPO ),t.HMODIFW = isnull( d.HMODIFW, t.HMODIFW ),t.HORAIMPO = isnull( d.HORAIMPO, t.HORAIMPO ),t.SMODIFW = isnull( d.SMODIFW, t.SMODIFW ),t.SALTAFW = isnull( d.SALTAFW, t.SALTAFW ),t.BDALTAFW = isnull( d.BDALTAFW, t.BDALTAFW ),t.TRTLF = isnull( d.TRTLF, t.TRTLF ),t.ZADSFW = isnull( d.ZADSFW, t.ZADSFW ),t.VMODIFW = isnull( d.VMODIFW, t.VMODIFW ),t.VALTAFW = isnull( d.VALTAFW, t.VALTAFW ),t.ESTTRANS = isnull( d.ESTTRANS, t.ESTTRANS ),t.UALTAFW = isnull( d.UALTAFW, t.UALTAFW ),t.BDMODIFW = isnull( d.BDMODIFW, t.BDMODIFW ),t.TIMAGEN = isnull( d.TIMAGEN, t.TIMAGEN ),t.TRCOD = isnull( d.TRCOD, t.TRCOD ),t.TROBS = isnull( d.TROBS, t.TROBS ),t.TRCUIT = isnull( d.TRCUIT, t.TRCUIT ),t.TRNRO = isnull( d.TRNRO, t.TRNRO ),t.TRNOM = isnull( d.TRNOM, t.TRNOM ),t.TRLOC = isnull( d.TRLOC, t.TRLOC ),t.TRMOVIL = isnull( d.TRMOVIL, t.TRMOVIL ),t.TRTIPODOC = isnull( d.TRTIPODOC, t.TRTIPODOC ),t.TRPISO = isnull( d.TRPISO, t.TRPISO ),t.TRCP = isnull( d.TRCP, t.TRCP ),t.TRFAX = isnull( d.TRFAX, t.TRFAX ),t.TREMAIL = isnull( d.TREMAIL, t.TREMAIL ),t.TRNRODOC = isnull( d.TRNRODOC, t.TRNRODOC ),t.TRDEPTO = isnull( d.TRDEPTO, t.TRDEPTO ),t.TRPRV = isnull( d.TRPRV, t.TRPRV ),t.TRPAGEWEB = isnull( d.TRPAGEWEB, t.TRPAGEWEB ),t.TRPAIS = isnull( d.TRPAIS, t.TRPAIS ),t.TRMSN = isnull( d.TRMSN, t.TRMSN )
					from ZooLogic.TRA t inner join deleted d 
							 on t.TRCOD = d.TRCOD
				-- Fin Updates
				insert into ZooLogic.TRA(Cd1,Faltafw,Fecexpo,Fecimpo,Fmodifw,Fectrans,Trcalle,Triva,Timestamp,Umodifw,Haltafw,Horaexpo,Hmodifw,Horaimpo,Smodifw,Saltafw,Bdaltafw,Trtlf,Zadsfw,Vmodifw,Valtafw,Esttrans,Ualtafw,Bdmodifw,Timagen,Trcod,Trobs,Trcuit,Trnro,Trnom,Trloc,Trmovil,Trtipodoc,Trpiso,Trcp,Trfax,Tremail,Trnrodoc,Trdepto,Trprv,Trpageweb,Trpais,Trmsn)
					Select isnull( d.CD1,''),CONVERT(datetime, convert(varchar(10),getdate(),112) ),isnull( d.FECEXPO,''),isnull( d.FECIMPO,''),isnull( d.FMODIFW,''),isnull( d.FECTRANS,''),isnull( d.TRCALLE,''),isnull( d.TRIVA,0),isnull( d.TIMESTAMP,0),isnull( d.UMODIFW,''),convert( char(8), getdate(), 108 ),isnull( d.HORAEXPO,''),isnull( d.HMODIFW,''),isnull( d.HORAIMPO,''),isnull( d.SMODIFW,''),isnull( d.SALTAFW,''),isnull( d.BDALTAFW,''),isnull( d.TRTLF,''),isnull( d.ZADSFW,''),isnull( d.VMODIFW,''),isnull( d.VALTAFW,''),isnull( d.ESTTRANS,''),isnull( d.UALTAFW,''),isnull( d.BDMODIFW,''),isnull( d.TIMAGEN,''),isnull( d.TRCOD,''),isnull( d.TROBS,''),isnull( d.TRCUIT,''),isnull( d.TRNRO,0),isnull( d.TRNOM,''),isnull( d.TRLOC,''),isnull( d.TRMOVIL,''),isnull( d.TRTIPODOC,''),isnull( d.TRPISO,''),isnull( d.TRCP,''),isnull( d.TRFAX,''),isnull( d.TREMAIL,''),isnull( d.TRNRODOC,''),isnull( d.TRDEPTO,''),isnull( d.TRPRV,''),isnull( d.TRPAGEWEB,''),isnull( d.TRPAIS,''),isnull( d.TRMSN,'')
...
<VFPData xml:space="preserve">
	...
	<row entidad="TRANSPORTISTA                           " atributo="FECHATRANSFERENCIA                      " tabla="TRA            " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSPORTISTA                           " atributo="TELEFONO                                " tabla="TRA            " campo="TRTLF     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Teléfono                                                                                                                                                        " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSPORTISTA                           " atributo="ESTADOTRANSFERENCIA                     " tabla="TRA            " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSPORTISTA                           " atributo="IMAGEN                                  " tabla="TRA            " campo="TIMAGEN   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="180" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="20" etiqueta="Archivo                                                                                                                                                         " dominio="IMAGENCONRUTADINAMICA         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="3" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="CODIGO                                  " tabla="TRA            " campo="TRCOD     " claveprimaria="true" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="6" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="true" admitebusqueda="2" etiqueta="Código                                                                                                                                                          " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSPORTISTA                           " atributo="LOCALIDAD                               " tabla="TRA            " campo="TRLOC     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="70" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="8" etiqueta="Localidad                                                                                                                                                       " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="MOVIL                                   " tabla="TRA            " campo="TRMOVIL   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="10" etiqueta="Teléfono móvil                                                                                                                                                  " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="TRANSPORTISTA                           " atributo="TIPODOCUMENTO                           " tabla="TRA            " campo="TRTIPODOC " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="406" etiqueta="Tipo/Número Doc                                                                                                                                                 " dominio="DOCUMENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="5" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="PISO                                    " tabla="TRA            " campo="TRPISO    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="408" etiqueta="Piso                                                                                                                                                            " dominio="DIRECCION                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="CODIGOPOSTAL                            " tabla="TRA            " campo="TRCP      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="410" etiqueta="Código Postal                                                                                                                                                   " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="FAX                                     " tabla="TRA            " campo="TRFAX     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="12" etiqueta="Fax                                                                                                                                                             " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="2" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="EMAIL                                   " tabla="TRA            " campo="TREMAIL   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="32" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="412" etiqueta="E-Mail                                                                                                                                                          " dominio="MAIL                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="NRODOCUMENTO                            " tabla="TRA            " campo="TRNRODOC  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="10" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="414" etiqueta="Tipo/Número Doc                                                                                                                                                 " dominio="DOCUMENTO                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="5" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="DEPARTAMENTO                            " tabla="TRA            " campo="TRDEPTO   " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="416" etiqueta="Departamento                                                                                                                                                    " dominio="DIRECCION                     " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="PROVINCIA                               " tabla="TRA            " campo="TRPRV     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PROVINCIA                               " tipodato="C         " longitud="2" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="418" etiqueta="Provincia                                                                                                                                                       " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="3" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="PAGINAWEB                               " tabla="TRA            " campo="TRPAGEWEB " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="60" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="420" etiqueta="Página Web                                                                                                                                                      " dominio="WEB                           " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="PAIS                                    " tabla="TRA            " campo="TRPAIS    " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="true" claveforanea="PAISES                                  " tipodato="C         " longitud="3" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="422" etiqueta="País                                                                                                                                                            " dominio="CODIGO                        " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="0" orden="4" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="TRANSPORTISTA                           " atributo="MESSENGER                               " tabla="TRA            " campo="TRMSN     " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="32" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="424" etiqueta="Messenger                                                                                                                                                       " dominio="MAIL                          " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="1" subgrupo="1" orden="5" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="PROVINCIA                               " atributo="DESCRIPCION                             " tabla="PROVINCI       " campo="PRV_DES   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="50" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="419" etiqueta="Detalle Pro.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PROVINCI On TRA.TRPRV = PROVINCI.PRV_COD And  PROVINCI.PRV_COD != ''                                                                                                                                                                               " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="PAISES                                  " atributo="DESCRIPCION                             " tabla="PAISES         " campo="PDES      " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="30" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="423" etiqueta="Detalle Paí.                                                                                                                                                    " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones=" Left Join PAISES On TRA.TRPAIS = PAISES.pcod And  PAISES.PCOD != ''                                                                                                                                                                                          " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
