	...
	function Insertar() as boolean
		...
		Try
			...
			text to lcSentencia textmerge noshow
				insert into ZooLogic.LIQTALLER ( "Fecimpo","Fectrans","Fmodifw","Fecexpo","Faltafw","Timestamp","Ualtafw","Smodifw","Umodifw","Saltafw","Zadsfw","Valtafw","Vmodifw","Haltafw","Esttrans","Bdmodifw","Horaexpo","Hmodifw","Bdaltafw","Horaimpo","Codigo","Cobs","Descrip" ) values ( <<"'" + this.ConvertirDateSql( lxLiqtallerFecimpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqtallerFectrans ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqtallerFmodifw ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqtallerFecexpo ) + "'" >>, <<"'" + this.ConvertirDateSql( lxLiqtallerFaltafw ) + "'" >>, <<lxLiqtallerTimestamp >>, <<"'" + this.FormatearTextoSql( lxLiqtallerUaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerSmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerUmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerSaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerZadsfw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerValtafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerVmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerHaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerEsttrans ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerBdmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerHoraexpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerHmodifw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerBdaltafw ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerHoraimpo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerCodigo ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerCobs ) + "'" >>, <<"'" + this.FormatearTextoSql( lxLiqtallerDescrip ) + "'" >> )
			endtext
		...
		this.oEntidad.Timestamp = lxLiqtallerTimestamp
		endwith
	...
	*--------------------------------------------------------------------------------------------------------
	...
	local loError as Exception, loEx as Exception, lxValorClavePrimaria as variant, lnI as Integer, loSentenciasTriggers as zoocoleccion OF zoocoleccion.prg, lcSentencia as string
		...
		Try
			...
			text to lcSentencia textmerge noshow
				update ZooLogic.LIQTALLER set "Fecimpo" = <<"'" + this.ConvertirDateSql( lxLiqtallerFecimpo ) + "'">>,"Fectrans" = <<"'" + this.ConvertirDateSql( lxLiqtallerFectrans ) + "'">>,"Fmodifw" = <<"'" + this.ConvertirDateSql( lxLiqtallerFmodifw ) + "'">>,"Fecexpo" = <<"'" + this.ConvertirDateSql( lxLiqtallerFecexpo ) + "'">>,"Faltafw" = <<"'" + this.ConvertirDateSql( lxLiqtallerFaltafw ) + "'">>,"Timestamp" = <<lxLiqtallerTimestamp>>,"Ualtafw" = <<"'" + this.FormatearTextoSql( lxLiqtallerUaltafw ) + "'">>,"Smodifw" = <<"'" + this.FormatearTextoSql( lxLiqtallerSmodifw ) + "'">>,"Umodifw" = <<"'" + this.FormatearTextoSql( lxLiqtallerUmodifw ) + "'">>,"Saltafw" = <<"'" + this.FormatearTextoSql( lxLiqtallerSaltafw ) + "'">>,"Zadsfw" = <<"'" + this.FormatearTextoSql( lxLiqtallerZadsfw ) + "'">>,"Valtafw" = <<"'" + this.FormatearTextoSql( lxLiqtallerValtafw ) + "'">>,"Vmodifw" = <<"'" + this.FormatearTextoSql( lxLiqtallerVmodifw ) + "'">>,"Haltafw" = <<"'" + this.FormatearTextoSql( lxLiqtallerHaltafw ) + "'">>,"Esttrans" = <<"'" + this.FormatearTextoSql( lxLiqtallerEsttrans ) + "'">>,"Bdmodifw" = <<"'" + this.FormatearTextoSql( lxLiqtallerBdmodifw ) + "'">>,"Horaexpo" = <<"'" + this.FormatearTextoSql( lxLiqtallerHoraexpo ) + "'">>,"Hmodifw" = <<"'" + this.FormatearTextoSql( lxLiqtallerHmodifw ) + "'">>,"Bdaltafw" = <<"'" + this.FormatearTextoSql( lxLiqtallerBdaltafw ) + "'">>,"Horaimpo" = <<"'" + this.FormatearTextoSql( lxLiqtallerHoraimpo ) + "'">>,"Codigo" = <<"'" + this.FormatearTextoSql( lxLiqtallerCodigo ) + "'">>,"Cobs" = <<"'" + this.FormatearTextoSql( lxLiqtallerCobs ) + "'">>,"Descrip" = <<"'" + this.FormatearTextoSql( lxLiqtallerDescrip ) + "'">> where "Codigo" = <<"'" + this.FormatearTextoSql( lxLiqtallerCodigo ) + "'">> and  LIQTALLER.CODIGO != '' << this.oEntidad.ObtenerWhereAdicionalParaSentenciaUpdate() >>
			endtext
			this.oConexion.EjecutarSql( lcSentencia  + goServicios.RealTime.ObtenerTagEstimulo( .oEntidad.cNombre ) )
	...
	*--------------------------------------------------------------------------------------------------------
	Function Primero() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Codigo" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.LIQTALLER where  LIQTALLER.CODIGO != '' order by Codigo
			endtext
			use in select('c_LIQUIDACIONDETALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDETALLER', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Siguiente() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Codigo" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.LIQTALLER where  funciones.padr( Codigo, 10, ' ' ) > <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LIQTALLER.CODIGO != '' order by Codigo
			endtext
			use in select('c_LIQUIDACIONDETALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDETALLER', set( 'Datasession' ) )
			Endwith
	...
	*--------------------------------------------------------------------------------------------------------
	Function Anterior() As Boolean
		...
		try
			...
			text to lcSentencia textmerge noshow
				select top 1 "Fecimpo" as "Fechaimpo", "Fectrans" as "Fechatransferencia", "Fmodifw" as "Fechamodificacionfw", "Fecexpo" as "Fechaexpo", "Faltafw" as "Fechaaltafw", "Timestamp" as "Timestamp", "Ualtafw" as "Usuarioaltafw", "Smodifw" as "Seriemodificacionfw", "Umodifw" as "Usuariomodificacionfw", "Saltafw" as "Seriealtafw", "Zadsfw" as "Zadsfw", "Valtafw" as "Versionaltafw", "Vmodifw" as "Versionmodificacionfw", "Haltafw" as "Horaaltafw", "Esttrans" as "Estadotransferencia", "Bdmodifw" as "Basededatosmodificacionfw", "Horaexpo" as "Horaexpo", "Hmodifw" as "Horamodificacionfw", "Bdaltafw" as "Basededatosaltafw", "Horaimpo" as "Horaimpo", "Codigo" as "Codigo", "Cobs" as "Observ", "Descrip" as "Descripcion" from ZooLogic.LIQTALLER where  funciones.padr( Codigo, 10, ' ' ) < <<"'" + this.FormatearTextoSql( lcOrden ) + "'">> and  LIQTALLER.CODIGO != '' order by Codigo desc
			endtext
			use in select('c_LIQUIDACIONDETALLER')
			this.oConexion.EjecutarSql( lcSentencia, 'c_LIQUIDACIONDETALLER', set( 'Datasession' ) )
			Endwith
	...
	function ObtenerTriggerDeleteImportacion( tcTablaTrabajo ) as String
		...
		Text to lcCadena noshow textmerge
			...
			Begin
				...
				-- Fin Updates
				insert into ZooLogic.LIQTALLER(Fecimpo,Fectrans,Fmodifw,Fecexpo,Faltafw,Timestamp,Ualtafw,Smodifw,Umodifw,Saltafw,Zadsfw,Valtafw,Vmodifw,Haltafw,Esttrans,Bdmodifw,Horaexpo,Hmodifw,Bdaltafw,Horaimpo,Codigo,Cobs,Descrip)
		...
		with this.oEntidad
			...
			if reccount( 'c_LIQUIDACIONDETALLER' ) < 1
				...
				Try
					...
					.Timestamp = nvl( c_LIQUIDACIONDETALLER.Timestamp, 0 )
					...
					.Observ = lcValor 
					.Descripcion = nvl( c_LIQUIDACIONDETALLER.Descripcion, [] )
				Catch To loError
					goServicios.Errores.LevantarExcepcion( loError )
				Finally
					.lCargando = .f.
...
<VFPData xml:space="preserve">
	...
	<row entidad="LIQUIDACIONDETALLER                     " atributo="FECHATRANSFERENCIA                      " tabla="LIQTALLER      " campo="FECTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="D         " longitud="8" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Fecha transferencia                                                                                                                                             " dominio="FECHA                         " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONDETALLER                     " atributo="TIMESTAMP                               " tabla="LIQTALLER      " campo="TIMESTAMP " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="N         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="                                                                                                                                                                " dominio="NUMERICO                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONDETALLER                     " atributo="ESTADOTRANSFERENCIA                     " tabla="LIQTALLER      " campo="ESTTRANS  " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="20" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="0" etiqueta="Estado transferencia                                                                                                                                            " dominio="CARACTER                      " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="0" alta="false" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	...
	<row entidad="LIQUIDACIONDETALLER                     " atributo="OBSERV                                  " tabla="LIQTALLER      " campo="COBS      " claveprimaria="false" muestrarelacion="false" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="M         " longitud="0" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="200" etiqueta="Observaciones                                                                                                                                                   " dominio="OBSERVACION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="1" orden="0" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
	<row entidad="LIQUIDACIONDETALLER                     " atributo="DESCRIPCION                             " tabla="LIQTALLER      " campo="DESCRIP   " claveprimaria="false" muestrarelacion="true" permitemodificar="false" esentidad="false" claveforanea="                                        " tipodato="C         " longitud="100" decimales="0" valorsugerido="                                                                                                                                                                                                                                                              " obligatorio="false" admitebusqueda="2" etiqueta="Descripción                                                                                                                                                     " dominio="DESCRIPCION                   " detalle="false" tipo="E" atributoforaneo="                                                                                                                                                                                                                                                              " clavecandidata="0" mascara="                         " ofuncionalidad=" " relaciones="                                                                                                                                                                                                                                                              " filtrobuscador="                                                                                                                                                                                                        " grupo="0" subgrupo="0" orden="1" alta="true" incluiratrib="false" excluiratrib="false" incluirbussubent="false" utilizamismarelacion="false"/>
</VFPData>
