...
define class Mock_Impresiondeetiquetaad_sqlserver as MockBase of MockBase.prg

	cClase = 'Impresiondeetiquetaad_sqlserver'
	...
	*-----------------------------------------------------------------------------------------
	function obtenercampodetalleetiquetadetalle( tcatributo as string ) as string                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenercampodetalleetiquetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenercamposselectdetalleetiquetadetalle( tccampos as string ) as string                                                                                                                                                                        
		...
		return this.ObtenerResultado( 'Obtenercamposselectdetalleetiquetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenerdatosdetalleetiquetadetalle( tcatributos as string, tchaving as string, tcorder as string, tcfunc as string, tntope as integer ) as string                                                                                                
		...
		return this.ObtenerResultado( 'Obtenerdatosdetalleetiquetadetalle', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function obtenertriggerdeleteimportacion_impetdet( tctablatrabajo ) as string                                                                                                                                                                             
		...
		return this.ObtenerResultado( 'Obtenertriggerdeleteimportacion_impetdet', lcParametros )
	EndFunc
	...
	*-----------------------------------------------------------------------------------------
	function parsearcamposdetalleetiquetadetalle( tccampos as string ) as string                                                                                                                                                                              
		...
		return this.ObtenerResultado( 'Parsearcamposdetalleetiquetadetalle', lcParametros )
	EndFunc
