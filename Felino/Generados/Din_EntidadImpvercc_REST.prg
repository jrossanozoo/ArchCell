...
define class Din_EntidadImpvercc_REST as ServicioRestOperacionesEntidad of ServicioRestOperacionesEntidad.prg
	...
	cNamespaceDTOs = "ZooLogicSA.OrganicServiciosREST.Felino.Generados.DTO.Impvercc"
	...
	*-----------------------------------------------------------------------------------------
	protected function SetearEntidadConDatosModelo( toEntidad as Object, toModeloEnRequest as Object ) as Void
		with toEntidad
			...
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_sucursal_desde", toEntidad, "F_sucursal_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_sucursal_hasta", toEntidad, "F_sucursal_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_baseagru_desde", toEntidad, "F_baseagru_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_baseagru_hasta", toEntidad, "F_baseagru_hasta" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_razons_desde", toEntidad, "F_razons_desde" )
			this.SetearAtributoModeloEnEntidad( toModeloEnRequest, "F_razons_hasta", toEntidad, "F_razons_hasta" )
	...
	*-----------------------------------------------------------------------------------------
	protected function CargarModeloResponse( toModeloResponse as Object, toEntidad as Object ) as Void
		with toModeloResponse
			...
			this.SetearAtributoString( toModeloResponse, "f_Sucursal_Desde", toEntidad.f_Sucursal_Desde)
			this.SetearAtributoString( toModeloResponse, "f_Sucursal_Hasta", toEntidad.f_Sucursal_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_BaseAgru_Desde", toEntidad.f_BaseAgru_Desde)
			this.SetearAtributoString( toModeloResponse, "f_BaseAgru_Hasta", toEntidad.f_BaseAgru_Hasta)
			this.SetearAtributoString( toModeloResponse, "f_RazonS_Desde", toEntidad.f_RazonS_Desde)
			this.SetearAtributoString( toModeloResponse, "f_RazonS_Hasta", toEntidad.f_RazonS_Hasta)
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerFiltroSegunModeloRequest( toModeloRequest as Object ) as String
		...
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "F_baseagru_desde", "BASDESDE")
		lcFiltro = this.AgregarCondicionAFiltro( lcFiltro, toModeloRequest, "F_baseagru_hasta", "BASHASTA")
	...
	*-----------------------------------------------------------------------------------------
	protected function ObtenerBusquedaSegunModeloRequest( toRequest as Object ) as String
		...
		if !isnull( lcExpresionBusqueda )
			...
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Basdesde LIKE '%" + lcExpresionBusqueda + "%'"
			lcRetorno = iif( !empty( lcRetorno ), lcRetorno + " OR ", "" ) + "Bashasta LIKE '%" + lcExpresionBusqueda + "%'"
