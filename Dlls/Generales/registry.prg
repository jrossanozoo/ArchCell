**************************************************
*-- Class Library:  c:\zoo\dlls\generales\registry.vcx
**************************************************


**************************************************
*-- Class:        registry (c:\zoo\dlls\generales\registry.vcx)
*-- ParentClass:  custom
*-- BaseClass:    custom
*-- Time Stamp:   07/23/02 02:13:03 PM
*
#INCLUDE "c:\zoo\dlls\generales\registry.h"
*
DEFINE CLASS registry AS custom
	...
	*-- User registry key.
	nuserkey = 0
	*-- Registry path to VFP options settings.
	cvfpoptpath = ""
	*-- DLL file for registry functions.
	cregdllfile = ""
	*-- DLL file for INI functions.
	cinidllfile = ""
	*-- DLL file for ODBC functions.
	codbcdllfile = ""
	*-- Current operating system code.
	ncurrentos = 0
	*-- Current registry key.
	ncurrentkey = 0
	*-- Application path registry key.
	capppathkey = ""
	Name = "registry"

	*-- Whether registry key functions loaded.
	lloadeddlls = .F.

	*-- Whether INI functions loaded.
	lloadedinis = .F.

	*-- Whether to create key if one does not already exist.
	lcreatekey = .F.

	*-- Whether an error occurred.
	lhaderror = .F.

	*-- Whether ODBC functions loaded.
	lloadedodbcs = .F.
	ldisallowexpanded = .F.
	lhasdllloaded = .F.
	...
	*-- Enumerates through a registry key.
	PROCEDURE enumkeys
...
**************************************************
*-- Class:        filereg (c:\zoo\dlls\generales\registry.vcx)
*-- ParentClass:  registry (c:\zoo\dlls\generales\registry.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   10/27/00 01:41:05 PM
*
#INCLUDE "c:\zoo\dlls\generales\registry.h"
*
DEFINE CLASS filereg AS registry
	...
	*-- Checks and returns path of application associated with a particular extension (e.g., XLS, DOC).
...
**************************************************
*-- Class:        foxreg (c:\zoo\dlls\generales\registry.vcx)
*-- ParentClass:  registry (c:\zoo\dlls\generales\registry.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   08/17/98 06:08:12 PM
*
#INCLUDE "c:\zoo\dlls\generales\registry.h"
*
DEFINE CLASS foxreg AS registry
	...
	*-- Sets an option from FoxPro registry settings.
	...
	*-- Retrieves an option from FoxPro registry settings.
...
**************************************************
*-- Class:        odbcreg (c:\zoo\dlls\generales\registry.vcx)
*-- ParentClass:  registry (c:\zoo\dlls\generales\registry.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   10/27/00 01:41:09 PM
*
#INCLUDE "c:\zoo\dlls\generales\registry.h"
*
DEFINE CLASS odbcreg AS registry
	...
	*-- Enumerates through ODBC drivers.
	...
	*-- Enumerates through ODBC data sources.
...
**************************************************
*-- Class:        oldinireg (c:\zoo\dlls\generales\registry.vcx)
*-- ParentClass:  registry (c:\zoo\dlls\generales\registry.vcx)
*-- BaseClass:    custom
*-- Time Stamp:   10/27/00 01:42:01 PM
*
#INCLUDE "c:\zoo\dlls\generales\registry.h"
*
